...
void interrupt_handler(struct trapframe *tf) {
    ...
    802003ce:	06f76e63          	bltu	a4,a5,8020044a <interrupt_handler+0x86>
...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200418:	c0470713          	addi	a4,a4,-1020 # 80204018 <interrupt_ticks>
    8020041c:	431c                	lw	a5,0(a4)
            if(interrupt_ticks == 100)
    8020041e:	06400693          	li	a3,100
            interrupt_ticks ++;
    80200422:	0017861b          	addiw	a2,a5,1
    80200426:	c310                	sw	a2,0(a4)
            if(interrupt_ticks == 100)
    80200428:	02d60263          	beq	a2,a3,8020044c <interrupt_handler+0x88>
            {
                interrupt_ticks = 0;
                print_ticks();
                print_times ++;
    ...
    80200430:	bf072703          	lw	a4,-1040(a4) # 8020401c <print_times>
    80200434:	47a9                	li	a5,10
    80200436:	04f70063          	beq	a4,a5,80200476 <interrupt_handler+0xb2>
            break;
        default:
            print_trapframe(tf);
            break;
    ...
    80200448:	b125                	j	80200070 <cprintf>
            print_trapframe(tf);
    8020044a:	bf29                	j	80200364 <print_trapframe>
    cprintf("%d ticks\n", TICK_NUM);
    8020044c:	06400593          	li	a1,100
    80200450:	00001517          	auipc	a0,0x1
    80200454:	ae050513          	addi	a0,a0,-1312 # 80200f30 <etext+0x514>
                interrupt_ticks = 0;
    80200458:	00004797          	auipc	a5,0x4
    8020045c:	bc07a023          	sw	zero,-1088(a5) # 80204018 <interrupt_ticks>
    cprintf("%d ticks\n", TICK_NUM);
    80200460:	c11ff0ef          	jal	ra,80200070 <cprintf>
                print_times ++;
    80200464:	00004697          	auipc	a3,0x4
    80200468:	bb868693          	addi	a3,a3,-1096 # 8020401c <print_times>
    8020046c:	429c                	lw	a5,0(a3)
    8020046e:	0017871b          	addiw	a4,a5,1
    80200472:	c298                	sw	a4,0(a3)
    80200474:	b7c1                	j	80200434 <interrupt_handler+0x70>
}
    80200476:	60a2                	ld	ra,8(sp)
    80200478:	0141                	addi	sp,sp,16
                sbi_shutdown();
    8020047a:	aba9                	j	802009d4 <sbi_shutdown>
...
static inline void trap_dispatch(struct trapframe *tf) {
    ...
    80200480:	0407cb63          	bltz	a5,802004d6 <trap+0x5a>
...
void trap(struct trapframe *tf) { trap_dispatch(tf); }
    ...
    8020048e:	04e78563          	beq	a5,a4,802004d8 <trap+0x5c>
    80200492:	02f76963          	bltu	a4,a5,802004c4 <trap+0x48>
    80200496:	4705                	li	a4,1
    80200498:	02f77263          	bgeu	a4,a5,802004bc <trap+0x40>
    8020049c:	4709                	li	a4,2
    8020049e:	02e79763          	bne	a5,a4,802004cc <trap+0x50>
            cprintf("Exception type : Illegal instruction ; Illegal instruction caught at %p\n", tf->epc);
    802004a2:	10853583          	ld	a1,264(a0)
    802004a6:	00001517          	auipc	a0,0x1
    802004aa:	aea50513          	addi	a0,a0,-1302 # 80200f90 <etext+0x574>
...
__alltraps:
    ...
    jal trap
    80200560:	f1dff0ef          	jal	ra,8020047c <trap>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    8020068e:	0ff5f593          	andi	a1,a1,255
    ...
    802006d2:	0ff5f593          	andi	a1,a1,255
