...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	659040ef          	jal	ra,ffffffffc0204ea2 <memset>
...
ffffffffc0200056:	e9e58593          	addi	a1,a1,-354 # ffffffffc0204ef0 <etext>
ffffffffc020005a:	00005517          	auipc	a0,0x5
ffffffffc020005e:	eb650513          	addi	a0,a0,-330 # ffffffffc0204f10 <etext+0x20>
...
ffffffffc020007a:	5fe040ef          	jal	ra,ffffffffc0204678 <proc_init>
...
ffffffffc020008e:	039040ef          	jal	ra,ffffffffc02048c6 <cpu_idle>
...
ffffffffc02000ac:	e7050513          	addi	a0,a0,-400 # ffffffffc0204f18 <etext+0x28>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	131040ef          	jal	ra,ffffffffc0204aa4 <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	0fb040ef          	jal	ra,ffffffffc0204aa4 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001ce:	d5650513          	addi	a0,a0,-682 # ffffffffc0204f20 <etext+0x30>
void print_kerninfo(void) {
...
ffffffffc02001e4:	d6050513          	addi	a0,a0,-672 # ffffffffc0204f40 <etext+0x50>
ffffffffc02001e8:	f99ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ec:	00005597          	auipc	a1,0x5
ffffffffc02001f0:	d0458593          	addi	a1,a1,-764 # ffffffffc0204ef0 <etext>
ffffffffc02001f4:	00005517          	auipc	a0,0x5
ffffffffc02001f8:	d6c50513          	addi	a0,a0,-660 # ffffffffc0204f60 <etext+0x70>
...
ffffffffc020020c:	d7850513          	addi	a0,a0,-648 # ffffffffc0204f80 <etext+0x90>
...
ffffffffc0200220:	d8450513          	addi	a0,a0,-636 # ffffffffc0204fa0 <etext+0xb0>
...
ffffffffc020024e:	d7650513          	addi	a0,a0,-650 # ffffffffc0204fc0 <etext+0xd0>
}
...
ffffffffc020025c:	d9860613          	addi	a2,a2,-616 # ffffffffc0204ff0 <etext+0x100>
ffffffffc0200260:	04d00593          	li	a1,77
ffffffffc0200264:	00005517          	auipc	a0,0x5
ffffffffc0200268:	da450513          	addi	a0,a0,-604 # ffffffffc0205008 <etext+0x118>
void print_stackframe(void) {
...
ffffffffc0200278:	dac60613          	addi	a2,a2,-596 # ffffffffc0205020 <etext+0x130>
ffffffffc020027c:	00005597          	auipc	a1,0x5
ffffffffc0200280:	dc458593          	addi	a1,a1,-572 # ffffffffc0205040 <etext+0x150>
ffffffffc0200284:	00005517          	auipc	a0,0x5
ffffffffc0200288:	dc450513          	addi	a0,a0,-572 # ffffffffc0205048 <etext+0x158>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200296:	dc660613          	addi	a2,a2,-570 # ffffffffc0205058 <etext+0x168>
ffffffffc020029a:	00005597          	auipc	a1,0x5
ffffffffc020029e:	de658593          	addi	a1,a1,-538 # ffffffffc0205080 <etext+0x190>
ffffffffc02002a2:	00005517          	auipc	a0,0x5
ffffffffc02002a6:	da650513          	addi	a0,a0,-602 # ffffffffc0205048 <etext+0x158>
ffffffffc02002aa:	ed7ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ae:	00005617          	auipc	a2,0x5
ffffffffc02002b2:	de260613          	addi	a2,a2,-542 # ffffffffc0205090 <etext+0x1a0>
ffffffffc02002b6:	00005597          	auipc	a1,0x5
ffffffffc02002ba:	dfa58593          	addi	a1,a1,-518 # ffffffffc02050b0 <etext+0x1c0>
ffffffffc02002be:	00005517          	auipc	a0,0x5
ffffffffc02002c2:	d8a50513          	addi	a0,a0,-630 # ffffffffc0205048 <etext+0x158>
...
ffffffffc02002fc:	dc850513          	addi	a0,a0,-568 # ffffffffc02050c0 <etext+0x1d0>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031e:	dce50513          	addi	a0,a0,-562 # ffffffffc02050e8 <etext+0x1f8>
...
ffffffffc0200348:	dcc90913          	addi	s2,s2,-564 # ffffffffc0205110 <etext+0x220>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020034c:	00005497          	auipc	s1,0x5
ffffffffc0200350:	dcc48493          	addi	s1,s1,-564 # ffffffffc0205118 <etext+0x228>
        if (argc == MAXARGS - 1) {
ffffffffc0200354:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200356:	00005b17          	auipc	s6,0x5
ffffffffc020035a:	dcab0b13          	addi	s6,s6,-566 # ffffffffc0205120 <etext+0x230>
        argv[argc ++] = buf;
ffffffffc020035e:	00005a17          	auipc	s4,0x5
ffffffffc0200362:	ce2a0a13          	addi	s4,s4,-798 # ffffffffc0205040 <etext+0x150>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc020038c:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc020038e:	2e1040ef          	jal	ra,ffffffffc0204e6e <strcmp>
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	2cd040ef          	jal	ra,ffffffffc0204e6e <strcmp>
...
ffffffffc02003e0:	2ad040ef          	jal	ra,ffffffffc0204e8c <strchr>
...
ffffffffc020041e:	26f040ef          	jal	ra,ffffffffc0204e8c <strchr>
...
ffffffffc020043c:	d0850513          	addi	a0,a0,-760 # ffffffffc0205140 <etext+0x250>
...
ffffffffc020058a:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020058c:	129040ef          	jal	ra,ffffffffc0204eb4 <memcpy>
    return 0;
}
...
ffffffffc02005ae:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005b0:	105040ef          	jal	ra,ffffffffc0204eb4 <memcpy>
    return 0;
}
...
ffffffffc0201bbe:	2e4030ef          	jal	ra,ffffffffc0204ea2 <memset>
    return page - pages + nbase;
...
ffffffffc0201c50:	252030ef          	jal	ra,ffffffffc0204ea2 <memset>
    return page - pages + nbase;
...
ffffffffc0202352:	30b020ef          	jal	ra,ffffffffc0204e5c <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202356:	10040593          	addi	a1,s0,256
ffffffffc020235a:	10000513          	li	a0,256
ffffffffc020235e:	311020ef          	jal	ra,ffffffffc0204e6e <strcmp>
...
ffffffffc0202390:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202394:	293020ef          	jal	ra,ffffffffc0204e26 <strlen>
...
ffffffffc0202b7e:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202b80:	560010ef          	jal	ra,ffffffffc02040e0 <swapfs_init>
...
ffffffffc020335a:	64d000ef          	jal	ra,ffffffffc02041a6 <swapfs_write>
...
ffffffffc02033f8:	521000ef          	jal	ra,ffffffffc0204118 <swapfs_read>
...
ffffffffc0204006:	c545                	beqz	a0,ffffffffc02040ae <do_pgfault+0xd0>
ffffffffc0204008:	651c                	ld	a5,8(a0)
ffffffffc020400a:	0af46263          	bltu	s0,a5,ffffffffc02040ae <do_pgfault+0xd0>
...
ffffffffc0204014:	efb1                	bnez	a5,ffffffffc0204070 <do_pgfault+0x92>
        perm |= READ_WRITE;
    }
...
ffffffffc0204024:	c555                	beqz	a0,ffffffffc02040d0 <do_pgfault+0xf2>
        cprintf("get_pte in do_pgfault failed\n");
        goto failed;
    }
    if (*ptep == 0) { // if the phy addr isn't exist, then alloc a page & map the phy addr with logical addr
ffffffffc0204026:	610c                	ld	a1,0(a0)
ffffffffc0204028:	c5a5                	beqz	a1,ffffffffc0204090 <do_pgfault+0xb2>
...
ffffffffc0204032:	c7d9                	beqz	a5,ffffffffc02040c0 <do_pgfault+0xe2>
...
ffffffffc0204042:	e90d                	bnez	a0,ffffffffc0204074 <do_pgfault+0x96>
                cprintf("swap_in in do_pgfault failed\n");
                goto failed;
            }   
            // 交换成功，则建立物理地址<--->虚拟地址映射，并将页设置为可交换的
            page_insert(mm->pgdir, page, addr, perm);
ffffffffc0204044:	65a2                	ld	a1,8(sp)
ffffffffc0204046:	6c88                	ld	a0,24(s1)
ffffffffc0204048:	86ce                	mv	a3,s3
ffffffffc020404a:	8622                	mv	a2,s0
ffffffffc020404c:	daffd0ef          	jal	ra,ffffffffc0201dfa <page_insert>
...
ffffffffc0204060:	70e2                	ld	ra,56(sp)
ffffffffc0204062:	7442                	ld	s0,48(sp)
ffffffffc0204064:	74a2                	ld	s1,40(sp)
ffffffffc0204066:	69e2                	ld	s3,24(sp)
ffffffffc0204068:	854a                	mv	a0,s2
ffffffffc020406a:	7902                	ld	s2,32(sp)
ffffffffc020406c:	6121                	addi	sp,sp,64
ffffffffc020406e:	8082                	ret
        perm |= READ_WRITE;
ffffffffc0204070:	49dd                	li	s3,23
ffffffffc0204072:	b755                	j	ffffffffc0204016 <do_pgfault+0x38>
                cprintf("swap_in in do_pgfault failed\n");
ffffffffc0204074:	00003517          	auipc	a0,0x3
ffffffffc0204078:	ae450513          	addi	a0,a0,-1308 # ffffffffc0206b58 <default_pmm_manager+0xf18>
ffffffffc020407c:	904fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
}
ffffffffc0204080:	70e2                	ld	ra,56(sp)
ffffffffc0204082:	7442                	ld	s0,48(sp)
ffffffffc0204084:	74a2                	ld	s1,40(sp)
ffffffffc0204086:	69e2                	ld	s3,24(sp)
ffffffffc0204088:	854a                	mv	a0,s2
ffffffffc020408a:	7902                	ld	s2,32(sp)
ffffffffc020408c:	6121                	addi	sp,sp,64
ffffffffc020408e:	8082                	ret
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0204090:	6c88                	ld	a0,24(s1)
ffffffffc0204092:	864e                	mv	a2,s3
ffffffffc0204094:	85a2                	mv	a1,s0
ffffffffc0204096:	9fbfe0ef          	jal	ra,ffffffffc0202a90 <pgdir_alloc_page>
   ret = 0;
ffffffffc020409a:	4901                	li	s2,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc020409c:	f171                	bnez	a0,ffffffffc0204060 <do_pgfault+0x82>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc020409e:	00003517          	auipc	a0,0x3
ffffffffc02040a2:	a9250513          	addi	a0,a0,-1390 # ffffffffc0206b30 <default_pmm_manager+0xef0>
ffffffffc02040a6:	8dafc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040aa:	5971                	li	s2,-4
            goto failed;
ffffffffc02040ac:	bf55                	j	ffffffffc0204060 <do_pgfault+0x82>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc02040ae:	85a2                	mv	a1,s0
ffffffffc02040b0:	00003517          	auipc	a0,0x3
ffffffffc02040b4:	a3050513          	addi	a0,a0,-1488 # ffffffffc0206ae0 <default_pmm_manager+0xea0>
ffffffffc02040b8:	8c8fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    int ret = -E_INVAL;
ffffffffc02040bc:	5975                	li	s2,-3
        goto failed;
ffffffffc02040be:	b74d                	j	ffffffffc0204060 <do_pgfault+0x82>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc02040c0:	00003517          	auipc	a0,0x3
ffffffffc02040c4:	ab850513          	addi	a0,a0,-1352 # ffffffffc0206b78 <default_pmm_manager+0xf38>
ffffffffc02040c8:	8b8fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040cc:	5971                	li	s2,-4
            goto failed;
ffffffffc02040ce:	bf49                	j	ffffffffc0204060 <do_pgfault+0x82>
        cprintf("get_pte in do_pgfault failed\n");
ffffffffc02040d0:	00003517          	auipc	a0,0x3
ffffffffc02040d4:	a4050513          	addi	a0,a0,-1472 # ffffffffc0206b10 <default_pmm_manager+0xed0>
ffffffffc02040d8:	8a8fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040dc:	5971                	li	s2,-4
        goto failed;
ffffffffc02040de:	b749                	j	ffffffffc0204060 <do_pgfault+0x82>
...
ffffffffc02040e4:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc02040e6:	c82fc0ef          	jal	ra,ffffffffc0200568 <ide_device_valid>
ffffffffc02040ea:	cd01                	beqz	a0,ffffffffc0204102 <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc02040ec:	4505                	li	a0,1
ffffffffc02040ee:	c80fc0ef          	jal	ra,ffffffffc020056e <ide_device_size>
}
ffffffffc02040f2:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc02040f4:	810d                	srli	a0,a0,0x3
ffffffffc02040f6:	00012797          	auipc	a5,0x12
ffffffffc02040fa:	48a7b923          	sd	a0,1170(a5) # ffffffffc0216588 <max_swap_offset>
}
ffffffffc02040fe:	0141                	addi	sp,sp,16
ffffffffc0204100:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0204102:	00003617          	auipc	a2,0x3
ffffffffc0204106:	a9e60613          	addi	a2,a2,-1378 # ffffffffc0206ba0 <default_pmm_manager+0xf60>
ffffffffc020410a:	45b5                	li	a1,13
ffffffffc020410c:	00003517          	auipc	a0,0x3
ffffffffc0204110:	ab450513          	addi	a0,a0,-1356 # ffffffffc0206bc0 <default_pmm_manager+0xf80>
ffffffffc0204114:	b32fc0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc0204150:	41c6b683          	ld	a3,1052(a3) # ffffffffc0216568 <npage>
...
ffffffffc0204164:	4207b783          	ld	a5,1056(a5) # ffffffffc0216580 <va_pa_offset>
...
ffffffffc020416e:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204170:	c04fc06f          	j	ffffffffc0200574 <ide_read_secs>
ffffffffc0204174:	86aa                	mv	a3,a0
ffffffffc0204176:	00003617          	auipc	a2,0x3
ffffffffc020417a:	a6260613          	addi	a2,a2,-1438 # ffffffffc0206bd8 <default_pmm_manager+0xf98>
ffffffffc020417e:	45d1                	li	a1,20
ffffffffc0204180:	00003517          	auipc	a0,0x3
ffffffffc0204184:	a4050513          	addi	a0,a0,-1472 # ffffffffc0206bc0 <default_pmm_manager+0xf80>
ffffffffc0204188:	abefc0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc020418c:	86b2                	mv	a3,a2
ffffffffc020418e:	06900593          	li	a1,105
ffffffffc0204192:	00002617          	auipc	a2,0x2
ffffffffc0204196:	ae660613          	addi	a2,a2,-1306 # ffffffffc0205c78 <default_pmm_manager+0x38>
ffffffffc020419a:	00002517          	auipc	a0,0x2
ffffffffc020419e:	b0650513          	addi	a0,a0,-1274 # ffffffffc0205ca0 <default_pmm_manager+0x60>
ffffffffc02041a2:	aa4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc02041de:	38e6b683          	ld	a3,910(a3) # ffffffffc0216568 <npage>
...
ffffffffc02041f2:	3927b783          	ld	a5,914(a5) # ffffffffc0216580 <va_pa_offset>
...
ffffffffc02041fc:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc02041fe:	b9afc06f          	j	ffffffffc0200598 <ide_write_secs>
ffffffffc0204202:	86aa                	mv	a3,a0
ffffffffc0204204:	00003617          	auipc	a2,0x3
ffffffffc0204208:	9d460613          	addi	a2,a2,-1580 # ffffffffc0206bd8 <default_pmm_manager+0xf98>
ffffffffc020420c:	45e5                	li	a1,25
ffffffffc020420e:	00003517          	auipc	a0,0x3
ffffffffc0204212:	9b250513          	addi	a0,a0,-1614 # ffffffffc0206bc0 <default_pmm_manager+0xf80>
ffffffffc0204216:	a30fc0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc020421a:	86b2                	mv	a3,a2
ffffffffc020421c:	06900593          	li	a1,105
ffffffffc0204220:	00002617          	auipc	a2,0x2
ffffffffc0204224:	a5860613          	addi	a2,a2,-1448 # ffffffffc0205c78 <default_pmm_manager+0x38>
ffffffffc0204228:	00002517          	auipc	a0,0x2
ffffffffc020422c:	a7850513          	addi	a0,a0,-1416 # ffffffffc0205ca0 <default_pmm_manager+0x60>
ffffffffc0204230:	a16fc0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc0204236:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0204238:	424000ef          	jal	ra,ffffffffc020465c <do_exit>

ffffffffc020423c <alloc_proc>:
...
ffffffffc020423e:	0e800513          	li	a0,232
alloc_proc(void) {
ffffffffc0204242:	e022                	sd	s0,0(sp)
ffffffffc0204244:	e406                	sd	ra,8(sp)
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));// 分配空间
ffffffffc0204246:	e08fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
ffffffffc020424a:	842a                	mv	s0,a0
    if (proc != NULL) {
ffffffffc020424c:	c521                	beqz	a0,ffffffffc0204294 <alloc_proc+0x58>
...
ffffffffc0204252:	e11c                	sd	a5,0(a0)
        proc->runs = 0;
        proc->kstack = 0;
        proc->need_resched = 0;
        proc->parent = NULL;
...
ffffffffc0204254:	07000613          	li	a2,112
ffffffffc0204258:	4581                	li	a1,0
        proc->runs = 0;
ffffffffc020425a:	00052423          	sw	zero,8(a0)
        proc->kstack = 0;
ffffffffc020425e:	00053823          	sd	zero,16(a0)
        proc->need_resched = 0;
ffffffffc0204262:	00052c23          	sw	zero,24(a0)
        proc->parent = NULL;
ffffffffc0204266:	02053023          	sd	zero,32(a0)
        proc->mm = NULL;
ffffffffc020426a:	02053423          	sd	zero,40(a0)
        memset(&(proc->context),0,sizeof(struct context));
ffffffffc020426e:	03050513          	addi	a0,a0,48
ffffffffc0204272:	431000ef          	jal	ra,ffffffffc0204ea2 <memset>
        proc->tf = NULL;
        proc->cr3 = boot_cr3;
ffffffffc0204276:	00012797          	auipc	a5,0x12
ffffffffc020427a:	2e27b783          	ld	a5,738(a5) # ffffffffc0216558 <boot_cr3>
        proc->tf = NULL;
ffffffffc020427e:	0a043023          	sd	zero,160(s0)
        proc->cr3 = boot_cr3;
ffffffffc0204282:	f45c                	sd	a5,168(s0)
        proc->flags = 0;
ffffffffc0204284:	0a042823          	sw	zero,176(s0)
        memset(&(proc->name),0,PROC_NAME_LEN);
ffffffffc0204288:	463d                	li	a2,15
ffffffffc020428a:	4581                	li	a1,0
ffffffffc020428c:	0b440513          	addi	a0,s0,180
ffffffffc0204290:	413000ef          	jal	ra,ffffffffc0204ea2 <memset>
    }
    return proc;
}
ffffffffc0204294:	60a2                	ld	ra,8(sp)
ffffffffc0204296:	8522                	mv	a0,s0
ffffffffc0204298:	6402                	ld	s0,0(sp)
ffffffffc020429a:	0141                	addi	sp,sp,16
ffffffffc020429c:	8082                	ret

ffffffffc020429e <forkret>:
...
forkret(void) {
    forkrets(current->tf);
ffffffffc020429e:	00012797          	auipc	a5,0x12
ffffffffc02042a2:	3127b783          	ld	a5,786(a5) # ffffffffc02165b0 <current>
ffffffffc02042a6:	73c8                	ld	a0,160(a5)
ffffffffc02042a8:	8c5fc06f          	j	ffffffffc0200b6c <forkrets>
...
ffffffffc02042b0:	00012497          	auipc	s1,0x12
ffffffffc02042b4:	26848493          	addi	s1,s1,616 # ffffffffc0216518 <name.2>
init_main(void *arg) {
ffffffffc02042b8:	f022                	sd	s0,32(sp)
ffffffffc02042ba:	e84a                	sd	s2,16(sp)
ffffffffc02042bc:	842a                	mv	s0,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042be:	00012917          	auipc	s2,0x12
ffffffffc02042c2:	2f293903          	ld	s2,754(s2) # ffffffffc02165b0 <current>
    memset(name, 0, sizeof(name));
ffffffffc02042c6:	4641                	li	a2,16
ffffffffc02042c8:	4581                	li	a1,0
ffffffffc02042ca:	8526                	mv	a0,s1
init_main(void *arg) {
ffffffffc02042cc:	f406                	sd	ra,40(sp)
ffffffffc02042ce:	e44e                	sd	s3,8(sp)
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042d0:	00492983          	lw	s3,4(s2)
    memset(name, 0, sizeof(name));
ffffffffc02042d4:	3cf000ef          	jal	ra,ffffffffc0204ea2 <memset>
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc02042d8:	0b490593          	addi	a1,s2,180
ffffffffc02042dc:	463d                	li	a2,15
ffffffffc02042de:	8526                	mv	a0,s1
ffffffffc02042e0:	3d5000ef          	jal	ra,ffffffffc0204eb4 <memcpy>
ffffffffc02042e4:	862a                	mv	a2,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042e6:	85ce                	mv	a1,s3
ffffffffc02042e8:	00003517          	auipc	a0,0x3
ffffffffc02042ec:	91050513          	addi	a0,a0,-1776 # ffffffffc0206bf8 <default_pmm_manager+0xfb8>
ffffffffc02042f0:	e91fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"%s\".\n", (const char *)arg);
ffffffffc02042f4:	85a2                	mv	a1,s0
ffffffffc02042f6:	00003517          	auipc	a0,0x3
ffffffffc02042fa:	92a50513          	addi	a0,a0,-1750 # ffffffffc0206c20 <default_pmm_manager+0xfe0>
ffffffffc02042fe:	e83fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc0204302:	00003517          	auipc	a0,0x3
ffffffffc0204306:	92e50513          	addi	a0,a0,-1746 # ffffffffc0206c30 <default_pmm_manager+0xff0>
ffffffffc020430a:	e77fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    return 0;
}
ffffffffc020430e:	70a2                	ld	ra,40(sp)
ffffffffc0204310:	7402                	ld	s0,32(sp)
ffffffffc0204312:	64e2                	ld	s1,24(sp)
ffffffffc0204314:	6942                	ld	s2,16(sp)
ffffffffc0204316:	69a2                	ld	s3,8(sp)
ffffffffc0204318:	4501                	li	a0,0
ffffffffc020431a:	6145                	addi	sp,sp,48
ffffffffc020431c:	8082                	ret

ffffffffc020431e <proc_run>:
proc_run(struct proc_struct *proc) {
ffffffffc020431e:	7179                	addi	sp,sp,-48
ffffffffc0204320:	ec4a                	sd	s2,24(sp)
    if (proc != current) {
ffffffffc0204322:	00012917          	auipc	s2,0x12
ffffffffc0204326:	28e90913          	addi	s2,s2,654 # ffffffffc02165b0 <current>
proc_run(struct proc_struct *proc) {
ffffffffc020432a:	f026                	sd	s1,32(sp)
    if (proc != current) {
ffffffffc020432c:	00093483          	ld	s1,0(s2)
proc_run(struct proc_struct *proc) {
ffffffffc0204330:	f406                	sd	ra,40(sp)
ffffffffc0204332:	e84e                	sd	s3,16(sp)
    if (proc != current) {
ffffffffc0204334:	02a48963          	beq	s1,a0,ffffffffc0204366 <proc_run+0x48>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204338:	100027f3          	csrr	a5,sstatus
ffffffffc020433c:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020433e:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204340:	e3a1                	bnez	a5,ffffffffc0204380 <proc_run+0x62>
            lcr3(current->cr3);//切换页表
ffffffffc0204342:	755c                	ld	a5,168(a0)
...
ffffffffc0204344:	80000737          	lui	a4,0x80000
            current = proc;//前一个进程和后一个进程,就两个进程
ffffffffc0204348:	00a93023          	sd	a0,0(s2)
ffffffffc020434c:	00c7d79b          	srliw	a5,a5,0xc
ffffffffc0204350:	8fd9                	or	a5,a5,a4
ffffffffc0204352:	18079073          	csrw	satp,a5
            switch_to(&(prev->context), &(current->context));
ffffffffc0204356:	03050593          	addi	a1,a0,48
ffffffffc020435a:	03048513          	addi	a0,s1,48
ffffffffc020435e:	594000ef          	jal	ra,ffffffffc02048f2 <switch_to>
    if (flag) {
ffffffffc0204362:	00099863          	bnez	s3,ffffffffc0204372 <proc_run+0x54>
}
ffffffffc0204366:	70a2                	ld	ra,40(sp)
ffffffffc0204368:	7482                	ld	s1,32(sp)
ffffffffc020436a:	6962                	ld	s2,24(sp)
ffffffffc020436c:	69c2                	ld	s3,16(sp)
ffffffffc020436e:	6145                	addi	sp,sp,48
ffffffffc0204370:	8082                	ret
ffffffffc0204372:	70a2                	ld	ra,40(sp)
ffffffffc0204374:	7482                	ld	s1,32(sp)
ffffffffc0204376:	6962                	ld	s2,24(sp)
ffffffffc0204378:	69c2                	ld	s3,16(sp)
ffffffffc020437a:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc020437c:	a40fc06f          	j	ffffffffc02005bc <intr_enable>
ffffffffc0204380:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc0204382:	a40fc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204386:	6522                	ld	a0,8(sp)
ffffffffc0204388:	4985                	li	s3,1
ffffffffc020438a:	bf65                	j	ffffffffc0204342 <proc_run+0x24>

ffffffffc020438c <do_fork>:
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc020438c:	7179                	addi	sp,sp,-48
ffffffffc020438e:	ec26                	sd	s1,24(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204390:	00012497          	auipc	s1,0x12
ffffffffc0204394:	23848493          	addi	s1,s1,568 # ffffffffc02165c8 <nr_process>
ffffffffc0204398:	4098                	lw	a4,0(s1)
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc020439a:	f406                	sd	ra,40(sp)
ffffffffc020439c:	f022                	sd	s0,32(sp)
ffffffffc020439e:	e84a                	sd	s2,16(sp)
ffffffffc02043a0:	e44e                	sd	s3,8(sp)
ffffffffc02043a2:	e052                	sd	s4,0(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc02043a4:	6785                	lui	a5,0x1
ffffffffc02043a6:	22f75063          	bge	a4,a5,ffffffffc02045c6 <do_fork+0x23a>
ffffffffc02043aa:	892e                	mv	s2,a1
ffffffffc02043ac:	8432                	mv	s0,a2
    if ((proc = alloc_proc()) == NULL) {
ffffffffc02043ae:	e8fff0ef          	jal	ra,ffffffffc020423c <alloc_proc>
ffffffffc02043b2:	89aa                	mv	s3,a0
ffffffffc02043b4:	20050e63          	beqz	a0,ffffffffc02045d0 <do_fork+0x244>
    proc->parent = current;//将子进程的父节点设置为当前进程
ffffffffc02043b8:	00012a17          	auipc	s4,0x12
ffffffffc02043bc:	1f8a0a13          	addi	s4,s4,504 # ffffffffc02165b0 <current>
ffffffffc02043c0:	000a3783          	ld	a5,0(s4)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043c4:	4509                	li	a0,2
    proc->parent = current;//将子进程的父节点设置为当前进程
ffffffffc02043c6:	02f9b023          	sd	a5,32(s3)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043ca:	e62fd0ef          	jal	ra,ffffffffc0201a2c <alloc_pages>
    if (page != NULL) {
ffffffffc02043ce:	1e050763          	beqz	a0,ffffffffc02045bc <do_fork+0x230>
    return page - pages + nbase;
ffffffffc02043d2:	00012697          	auipc	a3,0x12
ffffffffc02043d6:	19e6b683          	ld	a3,414(a3) # ffffffffc0216570 <pages>
ffffffffc02043da:	40d506b3          	sub	a3,a0,a3
ffffffffc02043de:	8699                	srai	a3,a3,0x6
ffffffffc02043e0:	00003517          	auipc	a0,0x3
ffffffffc02043e4:	c2053503          	ld	a0,-992(a0) # ffffffffc0207000 <nbase>
ffffffffc02043e8:	96aa                	add	a3,a3,a0
    return KADDR(page2pa(page));
ffffffffc02043ea:	00c69793          	slli	a5,a3,0xc
ffffffffc02043ee:	83b1                	srli	a5,a5,0xc
ffffffffc02043f0:	00012717          	auipc	a4,0x12
ffffffffc02043f4:	17873703          	ld	a4,376(a4) # ffffffffc0216568 <npage>
    return page2ppn(page) << PGSHIFT;
ffffffffc02043f8:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02043fa:	1ee7fd63          	bgeu	a5,a4,ffffffffc02045f4 <do_fork+0x268>
    assert(current->mm == NULL);
ffffffffc02043fe:	000a3783          	ld	a5,0(s4)
ffffffffc0204402:	00012717          	auipc	a4,0x12
ffffffffc0204406:	17e73703          	ld	a4,382(a4) # ffffffffc0216580 <va_pa_offset>
ffffffffc020440a:	96ba                	add	a3,a3,a4
ffffffffc020440c:	779c                	ld	a5,40(a5)
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc020440e:	00d9b823          	sd	a3,16(s3)
    assert(current->mm == NULL);
ffffffffc0204412:	1c079163          	bnez	a5,ffffffffc02045d4 <do_fork+0x248>
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc0204416:	6789                	lui	a5,0x2
ffffffffc0204418:	ee078793          	addi	a5,a5,-288 # 1ee0 <kern_entry-0xffffffffc01fe120>
ffffffffc020441c:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc020441e:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc0204420:	0ad9b023          	sd	a3,160(s3)
    *(proc->tf) = *tf;
ffffffffc0204424:	87b6                	mv	a5,a3
ffffffffc0204426:	12040893          	addi	a7,s0,288
ffffffffc020442a:	00063803          	ld	a6,0(a2)
ffffffffc020442e:	6608                	ld	a0,8(a2)
ffffffffc0204430:	6a0c                	ld	a1,16(a2)
ffffffffc0204432:	6e18                	ld	a4,24(a2)
ffffffffc0204434:	0107b023          	sd	a6,0(a5)
ffffffffc0204438:	e788                	sd	a0,8(a5)
ffffffffc020443a:	eb8c                	sd	a1,16(a5)
ffffffffc020443c:	ef98                	sd	a4,24(a5)
ffffffffc020443e:	02060613          	addi	a2,a2,32
ffffffffc0204442:	02078793          	addi	a5,a5,32
ffffffffc0204446:	ff1612e3          	bne	a2,a7,ffffffffc020442a <do_fork+0x9e>
    proc->tf->gpr.a0 = 0;
ffffffffc020444a:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020444e:	12090563          	beqz	s2,ffffffffc0204578 <do_fork+0x1ec>
ffffffffc0204452:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204456:	00000797          	auipc	a5,0x0
ffffffffc020445a:	e4878793          	addi	a5,a5,-440 # ffffffffc020429e <forkret>
ffffffffc020445e:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204462:	02d9bc23          	sd	a3,56(s3)
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc020446c:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020446e:	12079663          	bnez	a5,ffffffffc020459a <do_fork+0x20e>
    if (++ last_pid >= MAX_PID) {
ffffffffc0204472:	00007817          	auipc	a6,0x7
ffffffffc0204476:	be680813          	addi	a6,a6,-1050 # ffffffffc020b058 <last_pid.1>
ffffffffc020447a:	00082783          	lw	a5,0(a6)
ffffffffc020447e:	6709                	lui	a4,0x2
ffffffffc0204480:	0017851b          	addiw	a0,a5,1
ffffffffc0204484:	00a82023          	sw	a0,0(a6)
ffffffffc0204488:	08e55163          	bge	a0,a4,ffffffffc020450a <do_fork+0x17e>
    if (last_pid >= next_safe) {
ffffffffc020448c:	00007317          	auipc	t1,0x7
ffffffffc0204490:	bd030313          	addi	t1,t1,-1072 # ffffffffc020b05c <next_safe.0>
ffffffffc0204494:	00032783          	lw	a5,0(t1)
ffffffffc0204498:	00012417          	auipc	s0,0x12
ffffffffc020449c:	09040413          	addi	s0,s0,144 # ffffffffc0216528 <proc_list>
ffffffffc02044a0:	06f55d63          	bge	a0,a5,ffffffffc020451a <do_fork+0x18e>
        proc->pid = get_pid();//获取当前进程PID
ffffffffc02044a4:	00a9a223          	sw	a0,4(s3)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc02044a8:	45a9                	li	a1,10
ffffffffc02044aa:	2501                	sext.w	a0,a0
ffffffffc02044ac:	576000ef          	jal	ra,ffffffffc0204a22 <hash32>
ffffffffc02044b0:	02051793          	slli	a5,a0,0x20
ffffffffc02044b4:	01c7d513          	srli	a0,a5,0x1c
ffffffffc02044b8:	0000e797          	auipc	a5,0xe
ffffffffc02044bc:	06078793          	addi	a5,a5,96 # ffffffffc0212518 <hash_list>
ffffffffc02044c0:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc02044c2:	6510                	ld	a2,8(a0)
ffffffffc02044c4:	0d898793          	addi	a5,s3,216
ffffffffc02044c8:	6414                	ld	a3,8(s0)
        nr_process ++;//进程数加一
ffffffffc02044ca:	4098                	lw	a4,0(s1)
    prev->next = next->prev = elm;
ffffffffc02044cc:	e21c                	sd	a5,0(a2)
ffffffffc02044ce:	e51c                	sd	a5,8(a0)
    elm->next = next;
ffffffffc02044d0:	0ec9b023          	sd	a2,224(s3)
        list_add(&proc_list, &(proc->list_link));//加入进程链表
ffffffffc02044d4:	0c898793          	addi	a5,s3,200
    elm->prev = prev;
ffffffffc02044d8:	0ca9bc23          	sd	a0,216(s3)
    prev->next = next->prev = elm;
ffffffffc02044dc:	e29c                	sd	a5,0(a3)
        nr_process ++;//进程数加一
ffffffffc02044de:	2705                	addiw	a4,a4,1
ffffffffc02044e0:	e41c                	sd	a5,8(s0)
    elm->next = next;
ffffffffc02044e2:	0cd9b823          	sd	a3,208(s3)
    elm->prev = prev;
ffffffffc02044e6:	0c89b423          	sd	s0,200(s3)
ffffffffc02044ea:	c098                	sw	a4,0(s1)
    if (flag) {
ffffffffc02044ec:	0a091b63          	bnez	s2,ffffffffc02045a2 <do_fork+0x216>
    wakeup_proc(proc);
ffffffffc02044f0:	854e                	mv	a0,s3
ffffffffc02044f2:	46a000ef          	jal	ra,ffffffffc020495c <wakeup_proc>
    ret = proc->pid;//返回当前进程的PID
ffffffffc02044f6:	0049a503          	lw	a0,4(s3)
}
ffffffffc02044fa:	70a2                	ld	ra,40(sp)
ffffffffc02044fc:	7402                	ld	s0,32(sp)
ffffffffc02044fe:	64e2                	ld	s1,24(sp)
ffffffffc0204500:	6942                	ld	s2,16(sp)
ffffffffc0204502:	69a2                	ld	s3,8(sp)
ffffffffc0204504:	6a02                	ld	s4,0(sp)
ffffffffc0204506:	6145                	addi	sp,sp,48
ffffffffc0204508:	8082                	ret
        last_pid = 1;
ffffffffc020450a:	4785                	li	a5,1
ffffffffc020450c:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc0204510:	4505                	li	a0,1
ffffffffc0204512:	00007317          	auipc	t1,0x7
ffffffffc0204516:	b4a30313          	addi	t1,t1,-1206 # ffffffffc020b05c <next_safe.0>
    return listelm->next;
ffffffffc020451a:	00012417          	auipc	s0,0x12
ffffffffc020451e:	00e40413          	addi	s0,s0,14 # ffffffffc0216528 <proc_list>
ffffffffc0204522:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
ffffffffc0204526:	6789                	lui	a5,0x2
ffffffffc0204528:	00f32023          	sw	a5,0(t1)
ffffffffc020452c:	86aa                	mv	a3,a0
ffffffffc020452e:	4581                	li	a1,0
        while ((le = list_next(le)) != list) {
ffffffffc0204530:	6e89                	lui	t4,0x2
ffffffffc0204532:	088e0063          	beq	t3,s0,ffffffffc02045b2 <do_fork+0x226>
ffffffffc0204536:	88ae                	mv	a7,a1
ffffffffc0204538:	87f2                	mv	a5,t3
ffffffffc020453a:	6609                	lui	a2,0x2
ffffffffc020453c:	a811                	j	ffffffffc0204550 <do_fork+0x1c4>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc020453e:	00e6d663          	bge	a3,a4,ffffffffc020454a <do_fork+0x1be>
ffffffffc0204542:	00c75463          	bge	a4,a2,ffffffffc020454a <do_fork+0x1be>
ffffffffc0204546:	863a                	mv	a2,a4
ffffffffc0204548:	4885                	li	a7,1
ffffffffc020454a:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc020454c:	00878d63          	beq	a5,s0,ffffffffc0204566 <do_fork+0x1da>
            if (proc->pid == last_pid) {
ffffffffc0204550:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc0204554:	fed715e3          	bne	a4,a3,ffffffffc020453e <do_fork+0x1b2>
                if (++ last_pid >= next_safe) {
ffffffffc0204558:	2685                	addiw	a3,a3,1
ffffffffc020455a:	04c6d763          	bge	a3,a2,ffffffffc02045a8 <do_fork+0x21c>
ffffffffc020455e:	679c                	ld	a5,8(a5)
ffffffffc0204560:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc0204562:	fe8797e3          	bne	a5,s0,ffffffffc0204550 <do_fork+0x1c4>
ffffffffc0204566:	c581                	beqz	a1,ffffffffc020456e <do_fork+0x1e2>
ffffffffc0204568:	00d82023          	sw	a3,0(a6)
ffffffffc020456c:	8536                	mv	a0,a3
ffffffffc020456e:	f2088be3          	beqz	a7,ffffffffc02044a4 <do_fork+0x118>
ffffffffc0204572:	00c32023          	sw	a2,0(t1)
ffffffffc0204576:	b73d                	j	ffffffffc02044a4 <do_fork+0x118>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204578:	8936                	mv	s2,a3
ffffffffc020457a:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc020457e:	00000797          	auipc	a5,0x0
ffffffffc0204582:	d2078793          	addi	a5,a5,-736 # ffffffffc020429e <forkret>
ffffffffc0204586:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc020458a:	02d9bc23          	sd	a3,56(s3)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020458e:	100027f3          	csrr	a5,sstatus
ffffffffc0204592:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204594:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204596:	ec078ee3          	beqz	a5,ffffffffc0204472 <do_fork+0xe6>
        intr_disable();
ffffffffc020459a:	828fc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc020459e:	4905                	li	s2,1
ffffffffc02045a0:	bdc9                	j	ffffffffc0204472 <do_fork+0xe6>
        intr_enable();
ffffffffc02045a2:	81afc0ef          	jal	ra,ffffffffc02005bc <intr_enable>
ffffffffc02045a6:	b7a9                	j	ffffffffc02044f0 <do_fork+0x164>
                    if (last_pid >= MAX_PID) {
ffffffffc02045a8:	01d6c363          	blt	a3,t4,ffffffffc02045ae <do_fork+0x222>
                        last_pid = 1;
ffffffffc02045ac:	4685                	li	a3,1
                    goto repeat;
ffffffffc02045ae:	4585                	li	a1,1
ffffffffc02045b0:	b749                	j	ffffffffc0204532 <do_fork+0x1a6>
ffffffffc02045b2:	cd81                	beqz	a1,ffffffffc02045ca <do_fork+0x23e>
ffffffffc02045b4:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc02045b8:	8536                	mv	a0,a3
ffffffffc02045ba:	b5ed                	j	ffffffffc02044a4 <do_fork+0x118>
    kfree(proc);
ffffffffc02045bc:	854e                	mv	a0,s3
ffffffffc02045be:	b40fd0ef          	jal	ra,ffffffffc02018fe <kfree>
    ret = -E_NO_MEM;
ffffffffc02045c2:	5571                	li	a0,-4
    goto fork_out;
ffffffffc02045c4:	bf1d                	j	ffffffffc02044fa <do_fork+0x16e>
    int ret = -E_NO_FREE_PROC;
ffffffffc02045c6:	556d                	li	a0,-5
ffffffffc02045c8:	bf0d                	j	ffffffffc02044fa <do_fork+0x16e>
    return last_pid;
ffffffffc02045ca:	00082503          	lw	a0,0(a6)
ffffffffc02045ce:	bdd9                	j	ffffffffc02044a4 <do_fork+0x118>
    ret = -E_NO_MEM;
ffffffffc02045d0:	5571                	li	a0,-4
    return ret;
ffffffffc02045d2:	b725                	j	ffffffffc02044fa <do_fork+0x16e>
    assert(current->mm == NULL);
ffffffffc02045d4:	00002697          	auipc	a3,0x2
ffffffffc02045d8:	67c68693          	addi	a3,a3,1660 # ffffffffc0206c50 <default_pmm_manager+0x1010>
ffffffffc02045dc:	00001617          	auipc	a2,0x1
ffffffffc02045e0:	2b460613          	addi	a2,a2,692 # ffffffffc0205890 <commands+0x738>
ffffffffc02045e4:	10b00593          	li	a1,267
ffffffffc02045e8:	00002517          	auipc	a0,0x2
ffffffffc02045ec:	68050513          	addi	a0,a0,1664 # ffffffffc0206c68 <default_pmm_manager+0x1028>
ffffffffc02045f0:	e57fb0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc02045f4:	00001617          	auipc	a2,0x1
ffffffffc02045f8:	68460613          	addi	a2,a2,1668 # ffffffffc0205c78 <default_pmm_manager+0x38>
ffffffffc02045fc:	06900593          	li	a1,105
ffffffffc0204600:	00001517          	auipc	a0,0x1
ffffffffc0204604:	6a050513          	addi	a0,a0,1696 # ffffffffc0205ca0 <default_pmm_manager+0x60>
ffffffffc0204608:	e3ffb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc020460c <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc020460c:	7129                	addi	sp,sp,-320
ffffffffc020460e:	fa22                	sd	s0,304(sp)
ffffffffc0204610:	f626                	sd	s1,296(sp)
ffffffffc0204612:	f24a                	sd	s2,288(sp)
ffffffffc0204614:	84ae                	mv	s1,a1
ffffffffc0204616:	892a                	mv	s2,a0
ffffffffc0204618:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc020461a:	4581                	li	a1,0
ffffffffc020461c:	12000613          	li	a2,288
ffffffffc0204620:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc0204622:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0204624:	07f000ef          	jal	ra,ffffffffc0204ea2 <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc0204628:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc020462a:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc020462c:	100027f3          	csrr	a5,sstatus
ffffffffc0204630:	edd7f793          	andi	a5,a5,-291
ffffffffc0204634:	1207e793          	ori	a5,a5,288
ffffffffc0204638:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020463a:	860a                	mv	a2,sp
ffffffffc020463c:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0204640:	00000797          	auipc	a5,0x0
ffffffffc0204644:	bf478793          	addi	a5,a5,-1036 # ffffffffc0204234 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204648:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc020464a:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020464c:	d41ff0ef          	jal	ra,ffffffffc020438c <do_fork>
}
ffffffffc0204650:	70f2                	ld	ra,312(sp)
ffffffffc0204652:	7452                	ld	s0,304(sp)
ffffffffc0204654:	74b2                	ld	s1,296(sp)
ffffffffc0204656:	7912                	ld	s2,288(sp)
ffffffffc0204658:	6131                	addi	sp,sp,320
ffffffffc020465a:	8082                	ret

ffffffffc020465c <do_exit>:
do_exit(int error_code) {
ffffffffc020465c:	1141                	addi	sp,sp,-16
    panic("process exit!!.\n");
ffffffffc020465e:	00002617          	auipc	a2,0x2
ffffffffc0204662:	62260613          	addi	a2,a2,1570 # ffffffffc0206c80 <default_pmm_manager+0x1040>
ffffffffc0204666:	17000593          	li	a1,368
ffffffffc020466a:	00002517          	auipc	a0,0x2
ffffffffc020466e:	5fe50513          	addi	a0,a0,1534 # ffffffffc0206c68 <default_pmm_manager+0x1028>
do_exit(int error_code) {
ffffffffc0204672:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc0204674:	dd3fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204678 <proc_init>:

// proc_init - set up the first kernel thread idleproc "idle" by itself and 
//           - create the second kernel thread init_main
void
proc_init(void) {
ffffffffc0204678:	7179                	addi	sp,sp,-48
ffffffffc020467a:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc020467c:	00012797          	auipc	a5,0x12
ffffffffc0204680:	eac78793          	addi	a5,a5,-340 # ffffffffc0216528 <proc_list>
ffffffffc0204684:	f406                	sd	ra,40(sp)
ffffffffc0204686:	f022                	sd	s0,32(sp)
ffffffffc0204688:	e84a                	sd	s2,16(sp)
ffffffffc020468a:	e44e                	sd	s3,8(sp)
ffffffffc020468c:	0000e497          	auipc	s1,0xe
ffffffffc0204690:	e8c48493          	addi	s1,s1,-372 # ffffffffc0212518 <hash_list>
ffffffffc0204694:	e79c                	sd	a5,8(a5)
ffffffffc0204696:	e39c                	sd	a5,0(a5)
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
ffffffffc0204698:	00012717          	auipc	a4,0x12
ffffffffc020469c:	e8070713          	addi	a4,a4,-384 # ffffffffc0216518 <name.2>
ffffffffc02046a0:	87a6                	mv	a5,s1
ffffffffc02046a2:	e79c                	sd	a5,8(a5)
ffffffffc02046a4:	e39c                	sd	a5,0(a5)
ffffffffc02046a6:	07c1                	addi	a5,a5,16
ffffffffc02046a8:	fef71de3          	bne	a4,a5,ffffffffc02046a2 <proc_init+0x2a>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc02046ac:	b91ff0ef          	jal	ra,ffffffffc020423c <alloc_proc>
ffffffffc02046b0:	00012917          	auipc	s2,0x12
ffffffffc02046b4:	f0890913          	addi	s2,s2,-248 # ffffffffc02165b8 <idleproc>
ffffffffc02046b8:	00a93023          	sd	a0,0(s2)
ffffffffc02046bc:	18050d63          	beqz	a0,ffffffffc0204856 <proc_init+0x1de>
        panic("cannot alloc idleproc.\n");
    }

    // check the proc structure
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc02046c0:	07000513          	li	a0,112
...
ffffffffc02046ce:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02046d0:	7d2000ef          	jal	ra,ffffffffc0204ea2 <memset>
...
ffffffffc02046e2:	7ea000ef          	jal	ra,ffffffffc0204ecc <memcmp>
ffffffffc02046e6:	89aa                	mv	s3,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc02046e8:	453d                	li	a0,15
ffffffffc02046ea:	964fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
...
ffffffffc02046f2:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc02046f4:	7ae000ef          	jal	ra,ffffffffc0204ea2 <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc02046f8:	00093503          	ld	a0,0(s2)
ffffffffc02046fc:	463d                	li	a2,15
ffffffffc02046fe:	85a2                	mv	a1,s0
ffffffffc0204700:	0b450513          	addi	a0,a0,180
ffffffffc0204704:	7c8000ef          	jal	ra,ffffffffc0204ecc <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc0204708:	00093783          	ld	a5,0(s2)
ffffffffc020470c:	00012717          	auipc	a4,0x12
ffffffffc0204710:	e4c73703          	ld	a4,-436(a4) # ffffffffc0216558 <boot_cr3>
ffffffffc0204714:	77d4                	ld	a3,168(a5)
ffffffffc0204716:	0ee68463          	beq	a3,a4,ffffffffc02047fe <proc_init+0x186>
...
ffffffffc020471a:	4709                	li	a4,2
ffffffffc020471c:	e398                	sd	a4,0(a5)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc020471e:	00004717          	auipc	a4,0x4
ffffffffc0204722:	8e270713          	addi	a4,a4,-1822 # ffffffffc0208000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204726:	0b478413          	addi	s0,a5,180
    idleproc->kstack = (uintptr_t)bootstack;
...
ffffffffc0204736:	76c000ef          	jal	ra,ffffffffc0204ea2 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc020473a:	463d                	li	a2,15
ffffffffc020473c:	00002597          	auipc	a1,0x2
ffffffffc0204740:	58c58593          	addi	a1,a1,1420 # ffffffffc0206cc8 <default_pmm_manager+0x1088>
ffffffffc0204744:	8522                	mv	a0,s0
ffffffffc0204746:	76e000ef          	jal	ra,ffffffffc0204eb4 <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc020474a:	00012717          	auipc	a4,0x12
ffffffffc020474e:	e7e70713          	addi	a4,a4,-386 # ffffffffc02165c8 <nr_process>
ffffffffc0204752:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc0204754:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0204758:	4601                	li	a2,0
    nr_process ++;
ffffffffc020475a:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc020475c:	00002597          	auipc	a1,0x2
ffffffffc0204760:	57458593          	addi	a1,a1,1396 # ffffffffc0206cd0 <default_pmm_manager+0x1090>
ffffffffc0204764:	00000517          	auipc	a0,0x0
ffffffffc0204768:	b4850513          	addi	a0,a0,-1208 # ffffffffc02042ac <init_main>
    nr_process ++;
ffffffffc020476c:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc020476e:	00012797          	auipc	a5,0x12
ffffffffc0204772:	e4d7b123          	sd	a3,-446(a5) # ffffffffc02165b0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0204776:	e97ff0ef          	jal	ra,ffffffffc020460c <kernel_thread>
ffffffffc020477a:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc020477c:	0ea05963          	blez	a0,ffffffffc020486e <proc_init+0x1f6>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0204780:	6789                	lui	a5,0x2
ffffffffc0204782:	fff5071b          	addiw	a4,a0,-1
ffffffffc0204786:	17f9                	addi	a5,a5,-2
ffffffffc0204788:	2501                	sext.w	a0,a0
ffffffffc020478a:	02e7e363          	bltu	a5,a4,ffffffffc02047b0 <proc_init+0x138>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc020478e:	45a9                	li	a1,10
ffffffffc0204790:	292000ef          	jal	ra,ffffffffc0204a22 <hash32>
ffffffffc0204794:	02051793          	slli	a5,a0,0x20
ffffffffc0204798:	01c7d693          	srli	a3,a5,0x1c
ffffffffc020479c:	96a6                	add	a3,a3,s1
ffffffffc020479e:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc02047a0:	a029                	j	ffffffffc02047aa <proc_init+0x132>
            if (proc->pid == pid) {
ffffffffc02047a2:	f2c7a703          	lw	a4,-212(a5) # 1f2c <kern_entry-0xffffffffc01fe0d4>
ffffffffc02047a6:	0a870563          	beq	a4,s0,ffffffffc0204850 <proc_init+0x1d8>
    return listelm->next;
ffffffffc02047aa:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc02047ac:	fef69be3          	bne	a3,a5,ffffffffc02047a2 <proc_init+0x12a>
    return NULL;
ffffffffc02047b0:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047b2:	0b478493          	addi	s1,a5,180
ffffffffc02047b6:	4641                	li	a2,16
...
ffffffffc02047ba:	00012417          	auipc	s0,0x12
ffffffffc02047be:	e0640413          	addi	s0,s0,-506 # ffffffffc02165c0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047c2:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc02047c4:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047c6:	6dc000ef          	jal	ra,ffffffffc0204ea2 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02047ca:	463d                	li	a2,15
ffffffffc02047cc:	00002597          	auipc	a1,0x2
ffffffffc02047d0:	53458593          	addi	a1,a1,1332 # ffffffffc0206d00 <default_pmm_manager+0x10c0>
ffffffffc02047d4:	8526                	mv	a0,s1
ffffffffc02047d6:	6de000ef          	jal	ra,ffffffffc0204eb4 <memcpy>
...
ffffffffc02047de:	c7e1                	beqz	a5,ffffffffc02048a6 <proc_init+0x22e>
ffffffffc02047e0:	43dc                	lw	a5,4(a5)
ffffffffc02047e2:	e3f1                	bnez	a5,ffffffffc02048a6 <proc_init+0x22e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc02047e4:	601c                	ld	a5,0(s0)
ffffffffc02047e6:	c3c5                	beqz	a5,ffffffffc0204886 <proc_init+0x20e>
ffffffffc02047e8:	43d8                	lw	a4,4(a5)
ffffffffc02047ea:	4785                	li	a5,1
ffffffffc02047ec:	08f71d63          	bne	a4,a5,ffffffffc0204886 <proc_init+0x20e>
}
ffffffffc02047f0:	70a2                	ld	ra,40(sp)
ffffffffc02047f2:	7402                	ld	s0,32(sp)
ffffffffc02047f4:	64e2                	ld	s1,24(sp)
ffffffffc02047f6:	6942                	ld	s2,16(sp)
ffffffffc02047f8:	69a2                	ld	s3,8(sp)
ffffffffc02047fa:	6145                	addi	sp,sp,48
ffffffffc02047fc:	8082                	ret
    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc02047fe:	73d8                	ld	a4,160(a5)
ffffffffc0204800:	ff09                	bnez	a4,ffffffffc020471a <proc_init+0xa2>
ffffffffc0204802:	f0099ce3          	bnez	s3,ffffffffc020471a <proc_init+0xa2>
        && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0
ffffffffc0204806:	6394                	ld	a3,0(a5)
ffffffffc0204808:	577d                	li	a4,-1
ffffffffc020480a:	1702                	slli	a4,a4,0x20
ffffffffc020480c:	f0e697e3          	bne	a3,a4,ffffffffc020471a <proc_init+0xa2>
ffffffffc0204810:	4798                	lw	a4,8(a5)
ffffffffc0204812:	f00714e3          	bnez	a4,ffffffffc020471a <proc_init+0xa2>
        && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL
ffffffffc0204816:	6b98                	ld	a4,16(a5)
ffffffffc0204818:	f00711e3          	bnez	a4,ffffffffc020471a <proc_init+0xa2>
ffffffffc020481c:	4f98                	lw	a4,24(a5)
ffffffffc020481e:	2701                	sext.w	a4,a4
ffffffffc0204820:	ee071de3          	bnez	a4,ffffffffc020471a <proc_init+0xa2>
ffffffffc0204824:	7398                	ld	a4,32(a5)
ffffffffc0204826:	ee071ae3          	bnez	a4,ffffffffc020471a <proc_init+0xa2>
        && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag
ffffffffc020482a:	7798                	ld	a4,40(a5)
ffffffffc020482c:	ee0717e3          	bnez	a4,ffffffffc020471a <proc_init+0xa2>
ffffffffc0204830:	0b07a703          	lw	a4,176(a5)
ffffffffc0204834:	8d59                	or	a0,a0,a4
ffffffffc0204836:	0005071b          	sext.w	a4,a0
ffffffffc020483a:	ee0710e3          	bnez	a4,ffffffffc020471a <proc_init+0xa2>
        cprintf("alloc_proc() correct!\n");
ffffffffc020483e:	00002517          	auipc	a0,0x2
ffffffffc0204842:	47250513          	addi	a0,a0,1138 # ffffffffc0206cb0 <default_pmm_manager+0x1070>
ffffffffc0204846:	93bfb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    idleproc->pid = 0;
ffffffffc020484a:	00093783          	ld	a5,0(s2)
ffffffffc020484e:	b5f1                	j	ffffffffc020471a <proc_init+0xa2>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0204850:	f2878793          	addi	a5,a5,-216
ffffffffc0204854:	bfb9                	j	ffffffffc02047b2 <proc_init+0x13a>
        panic("cannot alloc idleproc.\n");
ffffffffc0204856:	00002617          	auipc	a2,0x2
ffffffffc020485a:	44260613          	addi	a2,a2,1090 # ffffffffc0206c98 <default_pmm_manager+0x1058>
ffffffffc020485e:	18800593          	li	a1,392
ffffffffc0204862:	00002517          	auipc	a0,0x2
ffffffffc0204866:	40650513          	addi	a0,a0,1030 # ffffffffc0206c68 <default_pmm_manager+0x1028>
ffffffffc020486a:	bddfb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("create init_main failed.\n");
ffffffffc020486e:	00002617          	auipc	a2,0x2
ffffffffc0204872:	47260613          	addi	a2,a2,1138 # ffffffffc0206ce0 <default_pmm_manager+0x10a0>
ffffffffc0204876:	1a800593          	li	a1,424
ffffffffc020487a:	00002517          	auipc	a0,0x2
ffffffffc020487e:	3ee50513          	addi	a0,a0,1006 # ffffffffc0206c68 <default_pmm_manager+0x1028>
ffffffffc0204882:	bc5fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204886:	00002697          	auipc	a3,0x2
ffffffffc020488a:	4aa68693          	addi	a3,a3,1194 # ffffffffc0206d30 <default_pmm_manager+0x10f0>
ffffffffc020488e:	00001617          	auipc	a2,0x1
ffffffffc0204892:	00260613          	addi	a2,a2,2 # ffffffffc0205890 <commands+0x738>
ffffffffc0204896:	1b200593          	li	a1,434
ffffffffc020489a:	00002517          	auipc	a0,0x2
ffffffffc020489e:	3ce50513          	addi	a0,a0,974 # ffffffffc0206c68 <default_pmm_manager+0x1028>
ffffffffc02048a2:	ba5fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc02048a6:	00002697          	auipc	a3,0x2
ffffffffc02048aa:	46268693          	addi	a3,a3,1122 # ffffffffc0206d08 <default_pmm_manager+0x10c8>
ffffffffc02048ae:	00001617          	auipc	a2,0x1
ffffffffc02048b2:	fe260613          	addi	a2,a2,-30 # ffffffffc0205890 <commands+0x738>
ffffffffc02048b6:	1b100593          	li	a1,433
ffffffffc02048ba:	00002517          	auipc	a0,0x2
ffffffffc02048be:	3ae50513          	addi	a0,a0,942 # ffffffffc0206c68 <default_pmm_manager+0x1028>
ffffffffc02048c2:	b85fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02048c6 <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc02048c6:	1101                	addi	sp,sp,-32
ffffffffc02048c8:	e822                	sd	s0,16(sp)
ffffffffc02048ca:	e426                	sd	s1,8(sp)
ffffffffc02048cc:	ec06                	sd	ra,24(sp)
ffffffffc02048ce:	00012497          	auipc	s1,0x12
ffffffffc02048d2:	ce248493          	addi	s1,s1,-798 # ffffffffc02165b0 <current>
    while (1) {
         cprintf("allasfdafsq!\n");
ffffffffc02048d6:	00002417          	auipc	s0,0x2
ffffffffc02048da:	48240413          	addi	s0,s0,1154 # ffffffffc0206d58 <default_pmm_manager+0x1118>
ffffffffc02048de:	8522                	mv	a0,s0
ffffffffc02048e0:	8a1fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
        if (current->need_resched) {
ffffffffc02048e4:	609c                	ld	a5,0(s1)
ffffffffc02048e6:	4f9c                	lw	a5,24(a5)
ffffffffc02048e8:	2781                	sext.w	a5,a5
ffffffffc02048ea:	dbf5                	beqz	a5,ffffffffc02048de <cpu_idle+0x18>
           
            schedule();
ffffffffc02048ec:	0a2000ef          	jal	ra,ffffffffc020498e <schedule>
ffffffffc02048f0:	b7fd                	j	ffffffffc02048de <cpu_idle+0x18>

ffffffffc02048f2 <switch_to>:
.text
...
ffffffffc02048f2:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc02048f6:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc02048fa:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc02048fc:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc02048fe:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc0204902:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0204906:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc020490a:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc020490e:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0204912:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0204916:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc020491a:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc020491e:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc0204922:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0204926:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc020492a:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc020492e:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc0204930:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc0204932:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0204936:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc020493a:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc020493e:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc0204942:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc0204946:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc020494a:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc020494e:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc0204952:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc0204956:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc020495a:	8082                	ret

ffffffffc020495c <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc020495c:	411c                	lw	a5,0(a0)
ffffffffc020495e:	4705                	li	a4,1
ffffffffc0204960:	37f9                	addiw	a5,a5,-2
ffffffffc0204962:	00f77563          	bgeu	a4,a5,ffffffffc020496c <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc0204966:	4789                	li	a5,2
ffffffffc0204968:	c11c                	sw	a5,0(a0)
ffffffffc020496a:	8082                	ret
wakeup_proc(struct proc_struct *proc) {
ffffffffc020496c:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc020496e:	00002697          	auipc	a3,0x2
ffffffffc0204972:	3fa68693          	addi	a3,a3,1018 # ffffffffc0206d68 <default_pmm_manager+0x1128>
ffffffffc0204976:	00001617          	auipc	a2,0x1
ffffffffc020497a:	f1a60613          	addi	a2,a2,-230 # ffffffffc0205890 <commands+0x738>
ffffffffc020497e:	45a5                	li	a1,9
ffffffffc0204980:	00002517          	auipc	a0,0x2
ffffffffc0204984:	42850513          	addi	a0,a0,1064 # ffffffffc0206da8 <default_pmm_manager+0x1168>
wakeup_proc(struct proc_struct *proc) {
ffffffffc0204988:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc020498a:	abdfb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc020498e <schedule>:
}

void
schedule(void) {
ffffffffc020498e:	1141                	addi	sp,sp,-16
ffffffffc0204990:	e406                	sd	ra,8(sp)
ffffffffc0204992:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204994:	100027f3          	csrr	a5,sstatus
ffffffffc0204998:	8b89                	andi	a5,a5,2
ffffffffc020499a:	4401                	li	s0,0
ffffffffc020499c:	efbd                	bnez	a5,ffffffffc0204a1a <schedule+0x8c>
    bool intr_flag;
...
ffffffffc020499e:	00012897          	auipc	a7,0x12
ffffffffc02049a2:	c128b883          	ld	a7,-1006(a7) # ffffffffc02165b0 <current>
ffffffffc02049a6:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02049aa:	00012517          	auipc	a0,0x12
ffffffffc02049ae:	c0e53503          	ld	a0,-1010(a0) # ffffffffc02165b8 <idleproc>
ffffffffc02049b2:	04a88e63          	beq	a7,a0,ffffffffc0204a0e <schedule+0x80>
ffffffffc02049b6:	0c888693          	addi	a3,a7,200
ffffffffc02049ba:	00012617          	auipc	a2,0x12
ffffffffc02049be:	b6e60613          	addi	a2,a2,-1170 # ffffffffc0216528 <proc_list>
        le = last;
ffffffffc02049c2:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
...
ffffffffc02049c6:	4809                	li	a6,2
ffffffffc02049c8:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc02049ca:	00c78863          	beq	a5,a2,ffffffffc02049da <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc02049ce:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc02049d2:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc02049d6:	03070163          	beq	a4,a6,ffffffffc02049f8 <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc02049da:	fef697e3          	bne	a3,a5,ffffffffc02049c8 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc02049de:	ed89                	bnez	a1,ffffffffc02049f8 <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc02049e0:	451c                	lw	a5,8(a0)
ffffffffc02049e2:	2785                	addiw	a5,a5,1
ffffffffc02049e4:	c51c                	sw	a5,8(a0)
        //cprintf("Towqrqrqwn\n\n");
        if (next != current) {
ffffffffc02049e6:	00a88463          	beq	a7,a0,ffffffffc02049ee <schedule+0x60>
            proc_run(next);
ffffffffc02049ea:	935ff0ef          	jal	ra,ffffffffc020431e <proc_run>
    if (flag) {
ffffffffc02049ee:	e819                	bnez	s0,ffffffffc0204a04 <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
...
ffffffffc02049f6:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc02049f8:	4198                	lw	a4,0(a1)
ffffffffc02049fa:	4789                	li	a5,2
ffffffffc02049fc:	fef712e3          	bne	a4,a5,ffffffffc02049e0 <schedule+0x52>
ffffffffc0204a00:	852e                	mv	a0,a1
ffffffffc0204a02:	bff9                	j	ffffffffc02049e0 <schedule+0x52>
}
ffffffffc0204a04:	6402                	ld	s0,0(sp)
ffffffffc0204a06:	60a2                	ld	ra,8(sp)
ffffffffc0204a08:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0204a0a:	bb3fb06f          	j	ffffffffc02005bc <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204a0e:	00012617          	auipc	a2,0x12
ffffffffc0204a12:	b1a60613          	addi	a2,a2,-1254 # ffffffffc0216528 <proc_list>
ffffffffc0204a16:	86b2                	mv	a3,a2
ffffffffc0204a18:	b76d                	j	ffffffffc02049c2 <schedule+0x34>
        intr_disable();
ffffffffc0204a1a:	ba9fb0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204a1e:	4405                	li	s0,1
ffffffffc0204a20:	bfbd                	j	ffffffffc020499e <schedule+0x10>

ffffffffc0204a22 <hash32>:
 *
...
ffffffffc0204a22:	9e3707b7          	lui	a5,0x9e370
ffffffffc0204a26:	2785                	addiw	a5,a5,1
ffffffffc0204a28:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc0204a2c:	02000793          	li	a5,32
ffffffffc0204a30:	9f8d                	subw	a5,a5,a1
}
ffffffffc0204a32:	00f5553b          	srlw	a0,a0,a5
ffffffffc0204a36:	8082                	ret

ffffffffc0204a38 <printnum>:
 * */
static void
...
ffffffffc0204a38:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a3c:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0204a3e:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a42:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0204a44:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a48:	f022                	sd	s0,32(sp)
ffffffffc0204a4a:	ec26                	sd	s1,24(sp)
ffffffffc0204a4c:	e84a                	sd	s2,16(sp)
ffffffffc0204a4e:	f406                	sd	ra,40(sp)
ffffffffc0204a50:	e44e                	sd	s3,8(sp)
ffffffffc0204a52:	84aa                	mv	s1,a0
ffffffffc0204a54:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0204a56:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0204a5a:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0204a5c:	03067e63          	bgeu	a2,a6,ffffffffc0204a98 <printnum+0x60>
ffffffffc0204a60:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0204a62:	00805763          	blez	s0,ffffffffc0204a70 <printnum+0x38>
ffffffffc0204a66:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0204a68:	85ca                	mv	a1,s2
ffffffffc0204a6a:	854e                	mv	a0,s3
ffffffffc0204a6c:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0204a6e:	fc65                	bnez	s0,ffffffffc0204a66 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a70:	1a02                	slli	s4,s4,0x20
ffffffffc0204a72:	00002797          	auipc	a5,0x2
ffffffffc0204a76:	34e78793          	addi	a5,a5,846 # ffffffffc0206dc0 <default_pmm_manager+0x1180>
ffffffffc0204a7a:	020a5a13          	srli	s4,s4,0x20
ffffffffc0204a7e:	9a3e                	add	s4,s4,a5
}
ffffffffc0204a80:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a82:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0204a86:	70a2                	ld	ra,40(sp)
ffffffffc0204a88:	69a2                	ld	s3,8(sp)
ffffffffc0204a8a:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a8c:	85ca                	mv	a1,s2
ffffffffc0204a8e:	87a6                	mv	a5,s1
}
ffffffffc0204a90:	6942                	ld	s2,16(sp)
ffffffffc0204a92:	64e2                	ld	s1,24(sp)
ffffffffc0204a94:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a96:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204a98:	03065633          	divu	a2,a2,a6
ffffffffc0204a9c:	8722                	mv	a4,s0
ffffffffc0204a9e:	f9bff0ef          	jal	ra,ffffffffc0204a38 <printnum>
ffffffffc0204aa2:	b7f9                	j	ffffffffc0204a70 <printnum+0x38>

ffffffffc0204aa4 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0204aa4:	7119                	addi	sp,sp,-128
ffffffffc0204aa6:	f4a6                	sd	s1,104(sp)
ffffffffc0204aa8:	f0ca                	sd	s2,96(sp)
ffffffffc0204aaa:	ecce                	sd	s3,88(sp)
ffffffffc0204aac:	e8d2                	sd	s4,80(sp)
ffffffffc0204aae:	e4d6                	sd	s5,72(sp)
ffffffffc0204ab0:	e0da                	sd	s6,64(sp)
ffffffffc0204ab2:	fc5e                	sd	s7,56(sp)
ffffffffc0204ab4:	f06a                	sd	s10,32(sp)
ffffffffc0204ab6:	fc86                	sd	ra,120(sp)
ffffffffc0204ab8:	f8a2                	sd	s0,112(sp)
ffffffffc0204aba:	f862                	sd	s8,48(sp)
ffffffffc0204abc:	f466                	sd	s9,40(sp)
ffffffffc0204abe:	ec6e                	sd	s11,24(sp)
ffffffffc0204ac0:	892a                	mv	s2,a0
ffffffffc0204ac2:	84ae                	mv	s1,a1
ffffffffc0204ac4:	8d32                	mv	s10,a2
ffffffffc0204ac6:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204ac8:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0204acc:	5b7d                	li	s6,-1
ffffffffc0204ace:	00002a97          	auipc	s5,0x2
ffffffffc0204ad2:	31ea8a93          	addi	s5,s5,798 # ffffffffc0206dec <default_pmm_manager+0x11ac>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204ad6:	00002b97          	auipc	s7,0x2
ffffffffc0204ada:	4f2b8b93          	addi	s7,s7,1266 # ffffffffc0206fc8 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204ade:	000d4503          	lbu	a0,0(s10)
ffffffffc0204ae2:	001d0413          	addi	s0,s10,1
ffffffffc0204ae6:	01350a63          	beq	a0,s3,ffffffffc0204afa <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204aea:	c121                	beqz	a0,ffffffffc0204b2a <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0204aec:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204aee:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0204af0:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204af2:	fff44503          	lbu	a0,-1(s0)
ffffffffc0204af6:	ff351ae3          	bne	a0,s3,ffffffffc0204aea <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204afa:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204afe:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204b02:	4c81                	li	s9,0
ffffffffc0204b04:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204b06:	5c7d                	li	s8,-1
ffffffffc0204b08:	5dfd                	li	s11,-1
ffffffffc0204b0a:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204b0e:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b10:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b14:	0ff5f593          	andi	a1,a1,255
ffffffffc0204b18:	00140d13          	addi	s10,s0,1
ffffffffc0204b1c:	04b56263          	bltu	a0,a1,ffffffffc0204b60 <vprintfmt+0xbc>
ffffffffc0204b20:	058a                	slli	a1,a1,0x2
ffffffffc0204b22:	95d6                	add	a1,a1,s5
ffffffffc0204b24:	4194                	lw	a3,0(a1)
ffffffffc0204b26:	96d6                	add	a3,a3,s5
ffffffffc0204b28:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0204b2a:	70e6                	ld	ra,120(sp)
ffffffffc0204b2c:	7446                	ld	s0,112(sp)
ffffffffc0204b2e:	74a6                	ld	s1,104(sp)
ffffffffc0204b30:	7906                	ld	s2,96(sp)
ffffffffc0204b32:	69e6                	ld	s3,88(sp)
ffffffffc0204b34:	6a46                	ld	s4,80(sp)
ffffffffc0204b36:	6aa6                	ld	s5,72(sp)
ffffffffc0204b38:	6b06                	ld	s6,64(sp)
ffffffffc0204b3a:	7be2                	ld	s7,56(sp)
ffffffffc0204b3c:	7c42                	ld	s8,48(sp)
ffffffffc0204b3e:	7ca2                	ld	s9,40(sp)
ffffffffc0204b40:	7d02                	ld	s10,32(sp)
ffffffffc0204b42:	6de2                	ld	s11,24(sp)
ffffffffc0204b44:	6109                	addi	sp,sp,128
ffffffffc0204b46:	8082                	ret
            padc = '0';
ffffffffc0204b48:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204b4a:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b4e:	846a                	mv	s0,s10
ffffffffc0204b50:	00140d13          	addi	s10,s0,1
ffffffffc0204b54:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b58:	0ff5f593          	andi	a1,a1,255
ffffffffc0204b5c:	fcb572e3          	bgeu	a0,a1,ffffffffc0204b20 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204b60:	85a6                	mv	a1,s1
ffffffffc0204b62:	02500513          	li	a0,37
ffffffffc0204b66:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204b68:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204b6c:	8d22                	mv	s10,s0
ffffffffc0204b6e:	f73788e3          	beq	a5,s3,ffffffffc0204ade <vprintfmt+0x3a>
ffffffffc0204b72:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204b76:	1d7d                	addi	s10,s10,-1
ffffffffc0204b78:	ff379de3          	bne	a5,s3,ffffffffc0204b72 <vprintfmt+0xce>
ffffffffc0204b7c:	b78d                	j	ffffffffc0204ade <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204b7e:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204b82:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b86:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204b88:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204b8c:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204b90:	02d86463          	bltu	a6,a3,ffffffffc0204bb8 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204b94:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204b98:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204b9c:	0186873b          	addw	a4,a3,s8
ffffffffc0204ba0:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204ba4:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204ba6:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204baa:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204bac:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204bb0:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204bb4:	fed870e3          	bgeu	a6,a3,ffffffffc0204b94 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204bb8:	f40ddce3          	bgez	s11,ffffffffc0204b10 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204bbc:	8de2                	mv	s11,s8
ffffffffc0204bbe:	5c7d                	li	s8,-1
ffffffffc0204bc0:	bf81                	j	ffffffffc0204b10 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204bc2:	fffdc693          	not	a3,s11
ffffffffc0204bc6:	96fd                	srai	a3,a3,0x3f
ffffffffc0204bc8:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bcc:	00144603          	lbu	a2,1(s0)
ffffffffc0204bd0:	2d81                	sext.w	s11,s11
ffffffffc0204bd2:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204bd4:	bf35                	j	ffffffffc0204b10 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204bd6:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bda:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204bde:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204be0:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0204be2:	bfd9                	j	ffffffffc0204bb8 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204be4:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204be6:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204bea:	01174463          	blt	a4,a7,ffffffffc0204bf2 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204bee:	1a088e63          	beqz	a7,ffffffffc0204daa <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204bf2:	000a3603          	ld	a2,0(s4)
ffffffffc0204bf6:	46c1                	li	a3,16
ffffffffc0204bf8:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204bfa:	2781                	sext.w	a5,a5
ffffffffc0204bfc:	876e                	mv	a4,s11
ffffffffc0204bfe:	85a6                	mv	a1,s1
ffffffffc0204c00:	854a                	mv	a0,s2
ffffffffc0204c02:	e37ff0ef          	jal	ra,ffffffffc0204a38 <printnum>
            break;
ffffffffc0204c06:	bde1                	j	ffffffffc0204ade <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204c08:	000a2503          	lw	a0,0(s4)
ffffffffc0204c0c:	85a6                	mv	a1,s1
ffffffffc0204c0e:	0a21                	addi	s4,s4,8
ffffffffc0204c10:	9902                	jalr	s2
            break;
ffffffffc0204c12:	b5f1                	j	ffffffffc0204ade <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204c14:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c16:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c1a:	01174463          	blt	a4,a7,ffffffffc0204c22 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204c1e:	18088163          	beqz	a7,ffffffffc0204da0 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204c22:	000a3603          	ld	a2,0(s4)
ffffffffc0204c26:	46a9                	li	a3,10
ffffffffc0204c28:	8a2e                	mv	s4,a1
ffffffffc0204c2a:	bfc1                	j	ffffffffc0204bfa <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c2c:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204c30:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c32:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c34:	bdf1                	j	ffffffffc0204b10 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204c36:	85a6                	mv	a1,s1
ffffffffc0204c38:	02500513          	li	a0,37
ffffffffc0204c3c:	9902                	jalr	s2
            break;
ffffffffc0204c3e:	b545                	j	ffffffffc0204ade <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c40:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204c44:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c46:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c48:	b5e1                	j	ffffffffc0204b10 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204c4a:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c4c:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c50:	01174463          	blt	a4,a7,ffffffffc0204c58 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204c54:	14088163          	beqz	a7,ffffffffc0204d96 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204c58:	000a3603          	ld	a2,0(s4)
ffffffffc0204c5c:	46a1                	li	a3,8
ffffffffc0204c5e:	8a2e                	mv	s4,a1
ffffffffc0204c60:	bf69                	j	ffffffffc0204bfa <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204c62:	03000513          	li	a0,48
ffffffffc0204c66:	85a6                	mv	a1,s1
ffffffffc0204c68:	e03e                	sd	a5,0(sp)
ffffffffc0204c6a:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204c6c:	85a6                	mv	a1,s1
ffffffffc0204c6e:	07800513          	li	a0,120
ffffffffc0204c72:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c74:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204c76:	6782                	ld	a5,0(sp)
ffffffffc0204c78:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c7a:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204c7e:	bfb5                	j	ffffffffc0204bfa <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204c80:	000a3403          	ld	s0,0(s4)
ffffffffc0204c84:	008a0713          	addi	a4,s4,8
ffffffffc0204c88:	e03a                	sd	a4,0(sp)
ffffffffc0204c8a:	14040263          	beqz	s0,ffffffffc0204dce <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204c8e:	0fb05763          	blez	s11,ffffffffc0204d7c <vprintfmt+0x2d8>
ffffffffc0204c92:	02d00693          	li	a3,45
ffffffffc0204c96:	0cd79163          	bne	a5,a3,ffffffffc0204d58 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c9a:	00044783          	lbu	a5,0(s0)
ffffffffc0204c9e:	0007851b          	sext.w	a0,a5
ffffffffc0204ca2:	cf85                	beqz	a5,ffffffffc0204cda <vprintfmt+0x236>
ffffffffc0204ca4:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204ca8:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204cac:	000c4563          	bltz	s8,ffffffffc0204cb6 <vprintfmt+0x212>
ffffffffc0204cb0:	3c7d                	addiw	s8,s8,-1
ffffffffc0204cb2:	036c0263          	beq	s8,s6,ffffffffc0204cd6 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204cb6:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204cb8:	0e0c8e63          	beqz	s9,ffffffffc0204db4 <vprintfmt+0x310>
ffffffffc0204cbc:	3781                	addiw	a5,a5,-32
ffffffffc0204cbe:	0ef47b63          	bgeu	s0,a5,ffffffffc0204db4 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204cc2:	03f00513          	li	a0,63
ffffffffc0204cc6:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204cc8:	000a4783          	lbu	a5,0(s4)
ffffffffc0204ccc:	3dfd                	addiw	s11,s11,-1
ffffffffc0204cce:	0a05                	addi	s4,s4,1
ffffffffc0204cd0:	0007851b          	sext.w	a0,a5
ffffffffc0204cd4:	ffe1                	bnez	a5,ffffffffc0204cac <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204cd6:	01b05963          	blez	s11,ffffffffc0204ce8 <vprintfmt+0x244>
ffffffffc0204cda:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204cdc:	85a6                	mv	a1,s1
ffffffffc0204cde:	02000513          	li	a0,32
ffffffffc0204ce2:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204ce4:	fe0d9be3          	bnez	s11,ffffffffc0204cda <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204ce8:	6a02                	ld	s4,0(sp)
ffffffffc0204cea:	bbd5                	j	ffffffffc0204ade <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204cec:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204cee:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204cf2:	01174463          	blt	a4,a7,ffffffffc0204cfa <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204cf6:	08088d63          	beqz	a7,ffffffffc0204d90 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204cfa:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204cfe:	0a044d63          	bltz	s0,ffffffffc0204db8 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204d02:	8622                	mv	a2,s0
ffffffffc0204d04:	8a66                	mv	s4,s9
ffffffffc0204d06:	46a9                	li	a3,10
ffffffffc0204d08:	bdcd                	j	ffffffffc0204bfa <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204d0a:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d0e:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204d10:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204d12:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204d16:	8fb5                	xor	a5,a5,a3
ffffffffc0204d18:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d1c:	02d74163          	blt	a4,a3,ffffffffc0204d3e <vprintfmt+0x29a>
ffffffffc0204d20:	00369793          	slli	a5,a3,0x3
ffffffffc0204d24:	97de                	add	a5,a5,s7
ffffffffc0204d26:	639c                	ld	a5,0(a5)
ffffffffc0204d28:	cb99                	beqz	a5,ffffffffc0204d3e <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204d2a:	86be                	mv	a3,a5
ffffffffc0204d2c:	00000617          	auipc	a2,0x0
ffffffffc0204d30:	1ec60613          	addi	a2,a2,492 # ffffffffc0204f18 <etext+0x28>
ffffffffc0204d34:	85a6                	mv	a1,s1
ffffffffc0204d36:	854a                	mv	a0,s2
ffffffffc0204d38:	0ce000ef          	jal	ra,ffffffffc0204e06 <printfmt>
ffffffffc0204d3c:	b34d                	j	ffffffffc0204ade <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204d3e:	00002617          	auipc	a2,0x2
ffffffffc0204d42:	0a260613          	addi	a2,a2,162 # ffffffffc0206de0 <default_pmm_manager+0x11a0>
ffffffffc0204d46:	85a6                	mv	a1,s1
ffffffffc0204d48:	854a                	mv	a0,s2
ffffffffc0204d4a:	0bc000ef          	jal	ra,ffffffffc0204e06 <printfmt>
ffffffffc0204d4e:	bb41                	j	ffffffffc0204ade <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204d50:	00002417          	auipc	s0,0x2
ffffffffc0204d54:	08840413          	addi	s0,s0,136 # ffffffffc0206dd8 <default_pmm_manager+0x1198>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d58:	85e2                	mv	a1,s8
ffffffffc0204d5a:	8522                	mv	a0,s0
ffffffffc0204d5c:	e43e                	sd	a5,8(sp)
ffffffffc0204d5e:	0e2000ef          	jal	ra,ffffffffc0204e40 <strnlen>
ffffffffc0204d62:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204d66:	01b05b63          	blez	s11,ffffffffc0204d7c <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204d6a:	67a2                	ld	a5,8(sp)
ffffffffc0204d6c:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d70:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204d72:	85a6                	mv	a1,s1
ffffffffc0204d74:	8552                	mv	a0,s4
ffffffffc0204d76:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d78:	fe0d9ce3          	bnez	s11,ffffffffc0204d70 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d7c:	00044783          	lbu	a5,0(s0)
ffffffffc0204d80:	00140a13          	addi	s4,s0,1
ffffffffc0204d84:	0007851b          	sext.w	a0,a5
ffffffffc0204d88:	d3a5                	beqz	a5,ffffffffc0204ce8 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204d8a:	05e00413          	li	s0,94
ffffffffc0204d8e:	bf39                	j	ffffffffc0204cac <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204d90:	000a2403          	lw	s0,0(s4)
ffffffffc0204d94:	b7ad                	j	ffffffffc0204cfe <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204d96:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d9a:	46a1                	li	a3,8
ffffffffc0204d9c:	8a2e                	mv	s4,a1
ffffffffc0204d9e:	bdb1                	j	ffffffffc0204bfa <vprintfmt+0x156>
ffffffffc0204da0:	000a6603          	lwu	a2,0(s4)
ffffffffc0204da4:	46a9                	li	a3,10
ffffffffc0204da6:	8a2e                	mv	s4,a1
ffffffffc0204da8:	bd89                	j	ffffffffc0204bfa <vprintfmt+0x156>
ffffffffc0204daa:	000a6603          	lwu	a2,0(s4)
ffffffffc0204dae:	46c1                	li	a3,16
ffffffffc0204db0:	8a2e                	mv	s4,a1
ffffffffc0204db2:	b5a1                	j	ffffffffc0204bfa <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204db4:	9902                	jalr	s2
ffffffffc0204db6:	bf09                	j	ffffffffc0204cc8 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204db8:	85a6                	mv	a1,s1
ffffffffc0204dba:	02d00513          	li	a0,45
ffffffffc0204dbe:	e03e                	sd	a5,0(sp)
ffffffffc0204dc0:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204dc2:	6782                	ld	a5,0(sp)
ffffffffc0204dc4:	8a66                	mv	s4,s9
ffffffffc0204dc6:	40800633          	neg	a2,s0
ffffffffc0204dca:	46a9                	li	a3,10
ffffffffc0204dcc:	b53d                	j	ffffffffc0204bfa <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204dce:	03b05163          	blez	s11,ffffffffc0204df0 <vprintfmt+0x34c>
ffffffffc0204dd2:	02d00693          	li	a3,45
ffffffffc0204dd6:	f6d79de3          	bne	a5,a3,ffffffffc0204d50 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204dda:	00002417          	auipc	s0,0x2
ffffffffc0204dde:	ffe40413          	addi	s0,s0,-2 # ffffffffc0206dd8 <default_pmm_manager+0x1198>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204de2:	02800793          	li	a5,40
ffffffffc0204de6:	02800513          	li	a0,40
ffffffffc0204dea:	00140a13          	addi	s4,s0,1
ffffffffc0204dee:	bd6d                	j	ffffffffc0204ca8 <vprintfmt+0x204>
ffffffffc0204df0:	00002a17          	auipc	s4,0x2
ffffffffc0204df4:	fe9a0a13          	addi	s4,s4,-23 # ffffffffc0206dd9 <default_pmm_manager+0x1199>
ffffffffc0204df8:	02800513          	li	a0,40
ffffffffc0204dfc:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204e00:	05e00413          	li	s0,94
ffffffffc0204e04:	b565                	j	ffffffffc0204cac <vprintfmt+0x208>
...
ffffffffc0204e1a:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204e1c:	c89ff0ef          	jal	ra,ffffffffc0204aa4 <vprintfmt>
}
...
strlen(const char *s) {
ffffffffc0204e2a:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204e2c:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204e2e:	cb81                	beqz	a5,ffffffffc0204e3e <strlen+0x18>
        cnt ++;
ffffffffc0204e30:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204e32:	00a707b3          	add	a5,a4,a0
ffffffffc0204e36:	0007c783          	lbu	a5,0(a5)
ffffffffc0204e3a:	fbfd                	bnez	a5,ffffffffc0204e30 <strlen+0xa>
...
ffffffffc0204e40:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e42:	e589                	bnez	a1,ffffffffc0204e4c <strnlen+0xc>
ffffffffc0204e44:	a811                	j	ffffffffc0204e58 <strnlen+0x18>
        cnt ++;
ffffffffc0204e46:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e48:	00f58863          	beq	a1,a5,ffffffffc0204e58 <strnlen+0x18>
ffffffffc0204e4c:	00f50733          	add	a4,a0,a5
ffffffffc0204e50:	00074703          	lbu	a4,0(a4)
ffffffffc0204e54:	fb6d                	bnez	a4,ffffffffc0204e46 <strnlen+0x6>
ffffffffc0204e56:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204e58:	852e                	mv	a0,a1
ffffffffc0204e5a:	8082                	ret

ffffffffc0204e5c <strcpy>:
char *
...
ffffffffc0204e62:	0785                	addi	a5,a5,1
ffffffffc0204e64:	0585                	addi	a1,a1,1
ffffffffc0204e66:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204e6a:	fb75                	bnez	a4,ffffffffc0204e5e <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0204e72:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e76:	cb89                	beqz	a5,ffffffffc0204e88 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204e78:	0505                	addi	a0,a0,1
ffffffffc0204e7a:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e7c:	fee789e3          	beq	a5,a4,ffffffffc0204e6e <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e80:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204e84:	9d19                	subw	a0,a0,a4
ffffffffc0204e86:	8082                	ret
ffffffffc0204e88:	4501                	li	a0,0
ffffffffc0204e8a:	bfed                	j	ffffffffc0204e84 <strcmp+0x16>

ffffffffc0204e8c <strchr>:
...
ffffffffc0204e90:	c799                	beqz	a5,ffffffffc0204e9e <strchr+0x12>
        if (*s == c) {
ffffffffc0204e92:	00f58763          	beq	a1,a5,ffffffffc0204ea0 <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204e96:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204e9a:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204e9c:	fbfd                	bnez	a5,ffffffffc0204e92 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204ea2:	ca01                	beqz	a2,ffffffffc0204eb2 <memset+0x10>
ffffffffc0204ea4:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204ea6:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204ea8:	0785                	addi	a5,a5,1
ffffffffc0204eaa:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204eae:	fec79de3          	bne	a5,a2,ffffffffc0204ea8 <memset+0x6>
    }
    return s;
...
ffffffffc0204eb4 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204eb4:	ca19                	beqz	a2,ffffffffc0204eca <memcpy+0x16>
ffffffffc0204eb6:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204eb8:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204eba:	0005c703          	lbu	a4,0(a1)
ffffffffc0204ebe:	0585                	addi	a1,a1,1
ffffffffc0204ec0:	0785                	addi	a5,a5,1
ffffffffc0204ec2:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204ec6:	fec59ae3          	bne	a1,a2,ffffffffc0204eba <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204ecc:	c205                	beqz	a2,ffffffffc0204eec <memcmp+0x20>
ffffffffc0204ece:	962e                	add	a2,a2,a1
ffffffffc0204ed0:	a019                	j	ffffffffc0204ed6 <memcmp+0xa>
ffffffffc0204ed2:	00c58d63          	beq	a1,a2,ffffffffc0204eec <memcmp+0x20>
        if (*s1 != *s2) {
...
ffffffffc0204eda:	0005c703          	lbu	a4,0(a1)
        ...
        s1 ++, s2 ++;
ffffffffc0204ede:	0505                	addi	a0,a0,1
ffffffffc0204ee0:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0204ee2:	fee788e3          	beq	a5,a4,ffffffffc0204ed2 <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204ee6:	40e7853b          	subw	a0,a5,a4
