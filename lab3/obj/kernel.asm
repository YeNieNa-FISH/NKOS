...
ffffffffc020003e:	52260613          	addi	a2,a2,1314 # ffffffffc021155c <end>
kern_init(void) {
...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	2fc040ef          	jal	ra,ffffffffc0204346 <memset>
...
ffffffffc020006e:	586030ef          	jal	ra,ffffffffc02035f4 <vmm_init>
...
ffffffffc02000ac:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000ae:	5e7030ef          	jal	ra,ffffffffc0203e94 <vprintfmt>
    return cnt;
}
...
ffffffffc02000e2:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e4:	5b1030ef          	jal	ra,ffffffffc0203e94 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200108:	29450513          	addi	a0,a0,660 # ffffffffc0204398 <etext+0x28>
void print_kerninfo(void) {
...
ffffffffc020011e:	29e50513          	addi	a0,a0,670 # ffffffffc02043b8 <etext+0x48>
ffffffffc0200122:	f99ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200126:	00004597          	auipc	a1,0x4
ffffffffc020012a:	24a58593          	addi	a1,a1,586 # ffffffffc0204370 <etext>
ffffffffc020012e:	00004517          	auipc	a0,0x4
ffffffffc0200132:	2aa50513          	addi	a0,a0,682 # ffffffffc02043d8 <etext+0x68>
...
ffffffffc0200146:	2b650513          	addi	a0,a0,694 # ffffffffc02043f8 <etext+0x88>
ffffffffc020014a:	f71ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  end    0x%08x (virtual)\n", end);
ffffffffc020014e:	00011597          	auipc	a1,0x11
ffffffffc0200152:	40e58593          	addi	a1,a1,1038 # ffffffffc021155c <end>
ffffffffc0200156:	00004517          	auipc	a0,0x4
ffffffffc020015a:	2c250513          	addi	a0,a0,706 # ffffffffc0204418 <etext+0xa8>
ffffffffc020015e:	f5dff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("Kernel executable memory footprint: %dKB\n",
            (end - kern_init + 1023) / 1024);
ffffffffc0200162:	00011597          	auipc	a1,0x11
ffffffffc0200166:	7f958593          	addi	a1,a1,2041 # ffffffffc021195b <end+0x3ff>
...
ffffffffc0200188:	2b450513          	addi	a0,a0,692 # ffffffffc0204438 <etext+0xc8>
}
...
ffffffffc0200196:	2d660613          	addi	a2,a2,726 # ffffffffc0204468 <etext+0xf8>
ffffffffc020019a:	04e00593          	li	a1,78
ffffffffc020019e:	00004517          	auipc	a0,0x4
ffffffffc02001a2:	2e250513          	addi	a0,a0,738 # ffffffffc0204480 <etext+0x110>
void print_stackframe(void) {
...
ffffffffc02001b2:	2ea60613          	addi	a2,a2,746 # ffffffffc0204498 <etext+0x128>
ffffffffc02001b6:	00004597          	auipc	a1,0x4
ffffffffc02001ba:	30258593          	addi	a1,a1,770 # ffffffffc02044b8 <etext+0x148>
ffffffffc02001be:	00004517          	auipc	a0,0x4
ffffffffc02001c2:	30250513          	addi	a0,a0,770 # ffffffffc02044c0 <etext+0x150>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d0:	30460613          	addi	a2,a2,772 # ffffffffc02044d0 <etext+0x160>
ffffffffc02001d4:	00004597          	auipc	a1,0x4
ffffffffc02001d8:	32458593          	addi	a1,a1,804 # ffffffffc02044f8 <etext+0x188>
ffffffffc02001dc:	00004517          	auipc	a0,0x4
ffffffffc02001e0:	2e450513          	addi	a0,a0,740 # ffffffffc02044c0 <etext+0x150>
ffffffffc02001e4:	ed7ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc02001e8:	00004617          	auipc	a2,0x4
ffffffffc02001ec:	32060613          	addi	a2,a2,800 # ffffffffc0204508 <etext+0x198>
ffffffffc02001f0:	00004597          	auipc	a1,0x4
ffffffffc02001f4:	33858593          	addi	a1,a1,824 # ffffffffc0204528 <etext+0x1b8>
ffffffffc02001f8:	00004517          	auipc	a0,0x4
ffffffffc02001fc:	2c850513          	addi	a0,a0,712 # ffffffffc02044c0 <etext+0x150>
...
ffffffffc0200236:	30650513          	addi	a0,a0,774 # ffffffffc0204538 <etext+0x1c8>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200258:	30c50513          	addi	a0,a0,780 # ffffffffc0204560 <etext+0x1f0>
...
ffffffffc020026e:	35ec0c13          	addi	s8,s8,862 # ffffffffc02045c8 <commands>
        if ((buf = readline("")) != NULL) {
ffffffffc0200272:	00005917          	auipc	s2,0x5
ffffffffc0200276:	76690913          	addi	s2,s2,1894 # ffffffffc02059d8 <default_pmm_manager+0x928>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020027a:	00004497          	auipc	s1,0x4
ffffffffc020027e:	30e48493          	addi	s1,s1,782 # ffffffffc0204588 <etext+0x218>
        if (argc == MAXARGS - 1) {
ffffffffc0200282:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200284:	00004b17          	auipc	s6,0x4
ffffffffc0200288:	30cb0b13          	addi	s6,s6,780 # ffffffffc0204590 <etext+0x220>
        argv[argc ++] = buf;
ffffffffc020028c:	00004a17          	auipc	s4,0x4
ffffffffc0200290:	22ca0a13          	addi	s4,s4,556 # ffffffffc02044b8 <etext+0x148>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200294:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc0200296:	854a                	mv	a0,s2
ffffffffc0200298:	77f030ef          	jal	ra,ffffffffc0204216 <readline>
...
ffffffffc02002b2:	31ad0d13          	addi	s10,s10,794 # ffffffffc02045c8 <commands>
        argv[argc ++] = buf;
...
ffffffffc02002ba:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002bc:	056040ef          	jal	ra,ffffffffc0204312 <strcmp>
...
ffffffffc02002ce:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d0:	042040ef          	jal	ra,ffffffffc0204312 <strcmp>
...
ffffffffc020030e:	022040ef          	jal	ra,ffffffffc0204330 <strchr>
...
ffffffffc020034c:	7e5030ef          	jal	ra,ffffffffc0204330 <strchr>
...
ffffffffc020036a:	24a50513          	addi	a0,a0,586 # ffffffffc02045b0 <etext+0x240>
...
ffffffffc02003a6:	26e50513          	addi	a0,a0,622 # ffffffffc0204610 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc02003bc:	17050513          	addi	a0,a0,368 # ffffffffc0205528 <default_pmm_manager+0x478>
...
ffffffffc02003fa:	23a50513          	addi	a0,a0,570 # ffffffffc0204630 <commands+0x68>
    ticks = 0;
...
ffffffffc02004b6:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004b8:	6a1030ef          	jal	ra,ffffffffc0204358 <memcpy>
    return 0;
}
...
ffffffffc02004da:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004dc:	67d030ef          	jal	ra,ffffffffc0204358 <memcpy>
    return 0;
}
...
ffffffffc0200528:	12c50513          	addi	a0,a0,300 # ffffffffc0204650 <commands+0x88>
ffffffffc020052c:	b8fff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    extern struct mm_struct *check_mm_struct;
    print_pgfault(tf);
    if (check_mm_struct != NULL) {
ffffffffc0200530:	00011517          	auipc	a0,0x11
ffffffffc0200534:	02053503          	ld	a0,32(a0) # ffffffffc0211550 <check_mm_struct>
...
ffffffffc0200546:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200548:	6840306f          	j	ffffffffc0203bcc <do_pgfault>
    panic("unhandled page fault.\n");
ffffffffc020054c:	00004617          	auipc	a2,0x4
ffffffffc0200550:	12460613          	addi	a2,a2,292 # ffffffffc0204670 <commands+0xa8>
ffffffffc0200554:	07800593          	li	a1,120
ffffffffc0200558:	00004517          	auipc	a0,0x4
ffffffffc020055c:	13050513          	addi	a0,a0,304 # ffffffffc0204688 <commands+0xc0>
...
ffffffffc020058e:	11650513          	addi	a0,a0,278 # ffffffffc02046a0 <commands+0xd8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200746:	24650513          	addi	a0,a0,582 # ffffffffc0204988 <commands+0x3c0>
}
...
ffffffffc020075a:	24a50513          	addi	a0,a0,586 # ffffffffc02049a0 <commands+0x3d8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200772:	24a50513          	addi	a0,a0,586 # ffffffffc02049b8 <commands+0x3f0>
ffffffffc0200776:	945ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  epc      0x%08x\n", tf->epc);
ffffffffc020077a:	10843583          	ld	a1,264(s0)
ffffffffc020077e:	00004517          	auipc	a0,0x4
ffffffffc0200782:	25250513          	addi	a0,a0,594 # ffffffffc02049d0 <commands+0x408>
ffffffffc0200786:	935ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  badvaddr 0x%08x\n", tf->badvaddr);
ffffffffc020078a:	11043583          	ld	a1,272(s0)
ffffffffc020078e:	00004517          	auipc	a0,0x4
ffffffffc0200792:	25a50513          	addi	a0,a0,602 # ffffffffc02049e8 <commands+0x420>
...
ffffffffc02007a6:	25e50513          	addi	a0,a0,606 # ffffffffc0204a00 <commands+0x438>
}
...
ffffffffc02007c2:	30a70713          	addi	a4,a4,778 # ffffffffc0204ac8 <commands+0x500>
...
ffffffffc02007d4:	2a850513          	addi	a0,a0,680 # ffffffffc0204a78 <commands+0x4b0>
ffffffffc02007d8:	8e3ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02007dc:	00004517          	auipc	a0,0x4
ffffffffc02007e0:	27c50513          	addi	a0,a0,636 # ffffffffc0204a58 <commands+0x490>
ffffffffc02007e4:	8d7ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02007e8:	00004517          	auipc	a0,0x4
ffffffffc02007ec:	23050513          	addi	a0,a0,560 # ffffffffc0204a18 <commands+0x450>
ffffffffc02007f0:	8cbff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02007f4:	00004517          	auipc	a0,0x4
ffffffffc02007f8:	24450513          	addi	a0,a0,580 # ffffffffc0204a38 <commands+0x470>
...
ffffffffc020082a:	28250513          	addi	a0,a0,642 # ffffffffc0204aa8 <commands+0x4e0>
...
ffffffffc020083e:	25e50513          	addi	a0,a0,606 # ffffffffc0204a98 <commands+0x4d0>
}
...
ffffffffc0200860:	45470713          	addi	a4,a4,1108 # ffffffffc0204cb0 <commands+0x6e8>
...
ffffffffc0200872:	42a50513          	addi	a0,a0,1066 # ffffffffc0204c98 <commands+0x6d0>
...
ffffffffc0200894:	26850513          	addi	a0,a0,616 # ffffffffc0204af8 <commands+0x530>
}
...
ffffffffc02008a8:	27450513          	addi	a0,a0,628 # ffffffffc0204b18 <commands+0x550>
ffffffffc02008ac:	b7f5                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Illegal instruction\n");
ffffffffc02008ae:	00004517          	auipc	a0,0x4
ffffffffc02008b2:	28a50513          	addi	a0,a0,650 # ffffffffc0204b38 <commands+0x570>
ffffffffc02008b6:	b7cd                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Breakpoint\n");
ffffffffc02008b8:	00004517          	auipc	a0,0x4
ffffffffc02008bc:	29850513          	addi	a0,a0,664 # ffffffffc0204b50 <commands+0x588>
ffffffffc02008c0:	bfe1                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load address misaligned\n");
ffffffffc02008c2:	00004517          	auipc	a0,0x4
ffffffffc02008c6:	29e50513          	addi	a0,a0,670 # ffffffffc0204b60 <commands+0x598>
ffffffffc02008ca:	b7f9                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load access fault\n");
ffffffffc02008cc:	00004517          	auipc	a0,0x4
ffffffffc02008d0:	2b450513          	addi	a0,a0,692 # ffffffffc0204b80 <commands+0x5b8>
...
ffffffffc02008ee:	2ae60613          	addi	a2,a2,686 # ffffffffc0204b98 <commands+0x5d0>
ffffffffc02008f2:	0ca00593          	li	a1,202
ffffffffc02008f6:	00004517          	auipc	a0,0x4
ffffffffc02008fa:	d9250513          	addi	a0,a0,-622 # ffffffffc0204688 <commands+0xc0>
ffffffffc02008fe:	a77ff0ef          	jal	ra,ffffffffc0200374 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc0200902:	00004517          	auipc	a0,0x4
ffffffffc0200906:	2b650513          	addi	a0,a0,694 # ffffffffc0204bb8 <commands+0x5f0>
ffffffffc020090a:	b779                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc020090c:	00004517          	auipc	a0,0x4
ffffffffc0200910:	2c450513          	addi	a0,a0,708 # ffffffffc0204bd0 <commands+0x608>
...
ffffffffc0200998:	20460613          	addi	a2,a2,516 # ffffffffc0204b98 <commands+0x5d0>
ffffffffc020099c:	0ea00593          	li	a1,234
ffffffffc02009a0:	00004517          	auipc	a0,0x4
ffffffffc02009a4:	ce850513          	addi	a0,a0,-792 # ffffffffc0204688 <commands+0xc0>
...
ffffffffc02009c4:	1d860613          	addi	a2,a2,472 # ffffffffc0204b98 <commands+0x5d0>
ffffffffc02009c8:	0f100593          	li	a1,241
ffffffffc02009cc:	00004517          	auipc	a0,0x4
ffffffffc02009d0:	cbc50513          	addi	a0,a0,-836 # ffffffffc0204688 <commands+0xc0>
...
ffffffffc0200b6e:	5fe5b583          	ld	a1,1534(a1) # ffffffffc0206168 <error_string+0x38>
ffffffffc0200b72:	02b70733          	mul	a4,a4,a1
ffffffffc0200b76:	00005617          	auipc	a2,0x5
ffffffffc0200b7a:	5fa63603          	ld	a2,1530(a2) # ffffffffc0206170 <nbase>
...
ffffffffc0200dc6:	f2e68693          	addi	a3,a3,-210 # ffffffffc0204cf0 <commands+0x728>
ffffffffc0200dca:	00004617          	auipc	a2,0x4
ffffffffc0200dce:	f3660613          	addi	a2,a2,-202 # ffffffffc0204d00 <commands+0x738>
ffffffffc0200dd2:	0f000593          	li	a1,240
ffffffffc0200dd6:	00004517          	auipc	a0,0x4
ffffffffc0200dda:	f4250513          	addi	a0,a0,-190 # ffffffffc0204d18 <commands+0x750>
ffffffffc0200dde:	d96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200de2:	00004697          	auipc	a3,0x4
ffffffffc0200de6:	fce68693          	addi	a3,a3,-50 # ffffffffc0204db0 <commands+0x7e8>
ffffffffc0200dea:	00004617          	auipc	a2,0x4
ffffffffc0200dee:	f1660613          	addi	a2,a2,-234 # ffffffffc0204d00 <commands+0x738>
ffffffffc0200df2:	0bd00593          	li	a1,189
ffffffffc0200df6:	00004517          	auipc	a0,0x4
ffffffffc0200dfa:	f2250513          	addi	a0,a0,-222 # ffffffffc0204d18 <commands+0x750>
ffffffffc0200dfe:	d76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200e02:	00004697          	auipc	a3,0x4
ffffffffc0200e06:	fd668693          	addi	a3,a3,-42 # ffffffffc0204dd8 <commands+0x810>
ffffffffc0200e0a:	00004617          	auipc	a2,0x4
ffffffffc0200e0e:	ef660613          	addi	a2,a2,-266 # ffffffffc0204d00 <commands+0x738>
ffffffffc0200e12:	0be00593          	li	a1,190
ffffffffc0200e16:	00004517          	auipc	a0,0x4
ffffffffc0200e1a:	f0250513          	addi	a0,a0,-254 # ffffffffc0204d18 <commands+0x750>
ffffffffc0200e1e:	d56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200e22:	00004697          	auipc	a3,0x4
ffffffffc0200e26:	ff668693          	addi	a3,a3,-10 # ffffffffc0204e18 <commands+0x850>
ffffffffc0200e2a:	00004617          	auipc	a2,0x4
ffffffffc0200e2e:	ed660613          	addi	a2,a2,-298 # ffffffffc0204d00 <commands+0x738>
ffffffffc0200e32:	0c000593          	li	a1,192
ffffffffc0200e36:	00004517          	auipc	a0,0x4
ffffffffc0200e3a:	ee250513          	addi	a0,a0,-286 # ffffffffc0204d18 <commands+0x750>
ffffffffc0200e3e:	d36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200e42:	00004697          	auipc	a3,0x4
ffffffffc0200e46:	05e68693          	addi	a3,a3,94 # ffffffffc0204ea0 <commands+0x8d8>
ffffffffc0200e4a:	00004617          	auipc	a2,0x4
ffffffffc0200e4e:	eb660613          	addi	a2,a2,-330 # ffffffffc0204d00 <commands+0x738>
ffffffffc0200e52:	0d900593          	li	a1,217
ffffffffc0200e56:	00004517          	auipc	a0,0x4
ffffffffc0200e5a:	ec250513          	addi	a0,a0,-318 # ffffffffc0204d18 <commands+0x750>
ffffffffc0200e5e:	d16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200e62:	00004697          	auipc	a3,0x4
ffffffffc0200e66:	eee68693          	addi	a3,a3,-274 # ffffffffc0204d50 <commands+0x788>
ffffffffc0200e6a:	00004617          	auipc	a2,0x4
ffffffffc0200e6e:	e9660613          	addi	a2,a2,-362 # ffffffffc0204d00 <commands+0x738>
ffffffffc0200e72:	0d200593          	li	a1,210
ffffffffc0200e76:	00004517          	auipc	a0,0x4
ffffffffc0200e7a:	ea250513          	addi	a0,a0,-350 # ffffffffc0204d18 <commands+0x750>
ffffffffc0200e7e:	cf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 3);
ffffffffc0200e82:	00004697          	auipc	a3,0x4
ffffffffc0200e86:	00e68693          	addi	a3,a3,14 # ffffffffc0204e90 <commands+0x8c8>
ffffffffc0200e8a:	00004617          	auipc	a2,0x4
ffffffffc0200e8e:	e7660613          	addi	a2,a2,-394 # ffffffffc0204d00 <commands+0x738>
ffffffffc0200e92:	0d000593          	li	a1,208
ffffffffc0200e96:	00004517          	auipc	a0,0x4
ffffffffc0200e9a:	e8250513          	addi	a0,a0,-382 # ffffffffc0204d18 <commands+0x750>
ffffffffc0200e9e:	cd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200ea2:	00004697          	auipc	a3,0x4
ffffffffc0200ea6:	fd668693          	addi	a3,a3,-42 # ffffffffc0204e78 <commands+0x8b0>
ffffffffc0200eaa:	00004617          	auipc	a2,0x4
ffffffffc0200eae:	e5660613          	addi	a2,a2,-426 # ffffffffc0204d00 <commands+0x738>
ffffffffc0200eb2:	0cb00593          	li	a1,203
ffffffffc0200eb6:	00004517          	auipc	a0,0x4
ffffffffc0200eba:	e6250513          	addi	a0,a0,-414 # ffffffffc0204d18 <commands+0x750>
ffffffffc0200ebe:	cb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200ec2:	00004697          	auipc	a3,0x4
ffffffffc0200ec6:	f9668693          	addi	a3,a3,-106 # ffffffffc0204e58 <commands+0x890>
ffffffffc0200eca:	00004617          	auipc	a2,0x4
ffffffffc0200ece:	e3660613          	addi	a2,a2,-458 # ffffffffc0204d00 <commands+0x738>
ffffffffc0200ed2:	0c200593          	li	a1,194
ffffffffc0200ed6:	00004517          	auipc	a0,0x4
ffffffffc0200eda:	e4250513          	addi	a0,a0,-446 # ffffffffc0204d18 <commands+0x750>
ffffffffc0200ede:	c96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != NULL);
ffffffffc0200ee2:	00004697          	auipc	a3,0x4
ffffffffc0200ee6:	00668693          	addi	a3,a3,6 # ffffffffc0204ee8 <commands+0x920>
ffffffffc0200eea:	00004617          	auipc	a2,0x4
ffffffffc0200eee:	e1660613          	addi	a2,a2,-490 # ffffffffc0204d00 <commands+0x738>
ffffffffc0200ef2:	0f800593          	li	a1,248
ffffffffc0200ef6:	00004517          	auipc	a0,0x4
ffffffffc0200efa:	e2250513          	addi	a0,a0,-478 # ffffffffc0204d18 <commands+0x750>
ffffffffc0200efe:	c76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0200f02:	00004697          	auipc	a3,0x4
ffffffffc0200f06:	fd668693          	addi	a3,a3,-42 # ffffffffc0204ed8 <commands+0x910>
ffffffffc0200f0a:	00004617          	auipc	a2,0x4
ffffffffc0200f0e:	df660613          	addi	a2,a2,-522 # ffffffffc0204d00 <commands+0x738>
ffffffffc0200f12:	0df00593          	li	a1,223
ffffffffc0200f16:	00004517          	auipc	a0,0x4
ffffffffc0200f1a:	e0250513          	addi	a0,a0,-510 # ffffffffc0204d18 <commands+0x750>
ffffffffc0200f1e:	c56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f22:	00004697          	auipc	a3,0x4
ffffffffc0200f26:	f5668693          	addi	a3,a3,-170 # ffffffffc0204e78 <commands+0x8b0>
ffffffffc0200f2a:	00004617          	auipc	a2,0x4
ffffffffc0200f2e:	dd660613          	addi	a2,a2,-554 # ffffffffc0204d00 <commands+0x738>
ffffffffc0200f32:	0dd00593          	li	a1,221
ffffffffc0200f36:	00004517          	auipc	a0,0x4
ffffffffc0200f3a:	de250513          	addi	a0,a0,-542 # ffffffffc0204d18 <commands+0x750>
ffffffffc0200f3e:	c36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200f42:	00004697          	auipc	a3,0x4
ffffffffc0200f46:	f7668693          	addi	a3,a3,-138 # ffffffffc0204eb8 <commands+0x8f0>
ffffffffc0200f4a:	00004617          	auipc	a2,0x4
ffffffffc0200f4e:	db660613          	addi	a2,a2,-586 # ffffffffc0204d00 <commands+0x738>
ffffffffc0200f52:	0dc00593          	li	a1,220
ffffffffc0200f56:	00004517          	auipc	a0,0x4
ffffffffc0200f5a:	dc250513          	addi	a0,a0,-574 # ffffffffc0204d18 <commands+0x750>
ffffffffc0200f5e:	c16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f62:	00004697          	auipc	a3,0x4
ffffffffc0200f66:	dee68693          	addi	a3,a3,-530 # ffffffffc0204d50 <commands+0x788>
ffffffffc0200f6a:	00004617          	auipc	a2,0x4
ffffffffc0200f6e:	d9660613          	addi	a2,a2,-618 # ffffffffc0204d00 <commands+0x738>
ffffffffc0200f72:	0b900593          	li	a1,185
ffffffffc0200f76:	00004517          	auipc	a0,0x4
ffffffffc0200f7a:	da250513          	addi	a0,a0,-606 # ffffffffc0204d18 <commands+0x750>
ffffffffc0200f7e:	bf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f82:	00004697          	auipc	a3,0x4
ffffffffc0200f86:	ef668693          	addi	a3,a3,-266 # ffffffffc0204e78 <commands+0x8b0>
ffffffffc0200f8a:	00004617          	auipc	a2,0x4
ffffffffc0200f8e:	d7660613          	addi	a2,a2,-650 # ffffffffc0204d00 <commands+0x738>
ffffffffc0200f92:	0d600593          	li	a1,214
ffffffffc0200f96:	00004517          	auipc	a0,0x4
ffffffffc0200f9a:	d8250513          	addi	a0,a0,-638 # ffffffffc0204d18 <commands+0x750>
ffffffffc0200f9e:	bd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fa2:	00004697          	auipc	a3,0x4
ffffffffc0200fa6:	dee68693          	addi	a3,a3,-530 # ffffffffc0204d90 <commands+0x7c8>
ffffffffc0200faa:	00004617          	auipc	a2,0x4
ffffffffc0200fae:	d5660613          	addi	a2,a2,-682 # ffffffffc0204d00 <commands+0x738>
ffffffffc0200fb2:	0d400593          	li	a1,212
ffffffffc0200fb6:	00004517          	auipc	a0,0x4
ffffffffc0200fba:	d6250513          	addi	a0,a0,-670 # ffffffffc0204d18 <commands+0x750>
ffffffffc0200fbe:	bb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0200fc2:	00004697          	auipc	a3,0x4
ffffffffc0200fc6:	dae68693          	addi	a3,a3,-594 # ffffffffc0204d70 <commands+0x7a8>
ffffffffc0200fca:	00004617          	auipc	a2,0x4
ffffffffc0200fce:	d3660613          	addi	a2,a2,-714 # ffffffffc0204d00 <commands+0x738>
ffffffffc0200fd2:	0d300593          	li	a1,211
ffffffffc0200fd6:	00004517          	auipc	a0,0x4
ffffffffc0200fda:	d4250513          	addi	a0,a0,-702 # ffffffffc0204d18 <commands+0x750>
ffffffffc0200fde:	b96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fe2:	00004697          	auipc	a3,0x4
ffffffffc0200fe6:	dae68693          	addi	a3,a3,-594 # ffffffffc0204d90 <commands+0x7c8>
ffffffffc0200fea:	00004617          	auipc	a2,0x4
ffffffffc0200fee:	d1660613          	addi	a2,a2,-746 # ffffffffc0204d00 <commands+0x738>
ffffffffc0200ff2:	0bb00593          	li	a1,187
ffffffffc0200ff6:	00004517          	auipc	a0,0x4
ffffffffc0200ffa:	d2250513          	addi	a0,a0,-734 # ffffffffc0204d18 <commands+0x750>
ffffffffc0200ffe:	b76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(count == 0);
ffffffffc0201002:	00004697          	auipc	a3,0x4
ffffffffc0201006:	03668693          	addi	a3,a3,54 # ffffffffc0205038 <commands+0xa70>
ffffffffc020100a:	00004617          	auipc	a2,0x4
ffffffffc020100e:	cf660613          	addi	a2,a2,-778 # ffffffffc0204d00 <commands+0x738>
ffffffffc0201012:	12500593          	li	a1,293
ffffffffc0201016:	00004517          	auipc	a0,0x4
ffffffffc020101a:	d0250513          	addi	a0,a0,-766 # ffffffffc0204d18 <commands+0x750>
ffffffffc020101e:	b56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0201022:	00004697          	auipc	a3,0x4
ffffffffc0201026:	eb668693          	addi	a3,a3,-330 # ffffffffc0204ed8 <commands+0x910>
ffffffffc020102a:	00004617          	auipc	a2,0x4
ffffffffc020102e:	cd660613          	addi	a2,a2,-810 # ffffffffc0204d00 <commands+0x738>
ffffffffc0201032:	11a00593          	li	a1,282
ffffffffc0201036:	00004517          	auipc	a0,0x4
ffffffffc020103a:	ce250513          	addi	a0,a0,-798 # ffffffffc0204d18 <commands+0x750>
ffffffffc020103e:	b36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201042:	00004697          	auipc	a3,0x4
ffffffffc0201046:	e3668693          	addi	a3,a3,-458 # ffffffffc0204e78 <commands+0x8b0>
ffffffffc020104a:	00004617          	auipc	a2,0x4
ffffffffc020104e:	cb660613          	addi	a2,a2,-842 # ffffffffc0204d00 <commands+0x738>
ffffffffc0201052:	11800593          	li	a1,280
ffffffffc0201056:	00004517          	auipc	a0,0x4
ffffffffc020105a:	cc250513          	addi	a0,a0,-830 # ffffffffc0204d18 <commands+0x750>
ffffffffc020105e:	b16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201062:	00004697          	auipc	a3,0x4
ffffffffc0201066:	dd668693          	addi	a3,a3,-554 # ffffffffc0204e38 <commands+0x870>
ffffffffc020106a:	00004617          	auipc	a2,0x4
ffffffffc020106e:	c9660613          	addi	a2,a2,-874 # ffffffffc0204d00 <commands+0x738>
ffffffffc0201072:	0c100593          	li	a1,193
ffffffffc0201076:	00004517          	auipc	a0,0x4
ffffffffc020107a:	ca250513          	addi	a0,a0,-862 # ffffffffc0204d18 <commands+0x750>
ffffffffc020107e:	af6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201082:	00004697          	auipc	a3,0x4
ffffffffc0201086:	f7668693          	addi	a3,a3,-138 # ffffffffc0204ff8 <commands+0xa30>
ffffffffc020108a:	00004617          	auipc	a2,0x4
ffffffffc020108e:	c7660613          	addi	a2,a2,-906 # ffffffffc0204d00 <commands+0x738>
ffffffffc0201092:	11200593          	li	a1,274
ffffffffc0201096:	00004517          	auipc	a0,0x4
ffffffffc020109a:	c8250513          	addi	a0,a0,-894 # ffffffffc0204d18 <commands+0x750>
ffffffffc020109e:	ad6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02010a2:	00004697          	auipc	a3,0x4
ffffffffc02010a6:	f3668693          	addi	a3,a3,-202 # ffffffffc0204fd8 <commands+0xa10>
ffffffffc02010aa:	00004617          	auipc	a2,0x4
ffffffffc02010ae:	c5660613          	addi	a2,a2,-938 # ffffffffc0204d00 <commands+0x738>
ffffffffc02010b2:	11000593          	li	a1,272
ffffffffc02010b6:	00004517          	auipc	a0,0x4
ffffffffc02010ba:	c6250513          	addi	a0,a0,-926 # ffffffffc0204d18 <commands+0x750>
ffffffffc02010be:	ab6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02010c2:	00004697          	auipc	a3,0x4
ffffffffc02010c6:	eee68693          	addi	a3,a3,-274 # ffffffffc0204fb0 <commands+0x9e8>
ffffffffc02010ca:	00004617          	auipc	a2,0x4
ffffffffc02010ce:	c3660613          	addi	a2,a2,-970 # ffffffffc0204d00 <commands+0x738>
ffffffffc02010d2:	10e00593          	li	a1,270
ffffffffc02010d6:	00004517          	auipc	a0,0x4
ffffffffc02010da:	c4250513          	addi	a0,a0,-958 # ffffffffc0204d18 <commands+0x750>
ffffffffc02010de:	a96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc02010e2:	00004697          	auipc	a3,0x4
ffffffffc02010e6:	ea668693          	addi	a3,a3,-346 # ffffffffc0204f88 <commands+0x9c0>
ffffffffc02010ea:	00004617          	auipc	a2,0x4
ffffffffc02010ee:	c1660613          	addi	a2,a2,-1002 # ffffffffc0204d00 <commands+0x738>
ffffffffc02010f2:	10d00593          	li	a1,269
ffffffffc02010f6:	00004517          	auipc	a0,0x4
ffffffffc02010fa:	c2250513          	addi	a0,a0,-990 # ffffffffc0204d18 <commands+0x750>
ffffffffc02010fe:	a76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201102:	00004697          	auipc	a3,0x4
ffffffffc0201106:	e7668693          	addi	a3,a3,-394 # ffffffffc0204f78 <commands+0x9b0>
ffffffffc020110a:	00004617          	auipc	a2,0x4
ffffffffc020110e:	bf660613          	addi	a2,a2,-1034 # ffffffffc0204d00 <commands+0x738>
ffffffffc0201112:	10800593          	li	a1,264
ffffffffc0201116:	00004517          	auipc	a0,0x4
ffffffffc020111a:	c0250513          	addi	a0,a0,-1022 # ffffffffc0204d18 <commands+0x750>
ffffffffc020111e:	a56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201122:	00004697          	auipc	a3,0x4
ffffffffc0201126:	d5668693          	addi	a3,a3,-682 # ffffffffc0204e78 <commands+0x8b0>
ffffffffc020112a:	00004617          	auipc	a2,0x4
ffffffffc020112e:	bd660613          	addi	a2,a2,-1066 # ffffffffc0204d00 <commands+0x738>
ffffffffc0201132:	10700593          	li	a1,263
ffffffffc0201136:	00004517          	auipc	a0,0x4
ffffffffc020113a:	be250513          	addi	a0,a0,-1054 # ffffffffc0204d18 <commands+0x750>
ffffffffc020113e:	a36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc0201142:	00004697          	auipc	a3,0x4
ffffffffc0201146:	e1668693          	addi	a3,a3,-490 # ffffffffc0204f58 <commands+0x990>
ffffffffc020114a:	00004617          	auipc	a2,0x4
ffffffffc020114e:	bb660613          	addi	a2,a2,-1098 # ffffffffc0204d00 <commands+0x738>
ffffffffc0201152:	10600593          	li	a1,262
ffffffffc0201156:	00004517          	auipc	a0,0x4
ffffffffc020115a:	bc250513          	addi	a0,a0,-1086 # ffffffffc0204d18 <commands+0x750>
ffffffffc020115e:	a16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201162:	00004697          	auipc	a3,0x4
ffffffffc0201166:	dc668693          	addi	a3,a3,-570 # ffffffffc0204f28 <commands+0x960>
ffffffffc020116a:	00004617          	auipc	a2,0x4
ffffffffc020116e:	b9660613          	addi	a2,a2,-1130 # ffffffffc0204d00 <commands+0x738>
ffffffffc0201172:	10500593          	li	a1,261
ffffffffc0201176:	00004517          	auipc	a0,0x4
ffffffffc020117a:	ba250513          	addi	a0,a0,-1118 # ffffffffc0204d18 <commands+0x750>
ffffffffc020117e:	9f6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201182:	00004697          	auipc	a3,0x4
ffffffffc0201186:	d8e68693          	addi	a3,a3,-626 # ffffffffc0204f10 <commands+0x948>
ffffffffc020118a:	00004617          	auipc	a2,0x4
ffffffffc020118e:	b7660613          	addi	a2,a2,-1162 # ffffffffc0204d00 <commands+0x738>
ffffffffc0201192:	10400593          	li	a1,260
ffffffffc0201196:	00004517          	auipc	a0,0x4
ffffffffc020119a:	b8250513          	addi	a0,a0,-1150 # ffffffffc0204d18 <commands+0x750>
ffffffffc020119e:	9d6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011a2:	00004697          	auipc	a3,0x4
ffffffffc02011a6:	cd668693          	addi	a3,a3,-810 # ffffffffc0204e78 <commands+0x8b0>
ffffffffc02011aa:	00004617          	auipc	a2,0x4
ffffffffc02011ae:	b5660613          	addi	a2,a2,-1194 # ffffffffc0204d00 <commands+0x738>
ffffffffc02011b2:	0fe00593          	li	a1,254
ffffffffc02011b6:	00004517          	auipc	a0,0x4
ffffffffc02011ba:	b6250513          	addi	a0,a0,-1182 # ffffffffc0204d18 <commands+0x750>
ffffffffc02011be:	9b6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!PageProperty(p0));
ffffffffc02011c2:	00004697          	auipc	a3,0x4
ffffffffc02011c6:	d3668693          	addi	a3,a3,-714 # ffffffffc0204ef8 <commands+0x930>
ffffffffc02011ca:	00004617          	auipc	a2,0x4
ffffffffc02011ce:	b3660613          	addi	a2,a2,-1226 # ffffffffc0204d00 <commands+0x738>
ffffffffc02011d2:	0f900593          	li	a1,249
ffffffffc02011d6:	00004517          	auipc	a0,0x4
ffffffffc02011da:	b4250513          	addi	a0,a0,-1214 # ffffffffc0204d18 <commands+0x750>
ffffffffc02011de:	996ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc02011e2:	00004697          	auipc	a3,0x4
ffffffffc02011e6:	e3668693          	addi	a3,a3,-458 # ffffffffc0205018 <commands+0xa50>
ffffffffc02011ea:	00004617          	auipc	a2,0x4
ffffffffc02011ee:	b1660613          	addi	a2,a2,-1258 # ffffffffc0204d00 <commands+0x738>
ffffffffc02011f2:	11700593          	li	a1,279
ffffffffc02011f6:	00004517          	auipc	a0,0x4
ffffffffc02011fa:	b2250513          	addi	a0,a0,-1246 # ffffffffc0204d18 <commands+0x750>
ffffffffc02011fe:	976ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == 0);
ffffffffc0201202:	00004697          	auipc	a3,0x4
ffffffffc0201206:	e4668693          	addi	a3,a3,-442 # ffffffffc0205048 <commands+0xa80>
ffffffffc020120a:	00004617          	auipc	a2,0x4
ffffffffc020120e:	af660613          	addi	a2,a2,-1290 # ffffffffc0204d00 <commands+0x738>
ffffffffc0201212:	12600593          	li	a1,294
ffffffffc0201216:	00004517          	auipc	a0,0x4
ffffffffc020121a:	b0250513          	addi	a0,a0,-1278 # ffffffffc0204d18 <commands+0x750>
ffffffffc020121e:	956ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == nr_free_pages());
ffffffffc0201222:	00004697          	auipc	a3,0x4
ffffffffc0201226:	b0e68693          	addi	a3,a3,-1266 # ffffffffc0204d30 <commands+0x768>
ffffffffc020122a:	00004617          	auipc	a2,0x4
ffffffffc020122e:	ad660613          	addi	a2,a2,-1322 # ffffffffc0204d00 <commands+0x738>
ffffffffc0201232:	0f300593          	li	a1,243
ffffffffc0201236:	00004517          	auipc	a0,0x4
ffffffffc020123a:	ae250513          	addi	a0,a0,-1310 # ffffffffc0204d18 <commands+0x750>
ffffffffc020123e:	936ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201242:	00004697          	auipc	a3,0x4
ffffffffc0201246:	b2e68693          	addi	a3,a3,-1234 # ffffffffc0204d70 <commands+0x7a8>
ffffffffc020124a:	00004617          	auipc	a2,0x4
ffffffffc020124e:	ab660613          	addi	a2,a2,-1354 # ffffffffc0204d00 <commands+0x738>
ffffffffc0201252:	0ba00593          	li	a1,186
ffffffffc0201256:	00004517          	auipc	a0,0x4
ffffffffc020125a:	ac250513          	addi	a0,a0,-1342 # ffffffffc0204d18 <commands+0x750>
...
ffffffffc020139e:	cc668693          	addi	a3,a3,-826 # ffffffffc0205060 <commands+0xa98>
ffffffffc02013a2:	00004617          	auipc	a2,0x4
ffffffffc02013a6:	95e60613          	addi	a2,a2,-1698 # ffffffffc0204d00 <commands+0x738>
ffffffffc02013aa:	08300593          	li	a1,131
ffffffffc02013ae:	00004517          	auipc	a0,0x4
ffffffffc02013b2:	96a50513          	addi	a0,a0,-1686 # ffffffffc0204d18 <commands+0x750>
ffffffffc02013b6:	fbffe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc02013ba:	00004697          	auipc	a3,0x4
ffffffffc02013be:	c9e68693          	addi	a3,a3,-866 # ffffffffc0205058 <commands+0xa90>
ffffffffc02013c2:	00004617          	auipc	a2,0x4
ffffffffc02013c6:	93e60613          	addi	a2,a2,-1730 # ffffffffc0204d00 <commands+0x738>
ffffffffc02013ca:	08000593          	li	a1,128
ffffffffc02013ce:	00004517          	auipc	a0,0x4
ffffffffc02013d2:	94a50513          	addi	a0,a0,-1718 # ffffffffc0204d18 <commands+0x750>
...
ffffffffc0201476:	be668693          	addi	a3,a3,-1050 # ffffffffc0205058 <commands+0xa90>
ffffffffc020147a:	00004617          	auipc	a2,0x4
ffffffffc020147e:	88660613          	addi	a2,a2,-1914 # ffffffffc0204d00 <commands+0x738>
ffffffffc0201482:	06200593          	li	a1,98
ffffffffc0201486:	00004517          	auipc	a0,0x4
ffffffffc020148a:	89250513          	addi	a0,a0,-1902 # ffffffffc0204d18 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc020154c:	b4068693          	addi	a3,a3,-1216 # ffffffffc0205088 <commands+0xac0>
ffffffffc0201550:	00003617          	auipc	a2,0x3
ffffffffc0201554:	7b060613          	addi	a2,a2,1968 # ffffffffc0204d00 <commands+0x738>
ffffffffc0201558:	04900593          	li	a1,73
ffffffffc020155c:	00003517          	auipc	a0,0x3
ffffffffc0201560:	7bc50513          	addi	a0,a0,1980 # ffffffffc0204d18 <commands+0x750>
ffffffffc0201564:	e11fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc0201568:	00004697          	auipc	a3,0x4
ffffffffc020156c:	af068693          	addi	a3,a3,-1296 # ffffffffc0205058 <commands+0xa90>
ffffffffc0201570:	00003617          	auipc	a2,0x3
ffffffffc0201574:	79060613          	addi	a2,a2,1936 # ffffffffc0204d00 <commands+0x738>
ffffffffc0201578:	04600593          	li	a1,70
ffffffffc020157c:	00003517          	auipc	a0,0x3
ffffffffc0201580:	79c50513          	addi	a0,a0,1948 # ffffffffc0204d18 <commands+0x750>
...
ffffffffc020158e:	b5e60613          	addi	a2,a2,-1186 # ffffffffc02050e8 <default_pmm_manager+0x38>
ffffffffc0201592:	06500593          	li	a1,101
ffffffffc0201596:	00004517          	auipc	a0,0x4
ffffffffc020159a:	b7250513          	addi	a0,a0,-1166 # ffffffffc0205108 <default_pmm_manager+0x58>
static inline struct Page *pa2page(uintptr_t pa) {
...
ffffffffc02015aa:	b7260613          	addi	a2,a2,-1166 # ffffffffc0205118 <default_pmm_manager+0x68>
ffffffffc02015ae:	07000593          	li	a1,112
ffffffffc02015b2:	00004517          	auipc	a0,0x4
ffffffffc02015b6:	b5650513          	addi	a0,a0,-1194 # ffffffffc0205108 <default_pmm_manager+0x58>
static inline struct Page *pte2page(pte_t pte) {
...
ffffffffc02015ee:	f66b0b13          	addi	s6,s6,-154 # ffffffffc0211550 <check_mm_struct>
...
ffffffffc0201722:	a4ab3b03          	ld	s6,-1462(s6) # ffffffffc0206168 <error_string+0x38>
...
ffffffffc0201760:	3e7020ef          	jal	ra,ffffffffc0204346 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc02017d0:	99cb3b03          	ld	s6,-1636(s6) # ffffffffc0206168 <error_string+0x38>
...
ffffffffc0201802:	345020ef          	jal	ra,ffffffffc0204346 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201862:	8e260613          	addi	a2,a2,-1822 # ffffffffc0205140 <default_pmm_manager+0x90>
ffffffffc0201866:	10200593          	li	a1,258
ffffffffc020186a:	00004517          	auipc	a0,0x4
ffffffffc020186e:	8fe50513          	addi	a0,a0,-1794 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc0201872:	b03fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201876:	00004617          	auipc	a2,0x4
ffffffffc020187a:	8ca60613          	addi	a2,a2,-1846 # ffffffffc0205140 <default_pmm_manager+0x90>
ffffffffc020187e:	10f00593          	li	a1,271
ffffffffc0201882:	00004517          	auipc	a0,0x4
ffffffffc0201886:	8e650513          	addi	a0,a0,-1818 # ffffffffc0205168 <default_pmm_manager+0xb8>
...
ffffffffc0201894:	8b060613          	addi	a2,a2,-1872 # ffffffffc0205140 <default_pmm_manager+0x90>
ffffffffc0201898:	10b00593          	li	a1,267
ffffffffc020189c:	00004517          	auipc	a0,0x4
ffffffffc02018a0:	8cc50513          	addi	a0,a0,-1844 # ffffffffc0205168 <default_pmm_manager+0xb8>
...
ffffffffc02018ae:	89660613          	addi	a2,a2,-1898 # ffffffffc0205140 <default_pmm_manager+0x90>
ffffffffc02018b2:	0ff00593          	li	a1,255
ffffffffc02018b6:	00004517          	auipc	a0,0x4
ffffffffc02018ba:	8b250513          	addi	a0,a0,-1870 # ffffffffc0205168 <default_pmm_manager+0xb8>
...
ffffffffc02019f8:	77443403          	ld	s0,1908(s0) # ffffffffc0206168 <error_string+0x38>
...
ffffffffc0201aba:	5fa78793          	addi	a5,a5,1530 # ffffffffc02050b0 <default_pmm_manager>
...
ffffffffc0201ac8:	6b450513          	addi	a0,a0,1716 # ffffffffc0205178 <default_pmm_manager+0xc8>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201b24:	67050513          	addi	a0,a0,1648 # ffffffffc0205190 <default_pmm_manager+0xe0>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201b34:	69050513          	addi	a0,a0,1680 # ffffffffc02051c0 <default_pmm_manager+0x110>
...
ffffffffc0201b4e:	68e50513          	addi	a0,a0,1678 # ffffffffc02051d8 <default_pmm_manager+0x128>
...
ffffffffc0201b5c:	a0378793          	addi	a5,a5,-1533 # ffffffffc021255b <end+0xfff>
...
ffffffffc0201bda:	65250513          	addi	a0,a0,1618 # ffffffffc0205228 <default_pmm_manager+0x178>
...
ffffffffc0201dfe:	36ecbc83          	ld	s9,878(s9) # ffffffffc0206168 <error_string+0x38>
...
ffffffffc0201e82:	0007b023          	sd	zero,0(a5) # fffffffffffff000 <end+0x3fdedaa4>
...
ffffffffc0201ea2:	67250513          	addi	a0,a0,1650 # ffffffffc0205510 <default_pmm_manager+0x460>
...
ffffffffc0201f26:	64051e63          	bnez	a0,ffffffffc0202582 <pmm_init+0xacc>
    assert(page_ref(p) == 1);
ffffffffc0201f2a:	000aa703          	lw	a4,0(s5) # fffffffffffff000 <end+0x3fdedaa4>
...
ffffffffc0201f58:	6f458593          	addi	a1,a1,1780 # ffffffffc0205648 <default_pmm_manager+0x598>
ffffffffc0201f5c:	10000513          	li	a0,256
ffffffffc0201f60:	3a0020ef          	jal	ra,ffffffffc0204300 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f64:	10040593          	addi	a1,s0,256
ffffffffc0201f68:	10000513          	li	a0,256
ffffffffc0201f6c:	3a6020ef          	jal	ra,ffffffffc0204312 <strcmp>
...
ffffffffc0201fa2:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eba4>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fa6:	324020ef          	jal	ra,ffffffffc02042ca <strlen>
...
ffffffffc020209c:	62850513          	addi	a0,a0,1576 # ffffffffc02056c0 <default_pmm_manager+0x610>
}
...
ffffffffc02021a2:	3d268693          	addi	a3,a3,978 # ffffffffc0205570 <default_pmm_manager+0x4c0>
ffffffffc02021a6:	00003617          	auipc	a2,0x3
ffffffffc02021aa:	b5a60613          	addi	a2,a2,-1190 # ffffffffc0204d00 <commands+0x738>
ffffffffc02021ae:	1ce00593          	li	a1,462
ffffffffc02021b2:	00003517          	auipc	a0,0x3
ffffffffc02021b6:	fb650513          	addi	a0,a0,-74 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc02021ba:	9bafe0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc02021be:	00003697          	auipc	a3,0x3
ffffffffc02021c2:	37268693          	addi	a3,a3,882 # ffffffffc0205530 <default_pmm_manager+0x480>
ffffffffc02021c6:	00003617          	auipc	a2,0x3
ffffffffc02021ca:	b3a60613          	addi	a2,a2,-1222 # ffffffffc0204d00 <commands+0x738>
ffffffffc02021ce:	1cd00593          	li	a1,461
ffffffffc02021d2:	00003517          	auipc	a0,0x3
ffffffffc02021d6:	f9650513          	addi	a0,a0,-106 # ffffffffc0205168 <default_pmm_manager+0xb8>
...
ffffffffc02021e4:	f6060613          	addi	a2,a2,-160 # ffffffffc0205140 <default_pmm_manager+0x90>
ffffffffc02021e8:	1cd00593          	li	a1,461
ffffffffc02021ec:	00003517          	auipc	a0,0x3
ffffffffc02021f0:	f7c50513          	addi	a0,a0,-132 # ffffffffc0205168 <default_pmm_manager+0xb8>
...
ffffffffc0202200:	00460613          	addi	a2,a2,4 # ffffffffc0205200 <default_pmm_manager+0x150>
ffffffffc0202204:	07700593          	li	a1,119
ffffffffc0202208:	00003517          	auipc	a0,0x3
ffffffffc020220c:	f6050513          	addi	a0,a0,-160 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc0202210:	964fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc0202214:	00003617          	auipc	a2,0x3
ffffffffc0202218:	fec60613          	addi	a2,a2,-20 # ffffffffc0205200 <default_pmm_manager+0x150>
ffffffffc020221c:	0bd00593          	li	a1,189
ffffffffc0202220:	00003517          	auipc	a0,0x3
ffffffffc0202224:	f4850513          	addi	a0,a0,-184 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc0202228:	94cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc020222c:	00003697          	auipc	a3,0x3
ffffffffc0202230:	03c68693          	addi	a3,a3,60 # ffffffffc0205268 <default_pmm_manager+0x1b8>
ffffffffc0202234:	00003617          	auipc	a2,0x3
ffffffffc0202238:	acc60613          	addi	a2,a2,-1332 # ffffffffc0204d00 <commands+0x738>
ffffffffc020223c:	19300593          	li	a1,403
ffffffffc0202240:	00003517          	auipc	a0,0x3
ffffffffc0202244:	f2850513          	addi	a0,a0,-216 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc0202248:	92cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020224c:	00003697          	auipc	a3,0x3
ffffffffc0202250:	ffc68693          	addi	a3,a3,-4 # ffffffffc0205248 <default_pmm_manager+0x198>
ffffffffc0202254:	00003617          	auipc	a2,0x3
ffffffffc0202258:	aac60613          	addi	a2,a2,-1364 # ffffffffc0204d00 <commands+0x738>
ffffffffc020225c:	19200593          	li	a1,402
ffffffffc0202260:	00003517          	auipc	a0,0x3
ffffffffc0202264:	f0850513          	addi	a0,a0,-248 # ffffffffc0205168 <default_pmm_manager+0xb8>
...
ffffffffc0202274:	08868693          	addi	a3,a3,136 # ffffffffc02052f8 <default_pmm_manager+0x248>
ffffffffc0202278:	00003617          	auipc	a2,0x3
ffffffffc020227c:	a8860613          	addi	a2,a2,-1400 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202280:	19a00593          	li	a1,410
ffffffffc0202284:	00003517          	auipc	a0,0x3
ffffffffc0202288:	ee450513          	addi	a0,a0,-284 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc020228c:	8e8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202290:	00003697          	auipc	a3,0x3
ffffffffc0202294:	03868693          	addi	a3,a3,56 # ffffffffc02052c8 <default_pmm_manager+0x218>
ffffffffc0202298:	00003617          	auipc	a2,0x3
ffffffffc020229c:	a6860613          	addi	a2,a2,-1432 # ffffffffc0204d00 <commands+0x738>
ffffffffc02022a0:	19800593          	li	a1,408
ffffffffc02022a4:	00003517          	auipc	a0,0x3
ffffffffc02022a8:	ec450513          	addi	a0,a0,-316 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc02022ac:	8c8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc02022b0:	00003697          	auipc	a3,0x3
ffffffffc02022b4:	ff068693          	addi	a3,a3,-16 # ffffffffc02052a0 <default_pmm_manager+0x1f0>
ffffffffc02022b8:	00003617          	auipc	a2,0x3
ffffffffc02022bc:	a4860613          	addi	a2,a2,-1464 # ffffffffc0204d00 <commands+0x738>
ffffffffc02022c0:	19400593          	li	a1,404
ffffffffc02022c4:	00003517          	auipc	a0,0x3
ffffffffc02022c8:	ea450513          	addi	a0,a0,-348 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc02022cc:	8a8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02022d0:	00003697          	auipc	a3,0x3
ffffffffc02022d4:	0b068693          	addi	a3,a3,176 # ffffffffc0205380 <default_pmm_manager+0x2d0>
ffffffffc02022d8:	00003617          	auipc	a2,0x3
ffffffffc02022dc:	a2860613          	addi	a2,a2,-1496 # ffffffffc0204d00 <commands+0x738>
ffffffffc02022e0:	1a300593          	li	a1,419
ffffffffc02022e4:	00003517          	auipc	a0,0x3
ffffffffc02022e8:	e8450513          	addi	a0,a0,-380 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc02022ec:	888fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02022f0:	00003697          	auipc	a3,0x3
ffffffffc02022f4:	13068693          	addi	a3,a3,304 # ffffffffc0205420 <default_pmm_manager+0x370>
ffffffffc02022f8:	00003617          	auipc	a2,0x3
ffffffffc02022fc:	a0860613          	addi	a2,a2,-1528 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202300:	1a800593          	li	a1,424
ffffffffc0202304:	00003517          	auipc	a0,0x3
ffffffffc0202308:	e6450513          	addi	a0,a0,-412 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc020230c:	868fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc0202310:	00003697          	auipc	a3,0x3
ffffffffc0202314:	04868693          	addi	a3,a3,72 # ffffffffc0205358 <default_pmm_manager+0x2a8>
ffffffffc0202318:	00003617          	auipc	a2,0x3
ffffffffc020231c:	9e860613          	addi	a2,a2,-1560 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202320:	1a000593          	li	a1,416
ffffffffc0202324:	00003517          	auipc	a0,0x3
ffffffffc0202328:	e4450513          	addi	a0,a0,-444 # ffffffffc0205168 <default_pmm_manager+0xb8>
...
ffffffffc0202336:	e0e60613          	addi	a2,a2,-498 # ffffffffc0205140 <default_pmm_manager+0x90>
ffffffffc020233a:	19f00593          	li	a1,415
ffffffffc020233e:	00003517          	auipc	a0,0x3
ffffffffc0202342:	e2a50513          	addi	a0,a0,-470 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc0202346:	82efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020234a:	00003697          	auipc	a3,0x3
ffffffffc020234e:	06e68693          	addi	a3,a3,110 # ffffffffc02053b8 <default_pmm_manager+0x308>
ffffffffc0202352:	00003617          	auipc	a2,0x3
ffffffffc0202356:	9ae60613          	addi	a2,a2,-1618 # ffffffffc0204d00 <commands+0x738>
ffffffffc020235a:	1ad00593          	li	a1,429
ffffffffc020235e:	00003517          	auipc	a0,0x3
ffffffffc0202362:	e0a50513          	addi	a0,a0,-502 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc0202366:	80efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020236a:	00003697          	auipc	a3,0x3
ffffffffc020236e:	11668693          	addi	a3,a3,278 # ffffffffc0205480 <default_pmm_manager+0x3d0>
ffffffffc0202372:	00003617          	auipc	a2,0x3
ffffffffc0202376:	98e60613          	addi	a2,a2,-1650 # ffffffffc0204d00 <commands+0x738>
ffffffffc020237a:	1ac00593          	li	a1,428
ffffffffc020237e:	00003517          	auipc	a0,0x3
ffffffffc0202382:	dea50513          	addi	a0,a0,-534 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc0202386:	feffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020238a:	00003697          	auipc	a3,0x3
ffffffffc020238e:	0de68693          	addi	a3,a3,222 # ffffffffc0205468 <default_pmm_manager+0x3b8>
ffffffffc0202392:	00003617          	auipc	a2,0x3
ffffffffc0202396:	96e60613          	addi	a2,a2,-1682 # ffffffffc0204d00 <commands+0x738>
ffffffffc020239a:	1ab00593          	li	a1,427
ffffffffc020239e:	00003517          	auipc	a0,0x3
ffffffffc02023a2:	dca50513          	addi	a0,a0,-566 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc02023a6:	fcffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc02023aa:	00003697          	auipc	a3,0x3
ffffffffc02023ae:	08e68693          	addi	a3,a3,142 # ffffffffc0205438 <default_pmm_manager+0x388>
ffffffffc02023b2:	00003617          	auipc	a2,0x3
ffffffffc02023b6:	94e60613          	addi	a2,a2,-1714 # ffffffffc0204d00 <commands+0x738>
ffffffffc02023ba:	1aa00593          	li	a1,426
ffffffffc02023be:	00003517          	auipc	a0,0x3
ffffffffc02023c2:	daa50513          	addi	a0,a0,-598 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc02023c6:	faffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc02023ca:	00003697          	auipc	a3,0x3
ffffffffc02023ce:	22668693          	addi	a3,a3,550 # ffffffffc02055f0 <default_pmm_manager+0x540>
ffffffffc02023d2:	00003617          	auipc	a2,0x3
ffffffffc02023d6:	92e60613          	addi	a2,a2,-1746 # ffffffffc0204d00 <commands+0x738>
ffffffffc02023da:	1d800593          	li	a1,472
ffffffffc02023de:	00003517          	auipc	a0,0x3
ffffffffc02023e2:	d8a50513          	addi	a0,a0,-630 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc02023e6:	f8ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02023ea:	00003697          	auipc	a3,0x3
ffffffffc02023ee:	01e68693          	addi	a3,a3,30 # ffffffffc0205408 <default_pmm_manager+0x358>
ffffffffc02023f2:	00003617          	auipc	a2,0x3
ffffffffc02023f6:	90e60613          	addi	a2,a2,-1778 # ffffffffc0204d00 <commands+0x738>
ffffffffc02023fa:	1a700593          	li	a1,423
ffffffffc02023fe:	00003517          	auipc	a0,0x3
ffffffffc0202402:	d6a50513          	addi	a0,a0,-662 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc0202406:	f6ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_W);
ffffffffc020240a:	00003697          	auipc	a3,0x3
ffffffffc020240e:	fee68693          	addi	a3,a3,-18 # ffffffffc02053f8 <default_pmm_manager+0x348>
ffffffffc0202412:	00003617          	auipc	a2,0x3
ffffffffc0202416:	8ee60613          	addi	a2,a2,-1810 # ffffffffc0204d00 <commands+0x738>
ffffffffc020241a:	1a600593          	li	a1,422
ffffffffc020241e:	00003517          	auipc	a0,0x3
ffffffffc0202422:	d4a50513          	addi	a0,a0,-694 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc0202426:	f4ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc020242a:	00003697          	auipc	a3,0x3
ffffffffc020242e:	0c668693          	addi	a3,a3,198 # ffffffffc02054f0 <default_pmm_manager+0x440>
ffffffffc0202432:	00003617          	auipc	a2,0x3
ffffffffc0202436:	8ce60613          	addi	a2,a2,-1842 # ffffffffc0204d00 <commands+0x738>
ffffffffc020243a:	1e800593          	li	a1,488
ffffffffc020243e:	00003517          	auipc	a0,0x3
ffffffffc0202442:	d2a50513          	addi	a0,a0,-726 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc0202446:	f2ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_U);
ffffffffc020244a:	00003697          	auipc	a3,0x3
ffffffffc020244e:	f9e68693          	addi	a3,a3,-98 # ffffffffc02053e8 <default_pmm_manager+0x338>
ffffffffc0202452:	00003617          	auipc	a2,0x3
ffffffffc0202456:	8ae60613          	addi	a2,a2,-1874 # ffffffffc0204d00 <commands+0x738>
ffffffffc020245a:	1a500593          	li	a1,421
ffffffffc020245e:	00003517          	auipc	a0,0x3
ffffffffc0202462:	d0a50513          	addi	a0,a0,-758 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc0202466:	f0ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020246a:	00003697          	auipc	a3,0x3
ffffffffc020246e:	ed668693          	addi	a3,a3,-298 # ffffffffc0205340 <default_pmm_manager+0x290>
ffffffffc0202472:	00003617          	auipc	a2,0x3
ffffffffc0202476:	88e60613          	addi	a2,a2,-1906 # ffffffffc0204d00 <commands+0x738>
ffffffffc020247a:	1b200593          	li	a1,434
ffffffffc020247e:	00003517          	auipc	a0,0x3
ffffffffc0202482:	cea50513          	addi	a0,a0,-790 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc0202486:	eeffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020248a:	00003697          	auipc	a3,0x3
ffffffffc020248e:	00e68693          	addi	a3,a3,14 # ffffffffc0205498 <default_pmm_manager+0x3e8>
ffffffffc0202492:	00003617          	auipc	a2,0x3
ffffffffc0202496:	86e60613          	addi	a2,a2,-1938 # ffffffffc0204d00 <commands+0x738>
ffffffffc020249a:	1af00593          	li	a1,431
ffffffffc020249e:	00003517          	auipc	a0,0x3
ffffffffc02024a2:	cca50513          	addi	a0,a0,-822 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc02024a6:	ecffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02024aa:	00003697          	auipc	a3,0x3
ffffffffc02024ae:	e7e68693          	addi	a3,a3,-386 # ffffffffc0205328 <default_pmm_manager+0x278>
ffffffffc02024b2:	00003617          	auipc	a2,0x3
ffffffffc02024b6:	84e60613          	addi	a2,a2,-1970 # ffffffffc0204d00 <commands+0x738>
ffffffffc02024ba:	1ae00593          	li	a1,430
ffffffffc02024be:	00003517          	auipc	a0,0x3
ffffffffc02024c2:	caa50513          	addi	a0,a0,-854 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc02024c6:	eaffd0ef          	jal	ra,ffffffffc0200374 <__panic>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc02024ca:	00003617          	auipc	a2,0x3
ffffffffc02024ce:	c7660613          	addi	a2,a2,-906 # ffffffffc0205140 <default_pmm_manager+0x90>
ffffffffc02024d2:	06a00593          	li	a1,106
ffffffffc02024d6:	00003517          	auipc	a0,0x3
ffffffffc02024da:	c3250513          	addi	a0,a0,-974 # ffffffffc0205108 <default_pmm_manager+0x58>
ffffffffc02024de:	e97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02024e2:	00003697          	auipc	a3,0x3
ffffffffc02024e6:	fe668693          	addi	a3,a3,-26 # ffffffffc02054c8 <default_pmm_manager+0x418>
ffffffffc02024ea:	00003617          	auipc	a2,0x3
ffffffffc02024ee:	81660613          	addi	a2,a2,-2026 # ffffffffc0204d00 <commands+0x738>
ffffffffc02024f2:	1b900593          	li	a1,441
ffffffffc02024f6:	00003517          	auipc	a0,0x3
ffffffffc02024fa:	c7250513          	addi	a0,a0,-910 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc02024fe:	e77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202502:	00003697          	auipc	a3,0x3
ffffffffc0202506:	f7e68693          	addi	a3,a3,-130 # ffffffffc0205480 <default_pmm_manager+0x3d0>
ffffffffc020250a:	00002617          	auipc	a2,0x2
ffffffffc020250e:	7f660613          	addi	a2,a2,2038 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202512:	1b700593          	li	a1,439
ffffffffc0202516:	00003517          	auipc	a0,0x3
ffffffffc020251a:	c5250513          	addi	a0,a0,-942 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc020251e:	e57fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0202522:	00003697          	auipc	a3,0x3
ffffffffc0202526:	f8e68693          	addi	a3,a3,-114 # ffffffffc02054b0 <default_pmm_manager+0x400>
ffffffffc020252a:	00002617          	auipc	a2,0x2
ffffffffc020252e:	7d660613          	addi	a2,a2,2006 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202532:	1b600593          	li	a1,438
ffffffffc0202536:	00003517          	auipc	a0,0x3
ffffffffc020253a:	c3250513          	addi	a0,a0,-974 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc020253e:	e37fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202542:	00003697          	auipc	a3,0x3
ffffffffc0202546:	f3e68693          	addi	a3,a3,-194 # ffffffffc0205480 <default_pmm_manager+0x3d0>
ffffffffc020254a:	00002617          	auipc	a2,0x2
ffffffffc020254e:	7b660613          	addi	a2,a2,1974 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202552:	1b300593          	li	a1,435
ffffffffc0202556:	00003517          	auipc	a0,0x3
ffffffffc020255a:	c1250513          	addi	a0,a0,-1006 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc020255e:	e17fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202562:	00003697          	auipc	a3,0x3
ffffffffc0202566:	07668693          	addi	a3,a3,118 # ffffffffc02055d8 <default_pmm_manager+0x528>
ffffffffc020256a:	00002617          	auipc	a2,0x2
ffffffffc020256e:	79660613          	addi	a2,a2,1942 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202572:	1d700593          	li	a1,471
ffffffffc0202576:	00003517          	auipc	a0,0x3
ffffffffc020257a:	bf250513          	addi	a0,a0,-1038 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc020257e:	df7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202582:	00003697          	auipc	a3,0x3
ffffffffc0202586:	01e68693          	addi	a3,a3,30 # ffffffffc02055a0 <default_pmm_manager+0x4f0>
ffffffffc020258a:	00002617          	auipc	a2,0x2
ffffffffc020258e:	77660613          	addi	a2,a2,1910 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202592:	1d600593          	li	a1,470
ffffffffc0202596:	00003517          	auipc	a0,0x3
ffffffffc020259a:	bd250513          	addi	a0,a0,-1070 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc020259e:	dd7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc02025a2:	00003697          	auipc	a3,0x3
ffffffffc02025a6:	fe668693          	addi	a3,a3,-26 # ffffffffc0205588 <default_pmm_manager+0x4d8>
ffffffffc02025aa:	00002617          	auipc	a2,0x2
ffffffffc02025ae:	75660613          	addi	a2,a2,1878 # ffffffffc0204d00 <commands+0x738>
ffffffffc02025b2:	1d200593          	li	a1,466
ffffffffc02025b6:	00003517          	auipc	a0,0x3
ffffffffc02025ba:	bb250513          	addi	a0,a0,-1102 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc02025be:	db7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02025c2:	00003697          	auipc	a3,0x3
ffffffffc02025c6:	f2e68693          	addi	a3,a3,-210 # ffffffffc02054f0 <default_pmm_manager+0x440>
ffffffffc02025ca:	00002617          	auipc	a2,0x2
ffffffffc02025ce:	73660613          	addi	a2,a2,1846 # ffffffffc0204d00 <commands+0x738>
ffffffffc02025d2:	1c000593          	li	a1,448
ffffffffc02025d6:	00003517          	auipc	a0,0x3
ffffffffc02025da:	b9250513          	addi	a0,a0,-1134 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc02025de:	d97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02025e2:	00003697          	auipc	a3,0x3
ffffffffc02025e6:	d4668693          	addi	a3,a3,-698 # ffffffffc0205328 <default_pmm_manager+0x278>
ffffffffc02025ea:	00002617          	auipc	a2,0x2
ffffffffc02025ee:	71660613          	addi	a2,a2,1814 # ffffffffc0204d00 <commands+0x738>
ffffffffc02025f2:	19b00593          	li	a1,411
ffffffffc02025f6:	00003517          	auipc	a0,0x3
ffffffffc02025fa:	b7250513          	addi	a0,a0,-1166 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc02025fe:	d77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc0202602:	00003617          	auipc	a2,0x3
ffffffffc0202606:	b3e60613          	addi	a2,a2,-1218 # ffffffffc0205140 <default_pmm_manager+0x90>
ffffffffc020260a:	19e00593          	li	a1,414
ffffffffc020260e:	00003517          	auipc	a0,0x3
ffffffffc0202612:	b5a50513          	addi	a0,a0,-1190 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc0202616:	d5ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020261a:	00003697          	auipc	a3,0x3
ffffffffc020261e:	d2668693          	addi	a3,a3,-730 # ffffffffc0205340 <default_pmm_manager+0x290>
ffffffffc0202622:	00002617          	auipc	a2,0x2
ffffffffc0202626:	6de60613          	addi	a2,a2,1758 # ffffffffc0204d00 <commands+0x738>
ffffffffc020262a:	19c00593          	li	a1,412
ffffffffc020262e:	00003517          	auipc	a0,0x3
ffffffffc0202632:	b3a50513          	addi	a0,a0,-1222 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc0202636:	d3ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020263a:	00003697          	auipc	a3,0x3
ffffffffc020263e:	d7e68693          	addi	a3,a3,-642 # ffffffffc02053b8 <default_pmm_manager+0x308>
ffffffffc0202642:	00002617          	auipc	a2,0x2
ffffffffc0202646:	6be60613          	addi	a2,a2,1726 # ffffffffc0204d00 <commands+0x738>
ffffffffc020264a:	1a400593          	li	a1,420
ffffffffc020264e:	00003517          	auipc	a0,0x3
ffffffffc0202652:	b1a50513          	addi	a0,a0,-1254 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc0202656:	d1ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc020265a:	00003697          	auipc	a3,0x3
ffffffffc020265e:	03e68693          	addi	a3,a3,62 # ffffffffc0205698 <default_pmm_manager+0x5e8>
ffffffffc0202662:	00002617          	auipc	a2,0x2
ffffffffc0202666:	69e60613          	addi	a2,a2,1694 # ffffffffc0204d00 <commands+0x738>
ffffffffc020266a:	1e000593          	li	a1,480
ffffffffc020266e:	00003517          	auipc	a0,0x3
ffffffffc0202672:	afa50513          	addi	a0,a0,-1286 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc0202676:	cfffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc020267a:	00003697          	auipc	a3,0x3
ffffffffc020267e:	fe668693          	addi	a3,a3,-26 # ffffffffc0205660 <default_pmm_manager+0x5b0>
ffffffffc0202682:	00002617          	auipc	a2,0x2
ffffffffc0202686:	67e60613          	addi	a2,a2,1662 # ffffffffc0204d00 <commands+0x738>
ffffffffc020268a:	1dd00593          	li	a1,477
ffffffffc020268e:	00003517          	auipc	a0,0x3
ffffffffc0202692:	ada50513          	addi	a0,a0,-1318 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc0202696:	cdffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 2);
ffffffffc020269a:	00003697          	auipc	a3,0x3
ffffffffc020269e:	f9668693          	addi	a3,a3,-106 # ffffffffc0205630 <default_pmm_manager+0x580>
ffffffffc02026a2:	00002617          	auipc	a2,0x2
ffffffffc02026a6:	65e60613          	addi	a2,a2,1630 # ffffffffc0204d00 <commands+0x738>
ffffffffc02026aa:	1d900593          	li	a1,473
ffffffffc02026ae:	00003517          	auipc	a0,0x3
ffffffffc02026b2:	aba50513          	addi	a0,a0,-1350 # ffffffffc0205168 <default_pmm_manager+0xb8>
...
ffffffffc020270e:	e4653503          	ld	a0,-442(a0) # ffffffffc0211550 <check_mm_struct>
...
ffffffffc0202724:	fc068693          	addi	a3,a3,-64 # ffffffffc02056e0 <default_pmm_manager+0x630>
ffffffffc0202728:	00002617          	auipc	a2,0x2
ffffffffc020272c:	5d860613          	addi	a2,a2,1496 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202730:	17a00593          	li	a1,378
ffffffffc0202734:	00003517          	auipc	a0,0x3
ffffffffc0202738:	a3450513          	addi	a0,a0,-1484 # ffffffffc0205168 <default_pmm_manager+0xb8>
...
ffffffffc02027a4:	9c86b683          	ld	a3,-1592(a3) # ffffffffc0206168 <error_string+0x38>
...
ffffffffc02027dc:	f2068693          	addi	a3,a3,-224 # ffffffffc02056f8 <default_pmm_manager+0x648>
ffffffffc02027e0:	00002617          	auipc	a2,0x2
ffffffffc02027e4:	52060613          	addi	a2,a2,1312 # ffffffffc0204d00 <commands+0x738>
ffffffffc02027e8:	1f000593          	li	a1,496
ffffffffc02027ec:	00003517          	auipc	a0,0x3
ffffffffc02027f0:	97c50513          	addi	a0,a0,-1668 # ffffffffc0205168 <default_pmm_manager+0xb8>
...
ffffffffc02027fe:	94660613          	addi	a2,a2,-1722 # ffffffffc0205140 <default_pmm_manager+0x90>
ffffffffc0202802:	06a00593          	li	a1,106
ffffffffc0202806:	00003517          	auipc	a0,0x3
ffffffffc020280a:	90250513          	addi	a0,a0,-1790 # ffffffffc0205108 <default_pmm_manager+0x58>
ffffffffc020280e:	b67fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(base != NULL);
ffffffffc0202812:	00003697          	auipc	a3,0x3
ffffffffc0202816:	f0668693          	addi	a3,a3,-250 # ffffffffc0205718 <default_pmm_manager+0x668>
ffffffffc020281a:	00002617          	auipc	a2,0x2
ffffffffc020281e:	4e660613          	addi	a2,a2,1254 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202822:	1f300593          	li	a1,499
ffffffffc0202826:	00003517          	auipc	a0,0x3
ffffffffc020282a:	94250513          	addi	a0,a0,-1726 # ffffffffc0205168 <default_pmm_manager+0xb8>
...
ffffffffc02028c6:	93e60613          	addi	a2,a2,-1730 # ffffffffc0205200 <default_pmm_manager+0x150>
ffffffffc02028ca:	06c00593          	li	a1,108
ffffffffc02028ce:	00003517          	auipc	a0,0x3
ffffffffc02028d2:	83a50513          	addi	a0,a0,-1990 # ffffffffc0205108 <default_pmm_manager+0x58>
ffffffffc02028d6:	a9ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(ptr != NULL);
ffffffffc02028da:	00003697          	auipc	a3,0x3
ffffffffc02028de:	e4e68693          	addi	a3,a3,-434 # ffffffffc0205728 <default_pmm_manager+0x678>
ffffffffc02028e2:	00002617          	auipc	a2,0x2
ffffffffc02028e6:	41e60613          	addi	a2,a2,1054 # ffffffffc0204d00 <commands+0x738>
ffffffffc02028ea:	1fa00593          	li	a1,506
ffffffffc02028ee:	00003517          	auipc	a0,0x3
ffffffffc02028f2:	87a50513          	addi	a0,a0,-1926 # ffffffffc0205168 <default_pmm_manager+0xb8>
ffffffffc02028f6:	a7ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0 && n < 1024 * 0124);
ffffffffc02028fa:	00003697          	auipc	a3,0x3
ffffffffc02028fe:	dfe68693          	addi	a3,a3,-514 # ffffffffc02056f8 <default_pmm_manager+0x648>
ffffffffc0202902:	00002617          	auipc	a2,0x2
ffffffffc0202906:	3fe60613          	addi	a2,a2,1022 # ffffffffc0204d00 <commands+0x738>
ffffffffc020290a:	1f900593          	li	a1,505
ffffffffc020290e:	00003517          	auipc	a0,0x3
ffffffffc0202912:	85a50513          	addi	a0,a0,-1958 # ffffffffc0205168 <default_pmm_manager+0xb8>
...
ffffffffc0202934:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202936:	386010ef          	jal	ra,ffffffffc0203cbc <swapfs_init>
...
ffffffffc0202994:	dd850513          	addi	a0,a0,-552 # ffffffffc0205768 <default_pmm_manager+0x6b8>
    return listelm->next;
ffffffffc0202998:	0000e497          	auipc	s1,0xe
ffffffffc020299c:	6a848493          	addi	s1,s1,1704 # ffffffffc0211040 <free_area_bf>
...
ffffffffc02029e4:	da050513          	addi	a0,a0,-608 # ffffffffc0205780 <default_pmm_manager+0x6d0>
ffffffffc02029e8:	ed2fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     
     //now we set the phy pages env     
     struct mm_struct *mm = mm_create();
ffffffffc02029ec:	24d000ef          	jal	ra,ffffffffc0203438 <mm_create>
...
ffffffffc02029fa:	b5a78793          	addi	a5,a5,-1190 # ffffffffc0211550 <check_mm_struct>
...
ffffffffc0202a20:	261000ef          	jal	ra,ffffffffc0203480 <vma_create>
...
ffffffffc0202a2c:	2c3000ef          	jal	ra,ffffffffc02034ee <insert_vma_struct>

     //setup the temp Page Table vaddr 0~4MB
     cprintf("setup Page Table for vaddr 0X1000, so alloc a page\n");
ffffffffc0202a30:	00003517          	auipc	a0,0x3
ffffffffc0202a34:	dc050513          	addi	a0,a0,-576 # ffffffffc02057f0 <default_pmm_manager+0x740>
...
ffffffffc0202a50:	df450513          	addi	a0,a0,-524 # ffffffffc0205840 <default_pmm_manager+0x790>
...
ffffffffc0202aa2:	5a07a923          	sw	zero,1458(a5) # ffffffffc0211050 <free_area_bf+0x10>
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
...
ffffffffc0202ac4:	e0850513          	addi	a0,a0,-504 # ffffffffc02058c8 <default_pmm_manager+0x818>
...
ffffffffc0202ad2:	a807a523          	sw	zero,-1398(a5) # ffffffffc0211558 <pgfault_num>
     *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc0202ae0:	a7c5a583          	lw	a1,-1412(a1) # ffffffffc0211558 <pgfault_num>
ffffffffc0202ae4:	4805                	li	a6,1
ffffffffc0202ae6:	0000f797          	auipc	a5,0xf
ffffffffc0202aea:	a7278793          	addi	a5,a5,-1422 # ffffffffc0211558 <pgfault_num>
...
ffffffffc0202ba0:	5d4c0c13          	addi	s8,s8,1492 # ffffffffc0206170 <nbase>
...
ffffffffc0202c10:	d6450513          	addi	a0,a0,-668 # ffffffffc0205970 <default_pmm_manager+0x8c0>
...
ffffffffc0202c36:	189000ef          	jal	ra,ffffffffc02035be <mm_destroy>
...
ffffffffc0202c62:	d4250513          	addi	a0,a0,-702 # ffffffffc02059a0 <default_pmm_manager+0x8f0>
ffffffffc0202c66:	c54fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     //assert(count == 0);
     
     cprintf("check_swap() succeeded!\n");
ffffffffc0202c6a:	00003517          	auipc	a0,0x3
ffffffffc0202c6e:	d5650513          	addi	a0,a0,-682 # ffffffffc02059c0 <default_pmm_manager+0x910>
...
ffffffffc0202c80:	07468693          	addi	a3,a3,116 # ffffffffc0204cf0 <commands+0x728>
ffffffffc0202c84:	00002617          	auipc	a2,0x2
ffffffffc0202c88:	07c60613          	addi	a2,a2,124 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202c8c:	0ba00593          	li	a1,186
ffffffffc0202c90:	00003517          	auipc	a0,0x3
ffffffffc0202c94:	ac850513          	addi	a0,a0,-1336 # ffffffffc0205758 <default_pmm_manager+0x6a8>
ffffffffc0202c98:	edcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202c9c:	00003697          	auipc	a3,0x3
ffffffffc0202ca0:	cac68693          	addi	a3,a3,-852 # ffffffffc0205948 <default_pmm_manager+0x898>
ffffffffc0202ca4:	00002617          	auipc	a2,0x2
ffffffffc0202ca8:	05c60613          	addi	a2,a2,92 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202cac:	0fa00593          	li	a1,250
ffffffffc0202cb0:	00003517          	auipc	a0,0x3
ffffffffc0202cb4:	aa850513          	addi	a0,a0,-1368 # ffffffffc0205758 <default_pmm_manager+0x6a8>
ffffffffc0202cb8:	ebcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202cbc:	00002617          	auipc	a2,0x2
ffffffffc0202cc0:	45c60613          	addi	a2,a2,1116 # ffffffffc0205118 <default_pmm_manager+0x68>
ffffffffc0202cc4:	07000593          	li	a1,112
ffffffffc0202cc8:	00002517          	auipc	a0,0x2
ffffffffc0202ccc:	44050513          	addi	a0,a0,1088 # ffffffffc0205108 <default_pmm_manager+0x58>
ffffffffc0202cd0:	ea4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0202cd4:	00002617          	auipc	a2,0x2
ffffffffc0202cd8:	41460613          	addi	a2,a2,1044 # ffffffffc02050e8 <default_pmm_manager+0x38>
ffffffffc0202cdc:	06500593          	li	a1,101
ffffffffc0202ce0:	00002517          	auipc	a0,0x2
ffffffffc0202ce4:	42850513          	addi	a0,a0,1064 # ffffffffc0205108 <default_pmm_manager+0x58>
ffffffffc0202ce8:	e8cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0202cec:	00003697          	auipc	a3,0x3
ffffffffc0202cf0:	b9468693          	addi	a3,a3,-1132 # ffffffffc0205880 <default_pmm_manager+0x7d0>
ffffffffc0202cf4:	00002617          	auipc	a2,0x2
ffffffffc0202cf8:	00c60613          	addi	a2,a2,12 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202cfc:	0db00593          	li	a1,219
ffffffffc0202d00:	00003517          	auipc	a0,0x3
ffffffffc0202d04:	a5850513          	addi	a0,a0,-1448 # ffffffffc0205758 <default_pmm_manager+0x6a8>
ffffffffc0202d08:	e6cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202d0c:	00003697          	auipc	a3,0x3
ffffffffc0202d10:	b5c68693          	addi	a3,a3,-1188 # ffffffffc0205868 <default_pmm_manager+0x7b8>
ffffffffc0202d14:	00002617          	auipc	a2,0x2
ffffffffc0202d18:	fec60613          	addi	a2,a2,-20 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202d1c:	0da00593          	li	a1,218
ffffffffc0202d20:	00003517          	auipc	a0,0x3
ffffffffc0202d24:	a3850513          	addi	a0,a0,-1480 # ffffffffc0205758 <default_pmm_manager+0x6a8>
ffffffffc0202d28:	e4cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202d2c:	00003617          	auipc	a2,0x3
ffffffffc0202d30:	a0c60613          	addi	a2,a2,-1524 # ffffffffc0205738 <default_pmm_manager+0x688>
ffffffffc0202d34:	02700593          	li	a1,39
ffffffffc0202d38:	00003517          	auipc	a0,0x3
ffffffffc0202d3c:	a2050513          	addi	a0,a0,-1504 # ffffffffc0205758 <default_pmm_manager+0x6a8>
ffffffffc0202d40:	e34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202d44:	00003697          	auipc	a3,0x3
ffffffffc0202d48:	bec68693          	addi	a3,a3,-1044 # ffffffffc0205930 <default_pmm_manager+0x880>
ffffffffc0202d4c:	00002617          	auipc	a2,0x2
ffffffffc0202d50:	fb460613          	addi	a2,a2,-76 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202d54:	0f900593          	li	a1,249
ffffffffc0202d58:	00003517          	auipc	a0,0x3
ffffffffc0202d5c:	a0050513          	addi	a0,a0,-1536 # ffffffffc0205758 <default_pmm_manager+0x6a8>
ffffffffc0202d60:	e14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d64:	00003697          	auipc	a3,0x3
ffffffffc0202d68:	bbc68693          	addi	a3,a3,-1092 # ffffffffc0205920 <default_pmm_manager+0x870>
ffffffffc0202d6c:	00002617          	auipc	a2,0x2
ffffffffc0202d70:	f9460613          	addi	a2,a2,-108 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202d74:	09d00593          	li	a1,157
ffffffffc0202d78:	00003517          	auipc	a0,0x3
ffffffffc0202d7c:	9e050513          	addi	a0,a0,-1568 # ffffffffc0205758 <default_pmm_manager+0x6a8>
ffffffffc0202d80:	df4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d84:	00003697          	auipc	a3,0x3
ffffffffc0202d88:	b9c68693          	addi	a3,a3,-1124 # ffffffffc0205920 <default_pmm_manager+0x870>
ffffffffc0202d8c:	00002617          	auipc	a2,0x2
ffffffffc0202d90:	f7460613          	addi	a2,a2,-140 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202d94:	09f00593          	li	a1,159
ffffffffc0202d98:	00003517          	auipc	a0,0x3
ffffffffc0202d9c:	9c050513          	addi	a0,a0,-1600 # ffffffffc0205758 <default_pmm_manager+0x6a8>
ffffffffc0202da0:	dd4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert( nr_free == 0);         
ffffffffc0202da4:	00002697          	auipc	a3,0x2
ffffffffc0202da8:	13468693          	addi	a3,a3,308 # ffffffffc0204ed8 <commands+0x910>
ffffffffc0202dac:	00002617          	auipc	a2,0x2
ffffffffc0202db0:	f5460613          	addi	a2,a2,-172 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202db4:	0f100593          	li	a1,241
ffffffffc0202db8:	00003517          	auipc	a0,0x3
ffffffffc0202dbc:	9a050513          	addi	a0,a0,-1632 # ffffffffc0205758 <default_pmm_manager+0x6a8>
ffffffffc0202dc0:	db4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(ret==0);
ffffffffc0202dc4:	00003697          	auipc	a3,0x3
ffffffffc0202dc8:	bd468693          	addi	a3,a3,-1068 # ffffffffc0205998 <default_pmm_manager+0x8e8>
ffffffffc0202dcc:	00002617          	auipc	a2,0x2
ffffffffc0202dd0:	f3460613          	addi	a2,a2,-204 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202dd4:	10000593          	li	a1,256
ffffffffc0202dd8:	00003517          	auipc	a0,0x3
ffffffffc0202ddc:	98050513          	addi	a0,a0,-1664 # ffffffffc0205758 <default_pmm_manager+0x6a8>
ffffffffc0202de0:	d94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0202de4:	00003697          	auipc	a3,0x3
ffffffffc0202de8:	9ec68693          	addi	a3,a3,-1556 # ffffffffc02057d0 <default_pmm_manager+0x720>
ffffffffc0202dec:	00002617          	auipc	a2,0x2
ffffffffc0202df0:	f1460613          	addi	a2,a2,-236 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202df4:	0ca00593          	li	a1,202
ffffffffc0202df8:	00003517          	auipc	a0,0x3
ffffffffc0202dfc:	96050513          	addi	a0,a0,-1696 # ffffffffc0205758 <default_pmm_manager+0x6a8>
ffffffffc0202e00:	d74fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(vma != NULL);
ffffffffc0202e04:	00003697          	auipc	a3,0x3
ffffffffc0202e08:	9dc68693          	addi	a3,a3,-1572 # ffffffffc02057e0 <default_pmm_manager+0x730>
ffffffffc0202e0c:	00002617          	auipc	a2,0x2
ffffffffc0202e10:	ef460613          	addi	a2,a2,-268 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202e14:	0cd00593          	li	a1,205
ffffffffc0202e18:	00003517          	auipc	a0,0x3
ffffffffc0202e1c:	94050513          	addi	a0,a0,-1728 # ffffffffc0205758 <default_pmm_manager+0x6a8>
ffffffffc0202e20:	d54fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0202e24:	00003697          	auipc	a3,0x3
ffffffffc0202e28:	a0468693          	addi	a3,a3,-1532 # ffffffffc0205828 <default_pmm_manager+0x778>
ffffffffc0202e2c:	00002617          	auipc	a2,0x2
ffffffffc0202e30:	ed460613          	addi	a2,a2,-300 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202e34:	0d500593          	li	a1,213
ffffffffc0202e38:	00003517          	auipc	a0,0x3
ffffffffc0202e3c:	92050513          	addi	a0,a0,-1760 # ffffffffc0205758 <default_pmm_manager+0x6a8>
ffffffffc0202e40:	d34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(total == nr_free_pages());
ffffffffc0202e44:	00002697          	auipc	a3,0x2
ffffffffc0202e48:	eec68693          	addi	a3,a3,-276 # ffffffffc0204d30 <commands+0x768>
ffffffffc0202e4c:	00002617          	auipc	a2,0x2
ffffffffc0202e50:	eb460613          	addi	a2,a2,-332 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202e54:	0bd00593          	li	a1,189
ffffffffc0202e58:	00003517          	auipc	a0,0x3
ffffffffc0202e5c:	90050513          	addi	a0,a0,-1792 # ffffffffc0205758 <default_pmm_manager+0x6a8>
ffffffffc0202e60:	d14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e64:	00003697          	auipc	a3,0x3
ffffffffc0202e68:	a9c68693          	addi	a3,a3,-1380 # ffffffffc0205900 <default_pmm_manager+0x850>
ffffffffc0202e6c:	00002617          	auipc	a2,0x2
ffffffffc0202e70:	e9460613          	addi	a2,a2,-364 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202e74:	09500593          	li	a1,149
ffffffffc0202e78:	00003517          	auipc	a0,0x3
ffffffffc0202e7c:	8e050513          	addi	a0,a0,-1824 # ffffffffc0205758 <default_pmm_manager+0x6a8>
ffffffffc0202e80:	cf4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e84:	00003697          	auipc	a3,0x3
ffffffffc0202e88:	a7c68693          	addi	a3,a3,-1412 # ffffffffc0205900 <default_pmm_manager+0x850>
ffffffffc0202e8c:	00002617          	auipc	a2,0x2
ffffffffc0202e90:	e7460613          	addi	a2,a2,-396 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202e94:	09700593          	li	a1,151
ffffffffc0202e98:	00003517          	auipc	a0,0x3
ffffffffc0202e9c:	8c050513          	addi	a0,a0,-1856 # ffffffffc0205758 <default_pmm_manager+0x6a8>
ffffffffc0202ea0:	cd4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ea4:	00003697          	auipc	a3,0x3
ffffffffc0202ea8:	a6c68693          	addi	a3,a3,-1428 # ffffffffc0205910 <default_pmm_manager+0x860>
ffffffffc0202eac:	00002617          	auipc	a2,0x2
ffffffffc0202eb0:	e5460613          	addi	a2,a2,-428 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202eb4:	09900593          	li	a1,153
ffffffffc0202eb8:	00003517          	auipc	a0,0x3
ffffffffc0202ebc:	8a050513          	addi	a0,a0,-1888 # ffffffffc0205758 <default_pmm_manager+0x6a8>
ffffffffc0202ec0:	cb4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ec4:	00003697          	auipc	a3,0x3
ffffffffc0202ec8:	a4c68693          	addi	a3,a3,-1460 # ffffffffc0205910 <default_pmm_manager+0x860>
ffffffffc0202ecc:	00002617          	auipc	a2,0x2
ffffffffc0202ed0:	e3460613          	addi	a2,a2,-460 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202ed4:	09b00593          	li	a1,155
ffffffffc0202ed8:	00003517          	auipc	a0,0x3
ffffffffc0202edc:	88050513          	addi	a0,a0,-1920 # ffffffffc0205758 <default_pmm_manager+0x6a8>
ffffffffc0202ee0:	c94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202ee4:	00003697          	auipc	a3,0x3
ffffffffc0202ee8:	a0c68693          	addi	a3,a3,-1524 # ffffffffc02058f0 <default_pmm_manager+0x840>
ffffffffc0202eec:	00002617          	auipc	a2,0x2
ffffffffc0202ef0:	e1460613          	addi	a2,a2,-492 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202ef4:	09100593          	li	a1,145
ffffffffc0202ef8:	00003517          	auipc	a0,0x3
ffffffffc0202efc:	86050513          	addi	a0,a0,-1952 # ffffffffc0205758 <default_pmm_manager+0x6a8>
ffffffffc0202f00:	c74fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202f04:	00003697          	auipc	a3,0x3
ffffffffc0202f08:	9ec68693          	addi	a3,a3,-1556 # ffffffffc02058f0 <default_pmm_manager+0x840>
ffffffffc0202f0c:	00002617          	auipc	a2,0x2
ffffffffc0202f10:	df460613          	addi	a2,a2,-524 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202f14:	09300593          	li	a1,147
ffffffffc0202f18:	00003517          	auipc	a0,0x3
ffffffffc0202f1c:	84050513          	addi	a0,a0,-1984 # ffffffffc0205758 <default_pmm_manager+0x6a8>
ffffffffc0202f20:	c54fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(mm != NULL);
ffffffffc0202f24:	00003697          	auipc	a3,0x3
ffffffffc0202f28:	88468693          	addi	a3,a3,-1916 # ffffffffc02057a8 <default_pmm_manager+0x6f8>
ffffffffc0202f2c:	00002617          	auipc	a2,0x2
ffffffffc0202f30:	dd460613          	addi	a2,a2,-556 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202f34:	0c200593          	li	a1,194
ffffffffc0202f38:	00003517          	auipc	a0,0x3
ffffffffc0202f3c:	82050513          	addi	a0,a0,-2016 # ffffffffc0205758 <default_pmm_manager+0x6a8>
ffffffffc0202f40:	c34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0202f44:	00003697          	auipc	a3,0x3
ffffffffc0202f48:	87468693          	addi	a3,a3,-1932 # ffffffffc02057b8 <default_pmm_manager+0x708>
ffffffffc0202f4c:	00002617          	auipc	a2,0x2
ffffffffc0202f50:	db460613          	addi	a2,a2,-588 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202f54:	0c500593          	li	a1,197
ffffffffc0202f58:	00003517          	auipc	a0,0x3
ffffffffc0202f5c:	80050513          	addi	a0,a0,-2048 # ffffffffc0205758 <default_pmm_manager+0x6a8>
ffffffffc0202f60:	c14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0202f64:	00003697          	auipc	a3,0x3
ffffffffc0202f68:	93c68693          	addi	a3,a3,-1732 # ffffffffc02058a0 <default_pmm_manager+0x7f0>
ffffffffc0202f6c:	00002617          	auipc	a2,0x2
ffffffffc0202f70:	d9460613          	addi	a2,a2,-620 # ffffffffc0204d00 <commands+0x738>
ffffffffc0202f74:	0e800593          	li	a1,232
ffffffffc0202f78:	00002517          	auipc	a0,0x2
ffffffffc0202f7c:	7e050513          	addi	a0,a0,2016 # ffffffffc0205758 <default_pmm_manager+0x6a8>
...
ffffffffc0202fc8:	a7cb0b13          	addi	s6,s6,-1412 # ffffffffc0205a40 <default_pmm_manager+0x990>
                    cprintf("SWAP: failed to save\n");
ffffffffc0202fcc:	00003b97          	auipc	s7,0x3
ffffffffc0202fd0:	a5cb8b93          	addi	s7,s7,-1444 # ffffffffc0205a28 <default_pmm_manager+0x978>
...
ffffffffc0203040:	54f000ef          	jal	ra,ffffffffc0203d8e <swapfs_write>
...
ffffffffc0203082:	96250513          	addi	a0,a0,-1694 # ffffffffc02059e0 <default_pmm_manager+0x930>
...
ffffffffc0203094:	98068693          	addi	a3,a3,-1664 # ffffffffc0205a10 <default_pmm_manager+0x960>
ffffffffc0203098:	00002617          	auipc	a2,0x2
ffffffffc020309c:	c6860613          	addi	a2,a2,-920 # ffffffffc0204d00 <commands+0x738>
ffffffffc02030a0:	06600593          	li	a1,102
ffffffffc02030a4:	00002517          	auipc	a0,0x2
ffffffffc02030a8:	6b450513          	addi	a0,a0,1716 # ffffffffc0205758 <default_pmm_manager+0x6a8>
...
ffffffffc02030de:	417000ef          	jal	ra,ffffffffc0203cf4 <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc02030e2:	00093583          	ld	a1,0(s2)
ffffffffc02030e6:	8626                	mv	a2,s1
ffffffffc02030e8:	00003517          	auipc	a0,0x3
ffffffffc02030ec:	9a850513          	addi	a0,a0,-1624 # ffffffffc0205a90 <default_pmm_manager+0x9e0>
...
ffffffffc020310e:	97668693          	addi	a3,a3,-1674 # ffffffffc0205a80 <default_pmm_manager+0x9d0>
ffffffffc0203112:	00002617          	auipc	a2,0x2
ffffffffc0203116:	bee60613          	addi	a2,a2,-1042 # ffffffffc0204d00 <commands+0x738>
ffffffffc020311a:	07c00593          	li	a1,124
ffffffffc020311e:	00002517          	auipc	a0,0x2
ffffffffc0203122:	63a50513          	addi	a0,a0,1594 # ffffffffc0205758 <default_pmm_manager+0x6a8>
...
ffffffffc0203146:	4166a683          	lw	a3,1046(a3) # ffffffffc0211558 <pgfault_num>
...
ffffffffc0203158:	40478793          	addi	a5,a5,1028 # ffffffffc0211558 <pgfault_num>
...
ffffffffc02031f6:	72e68693          	addi	a3,a3,1838 # ffffffffc0205920 <default_pmm_manager+0x870>
ffffffffc02031fa:	00002617          	auipc	a2,0x2
ffffffffc02031fe:	b0660613          	addi	a2,a2,-1274 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203202:	07700593          	li	a1,119
ffffffffc0203206:	00003517          	auipc	a0,0x3
ffffffffc020320a:	8ca50513          	addi	a0,a0,-1846 # ffffffffc0205ad0 <default_pmm_manager+0xa20>
ffffffffc020320e:	966fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==6);
ffffffffc0203212:	00003697          	auipc	a3,0x3
ffffffffc0203216:	90e68693          	addi	a3,a3,-1778 # ffffffffc0205b20 <default_pmm_manager+0xa70>
ffffffffc020321a:	00002617          	auipc	a2,0x2
ffffffffc020321e:	ae660613          	addi	a2,a2,-1306 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203222:	08e00593          	li	a1,142
ffffffffc0203226:	00003517          	auipc	a0,0x3
ffffffffc020322a:	8aa50513          	addi	a0,a0,-1878 # ffffffffc0205ad0 <default_pmm_manager+0xa20>
ffffffffc020322e:	946fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203232:	00003697          	auipc	a3,0x3
ffffffffc0203236:	8c668693          	addi	a3,a3,-1850 # ffffffffc0205af8 <default_pmm_manager+0xa48>
ffffffffc020323a:	00002617          	auipc	a2,0x2
ffffffffc020323e:	ac660613          	addi	a2,a2,-1338 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203242:	08c00593          	li	a1,140
ffffffffc0203246:	00003517          	auipc	a0,0x3
ffffffffc020324a:	88a50513          	addi	a0,a0,-1910 # ffffffffc0205ad0 <default_pmm_manager+0xa20>
ffffffffc020324e:	926fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203252:	00003697          	auipc	a3,0x3
ffffffffc0203256:	89668693          	addi	a3,a3,-1898 # ffffffffc0205ae8 <default_pmm_manager+0xa38>
ffffffffc020325a:	00002617          	auipc	a2,0x2
ffffffffc020325e:	aa660613          	addi	a2,a2,-1370 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203262:	08b00593          	li	a1,139
ffffffffc0203266:	00003517          	auipc	a0,0x3
ffffffffc020326a:	86a50513          	addi	a0,a0,-1942 # ffffffffc0205ad0 <default_pmm_manager+0xa20>
ffffffffc020326e:	906fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203272:	00003697          	auipc	a3,0x3
ffffffffc0203276:	87668693          	addi	a3,a3,-1930 # ffffffffc0205ae8 <default_pmm_manager+0xa38>
ffffffffc020327a:	00002617          	auipc	a2,0x2
ffffffffc020327e:	a8660613          	addi	a2,a2,-1402 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203282:	08900593          	li	a1,137
ffffffffc0203286:	00003517          	auipc	a0,0x3
ffffffffc020328a:	84a50513          	addi	a0,a0,-1974 # ffffffffc0205ad0 <default_pmm_manager+0xa20>
ffffffffc020328e:	8e6fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203292:	00003697          	auipc	a3,0x3
ffffffffc0203296:	85668693          	addi	a3,a3,-1962 # ffffffffc0205ae8 <default_pmm_manager+0xa38>
ffffffffc020329a:	00002617          	auipc	a2,0x2
ffffffffc020329e:	a6660613          	addi	a2,a2,-1434 # ffffffffc0204d00 <commands+0x738>
ffffffffc02032a2:	08700593          	li	a1,135
ffffffffc02032a6:	00003517          	auipc	a0,0x3
ffffffffc02032aa:	82a50513          	addi	a0,a0,-2006 # ffffffffc0205ad0 <default_pmm_manager+0xa20>
ffffffffc02032ae:	8c6fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032b2:	00003697          	auipc	a3,0x3
ffffffffc02032b6:	83668693          	addi	a3,a3,-1994 # ffffffffc0205ae8 <default_pmm_manager+0xa38>
ffffffffc02032ba:	00002617          	auipc	a2,0x2
ffffffffc02032be:	a4660613          	addi	a2,a2,-1466 # ffffffffc0204d00 <commands+0x738>
ffffffffc02032c2:	08500593          	li	a1,133
ffffffffc02032c6:	00003517          	auipc	a0,0x3
ffffffffc02032ca:	80a50513          	addi	a0,a0,-2038 # ffffffffc0205ad0 <default_pmm_manager+0xa20>
ffffffffc02032ce:	8a6fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032d2:	00003697          	auipc	a3,0x3
ffffffffc02032d6:	81668693          	addi	a3,a3,-2026 # ffffffffc0205ae8 <default_pmm_manager+0xa38>
ffffffffc02032da:	00002617          	auipc	a2,0x2
ffffffffc02032de:	a2660613          	addi	a2,a2,-1498 # ffffffffc0204d00 <commands+0x738>
ffffffffc02032e2:	08300593          	li	a1,131
ffffffffc02032e6:	00002517          	auipc	a0,0x2
ffffffffc02032ea:	7ea50513          	addi	a0,a0,2026 # ffffffffc0205ad0 <default_pmm_manager+0xa20>
ffffffffc02032ee:	886fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032f2:	00002697          	auipc	a3,0x2
ffffffffc02032f6:	7f668693          	addi	a3,a3,2038 # ffffffffc0205ae8 <default_pmm_manager+0xa38>
ffffffffc02032fa:	00002617          	auipc	a2,0x2
ffffffffc02032fe:	a0660613          	addi	a2,a2,-1530 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203302:	08100593          	li	a1,129
ffffffffc0203306:	00002517          	auipc	a0,0x2
ffffffffc020330a:	7ca50513          	addi	a0,a0,1994 # ffffffffc0205ad0 <default_pmm_manager+0xa20>
ffffffffc020330e:	866fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203312:	00002697          	auipc	a3,0x2
ffffffffc0203316:	7d668693          	addi	a3,a3,2006 # ffffffffc0205ae8 <default_pmm_manager+0xa38>
ffffffffc020331a:	00002617          	auipc	a2,0x2
ffffffffc020331e:	9e660613          	addi	a2,a2,-1562 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203322:	07f00593          	li	a1,127
ffffffffc0203326:	00002517          	auipc	a0,0x2
ffffffffc020332a:	7aa50513          	addi	a0,a0,1962 # ffffffffc0205ad0 <default_pmm_manager+0xa20>
ffffffffc020332e:	846fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc0203332:	00002697          	auipc	a3,0x2
ffffffffc0203336:	5ee68693          	addi	a3,a3,1518 # ffffffffc0205920 <default_pmm_manager+0x870>
ffffffffc020333a:	00002617          	auipc	a2,0x2
ffffffffc020333e:	9c660613          	addi	a2,a2,-1594 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203342:	07d00593          	li	a1,125
ffffffffc0203346:	00002517          	auipc	a0,0x2
ffffffffc020334a:	78a50513          	addi	a0,a0,1930 # ffffffffc0205ad0 <default_pmm_manager+0xa20>
ffffffffc020334e:	826fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc0203352:	00002697          	auipc	a3,0x2
ffffffffc0203356:	5ce68693          	addi	a3,a3,1486 # ffffffffc0205920 <default_pmm_manager+0x870>
ffffffffc020335a:	00002617          	auipc	a2,0x2
ffffffffc020335e:	9a660613          	addi	a2,a2,-1626 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203362:	07b00593          	li	a1,123
ffffffffc0203366:	00002517          	auipc	a0,0x2
ffffffffc020336a:	76a50513          	addi	a0,a0,1898 # ffffffffc0205ad0 <default_pmm_manager+0xa20>
ffffffffc020336e:	806fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc0203372:	00002697          	auipc	a3,0x2
ffffffffc0203376:	5ae68693          	addi	a3,a3,1454 # ffffffffc0205920 <default_pmm_manager+0x870>
ffffffffc020337a:	00002617          	auipc	a2,0x2
ffffffffc020337e:	98660613          	addi	a2,a2,-1658 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203382:	07900593          	li	a1,121
ffffffffc0203386:	00002517          	auipc	a0,0x2
ffffffffc020338a:	74a50513          	addi	a0,a0,1866 # ffffffffc0205ad0 <default_pmm_manager+0xa20>
...
ffffffffc02033a2:	7a268693          	addi	a3,a3,1954 # ffffffffc0205b40 <default_pmm_manager+0xa90>
ffffffffc02033a6:	00002617          	auipc	a2,0x2
ffffffffc02033aa:	95a60613          	addi	a2,a2,-1702 # ffffffffc0204d00 <commands+0x738>
ffffffffc02033ae:	04400593          	li	a1,68
ffffffffc02033b2:	00002517          	auipc	a0,0x2
ffffffffc02033b6:	71e50513          	addi	a0,a0,1822 # ffffffffc0205ad0 <default_pmm_manager+0xa20>
ffffffffc02033ba:	fbbfc0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(head != NULL);
ffffffffc02033be:	00002697          	auipc	a3,0x2
ffffffffc02033c2:	77268693          	addi	a3,a3,1906 # ffffffffc0205b30 <default_pmm_manager+0xa80>
ffffffffc02033c6:	00002617          	auipc	a2,0x2
ffffffffc02033ca:	93a60613          	addi	a2,a2,-1734 # ffffffffc0204d00 <commands+0x738>
ffffffffc02033ce:	04300593          	li	a1,67
ffffffffc02033d2:	00002517          	auipc	a0,0x2
ffffffffc02033d6:	6fe50513          	addi	a0,a0,1790 # ffffffffc0205ad0 <default_pmm_manager+0xa20>
...
ffffffffc02033e2:	16a7b783          	ld	a5,362(a5) # ffffffffc0211548 <curr_ptr>
ffffffffc02033e6:	c399                	beqz	a5,ffffffffc02033ec <_clock_map_swappable+0xe>
}
...
ffffffffc02033f2:	76268693          	addi	a3,a3,1890 # ffffffffc0205b50 <default_pmm_manager+0xaa0>
ffffffffc02033f6:	00002617          	auipc	a2,0x2
ffffffffc02033fa:	90a60613          	addi	a2,a2,-1782 # ffffffffc0204d00 <commands+0x738>
ffffffffc02033fe:	03300593          	li	a1,51
ffffffffc0203402:	00002517          	auipc	a0,0x2
ffffffffc0203406:	6ce50513          	addi	a0,a0,1742 # ffffffffc0205ad0 <default_pmm_manager+0xa20>
{
ffffffffc020340a:	e406                	sd	ra,8(sp)
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc020340c:	f69fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203410 <_clock_tick_event>:
ffffffffc0203410:	4501                	li	a0,0
ffffffffc0203412:	8082                	ret

ffffffffc0203414 <check_vma_overlap.part.0>:
}
...
ffffffffc0203416:	00002697          	auipc	a3,0x2
ffffffffc020341a:	77a68693          	addi	a3,a3,1914 # ffffffffc0205b90 <default_pmm_manager+0xae0>
ffffffffc020341e:	00002617          	auipc	a2,0x2
ffffffffc0203422:	8e260613          	addi	a2,a2,-1822 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203426:	07d00593          	li	a1,125
ffffffffc020342a:	00002517          	auipc	a0,0x2
ffffffffc020342e:	78650513          	addi	a0,a0,1926 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
ffffffffc0203432:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc0203434:	f41fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203438 <mm_create>:
mm_create(void) {
ffffffffc0203438:	1141                	addi	sp,sp,-16
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc020343a:	03000513          	li	a0,48
mm_create(void) {
ffffffffc020343e:	e022                	sd	s0,0(sp)
ffffffffc0203440:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203442:	b36ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203446:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc0203448:	c105                	beqz	a0,ffffffffc0203468 <mm_create+0x30>
    elm->prev = elm->next = elm;
ffffffffc020344a:	e408                	sd	a0,8(s0)
ffffffffc020344c:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
ffffffffc020344e:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc0203452:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc0203456:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020345a:	0000e797          	auipc	a5,0xe
ffffffffc020345e:	0e67a783          	lw	a5,230(a5) # ffffffffc0211540 <swap_init_ok>
ffffffffc0203462:	eb81                	bnez	a5,ffffffffc0203472 <mm_create+0x3a>
...
ffffffffc0203470:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203472:	b13ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
}
...
ffffffffc02034ae:	86aa                	mv	a3,a0
    if (mm != NULL) {
ffffffffc02034b0:	c505                	beqz	a0,ffffffffc02034d8 <find_vma+0x2a>
        vma = mm->mmap_cache;
ffffffffc02034b2:	6908                	ld	a0,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc02034b4:	c501                	beqz	a0,ffffffffc02034bc <find_vma+0xe>
ffffffffc02034b6:	651c                	ld	a5,8(a0)
ffffffffc02034b8:	02f5f263          	bgeu	a1,a5,ffffffffc02034dc <find_vma+0x2e>
    return listelm->next;
ffffffffc02034bc:	669c                	ld	a5,8(a3)
                while ((le = list_next(le)) != list) {
ffffffffc02034be:	00f68d63          	beq	a3,a5,ffffffffc02034d8 <find_vma+0x2a>
                    if (vma->vm_start<=addr && addr < vma->vm_end) {
ffffffffc02034c2:	fe87b703          	ld	a4,-24(a5)
ffffffffc02034c6:	00e5e663          	bltu	a1,a4,ffffffffc02034d2 <find_vma+0x24>
ffffffffc02034ca:	ff07b703          	ld	a4,-16(a5)
ffffffffc02034ce:	00e5ec63          	bltu	a1,a4,ffffffffc02034e6 <find_vma+0x38>
ffffffffc02034d2:	679c                	ld	a5,8(a5)
                while ((le = list_next(le)) != list) {
ffffffffc02034d4:	fef697e3          	bne	a3,a5,ffffffffc02034c2 <find_vma+0x14>
    struct vma_struct *vma = NULL;
ffffffffc02034d8:	4501                	li	a0,0
}
ffffffffc02034da:	8082                	ret
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc02034dc:	691c                	ld	a5,16(a0)
ffffffffc02034de:	fcf5ffe3          	bgeu	a1,a5,ffffffffc02034bc <find_vma+0xe>
            mm->mmap_cache = vma;
ffffffffc02034e2:	ea88                	sd	a0,16(a3)
ffffffffc02034e4:	8082                	ret
                    vma = le2vma(le, list_link);
ffffffffc02034e6:	fe078513          	addi	a0,a5,-32
            mm->mmap_cache = vma;
ffffffffc02034ea:	ea88                	sd	a0,16(a3)
ffffffffc02034ec:	8082                	ret

ffffffffc02034ee <insert_vma_struct>:
...
ffffffffc02034ee:	6590                	ld	a2,8(a1)
ffffffffc02034f0:	0105b803          	ld	a6,16(a1) # 1010 <kern_entry-0xffffffffc01feff0>
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
ffffffffc02034f4:	1141                	addi	sp,sp,-16
ffffffffc02034f6:	e406                	sd	ra,8(sp)
ffffffffc02034f8:	87aa                	mv	a5,a0
    assert(vma->vm_start < vma->vm_end);
ffffffffc02034fa:	01066763          	bltu	a2,a6,ffffffffc0203508 <insert_vma_struct+0x1a>
ffffffffc02034fe:	a085                	j	ffffffffc020355e <insert_vma_struct+0x70>
...
ffffffffc0203500:	fe87b703          	ld	a4,-24(a5)
ffffffffc0203504:	04e66863          	bltu	a2,a4,ffffffffc0203554 <insert_vma_struct+0x66>
ffffffffc0203508:	86be                	mv	a3,a5
ffffffffc020350a:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc020350c:	fef51ae3          	bne	a0,a5,ffffffffc0203500 <insert_vma_struct+0x12>
        }
    ...
    /* check overlap */
    if (le_prev != list) {
ffffffffc0203510:	02a68463          	beq	a3,a0,ffffffffc0203538 <insert_vma_struct+0x4a>
        check_vma_overlap(le2vma(le_prev, list_link), vma);
ffffffffc0203514:	ff06b703          	ld	a4,-16(a3)
    assert(prev->vm_start < prev->vm_end);
ffffffffc0203518:	fe86b883          	ld	a7,-24(a3)
ffffffffc020351c:	08e8f163          	bgeu	a7,a4,ffffffffc020359e <insert_vma_struct+0xb0>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203520:	04e66f63          	bltu	a2,a4,ffffffffc020357e <insert_vma_struct+0x90>
    }
    if (le_next != list) {
ffffffffc0203524:	00f50a63          	beq	a0,a5,ffffffffc0203538 <insert_vma_struct+0x4a>
            if (mmap_prev->vm_start > vma->vm_start) {
ffffffffc0203528:	fe87b703          	ld	a4,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc020352c:	05076963          	bltu	a4,a6,ffffffffc020357e <insert_vma_struct+0x90>
    assert(next->vm_start < next->vm_end);
ffffffffc0203530:	ff07b603          	ld	a2,-16(a5)
ffffffffc0203534:	02c77363          	bgeu	a4,a2,ffffffffc020355a <insert_vma_struct+0x6c>
    }
    ...
    mm->map_count ++;
ffffffffc0203538:	5118                	lw	a4,32(a0)
    vma->vm_mm = mm;
ffffffffc020353a:	e188                	sd	a0,0(a1)
    list_add_after(le_prev, &(vma->list_link));
ffffffffc020353c:	02058613          	addi	a2,a1,32
    prev->next = next->prev = elm;
ffffffffc0203540:	e390                	sd	a2,0(a5)
ffffffffc0203542:	e690                	sd	a2,8(a3)
}
ffffffffc0203544:	60a2                	ld	ra,8(sp)
    elm->next = next;
ffffffffc0203546:	f59c                	sd	a5,40(a1)
    elm->prev = prev;
ffffffffc0203548:	f194                	sd	a3,32(a1)
    mm->map_count ++;
ffffffffc020354a:	0017079b          	addiw	a5,a4,1
ffffffffc020354e:	d11c                	sw	a5,32(a0)
}
ffffffffc0203550:	0141                	addi	sp,sp,16
ffffffffc0203552:	8082                	ret
    if (le_prev != list) {
ffffffffc0203554:	fca690e3          	bne	a3,a0,ffffffffc0203514 <insert_vma_struct+0x26>
ffffffffc0203558:	bfd1                	j	ffffffffc020352c <insert_vma_struct+0x3e>
ffffffffc020355a:	ebbff0ef          	jal	ra,ffffffffc0203414 <check_vma_overlap.part.0>
    assert(vma->vm_start < vma->vm_end);
ffffffffc020355e:	00002697          	auipc	a3,0x2
ffffffffc0203562:	66268693          	addi	a3,a3,1634 # ffffffffc0205bc0 <default_pmm_manager+0xb10>
ffffffffc0203566:	00001617          	auipc	a2,0x1
ffffffffc020356a:	79a60613          	addi	a2,a2,1946 # ffffffffc0204d00 <commands+0x738>
ffffffffc020356e:	08400593          	li	a1,132
ffffffffc0203572:	00002517          	auipc	a0,0x2
ffffffffc0203576:	63e50513          	addi	a0,a0,1598 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc020357a:	dfbfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020357e:	00002697          	auipc	a3,0x2
ffffffffc0203582:	68268693          	addi	a3,a3,1666 # ffffffffc0205c00 <default_pmm_manager+0xb50>
ffffffffc0203586:	00001617          	auipc	a2,0x1
ffffffffc020358a:	77a60613          	addi	a2,a2,1914 # ffffffffc0204d00 <commands+0x738>
ffffffffc020358e:	07c00593          	li	a1,124
ffffffffc0203592:	00002517          	auipc	a0,0x2
ffffffffc0203596:	61e50513          	addi	a0,a0,1566 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc020359a:	ddbfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc020359e:	00002697          	auipc	a3,0x2
ffffffffc02035a2:	64268693          	addi	a3,a3,1602 # ffffffffc0205be0 <default_pmm_manager+0xb30>
ffffffffc02035a6:	00001617          	auipc	a2,0x1
ffffffffc02035aa:	75a60613          	addi	a2,a2,1882 # ffffffffc0204d00 <commands+0x738>
ffffffffc02035ae:	07b00593          	li	a1,123
ffffffffc02035b2:	00002517          	auipc	a0,0x2
ffffffffc02035b6:	5fe50513          	addi	a0,a0,1534 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc02035ba:	dbbfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02035be <mm_destroy>:

// mm_destroy - free mm and mm internal fields
void
mm_destroy(struct mm_struct *mm) {
ffffffffc02035be:	1141                	addi	sp,sp,-16
ffffffffc02035c0:	e022                	sd	s0,0(sp)
ffffffffc02035c2:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc02035c4:	6508                	ld	a0,8(a0)
ffffffffc02035c6:	e406                	sd	ra,8(sp)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list) {
ffffffffc02035c8:	00a40e63          	beq	s0,a0,ffffffffc02035e4 <mm_destroy+0x26>
    __list_del(listelm->prev, listelm->next);
ffffffffc02035cc:	6118                	ld	a4,0(a0)
ffffffffc02035ce:	651c                	ld	a5,8(a0)
        list_del(le);
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc02035d0:	03000593          	li	a1,48
ffffffffc02035d4:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc02035d6:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc02035d8:	e398                	sd	a4,0(a5)
ffffffffc02035da:	a58ff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc02035de:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc02035e0:	fea416e3          	bne	s0,a0,ffffffffc02035cc <mm_destroy+0xe>
    }
...
ffffffffc02035ee:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc02035f0:	a42ff06f          	j	ffffffffc0202832 <kfree>

ffffffffc02035f4 <vmm_init>:

// vmm_init - initialize virtual memory management
//          - now just call check_vmm to check correctness of vmm
void
vmm_init(void) {
ffffffffc02035f4:	715d                	addi	sp,sp,-80
ffffffffc02035f6:	e486                	sd	ra,72(sp)
ffffffffc02035f8:	f44e                	sd	s3,40(sp)
ffffffffc02035fa:	f052                	sd	s4,32(sp)
ffffffffc02035fc:	e0a2                	sd	s0,64(sp)
ffffffffc02035fe:	fc26                	sd	s1,56(sp)
ffffffffc0203600:	f84a                	sd	s2,48(sp)
ffffffffc0203602:	ec56                	sd	s5,24(sp)
ffffffffc0203604:	e85a                	sd	s6,16(sp)
ffffffffc0203606:	e45e                	sd	s7,8(sp)
}
...
ffffffffc0203608:	88afe0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc020360c:	89aa                	mv	s3,a0
...
check_vma_struct(void) {
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc020360e:	884fe0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203612:	8a2a                	mv	s4,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203614:	03000513          	li	a0,48
ffffffffc0203618:	960ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (mm != NULL) {
ffffffffc020361c:	56050863          	beqz	a0,ffffffffc0203b8c <vmm_init+0x598>
    elm->prev = elm->next = elm;
ffffffffc0203620:	e508                	sd	a0,8(a0)
ffffffffc0203622:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc0203624:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc0203628:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc020362c:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203630:	0000e797          	auipc	a5,0xe
ffffffffc0203634:	f107a783          	lw	a5,-240(a5) # ffffffffc0211540 <swap_init_ok>
ffffffffc0203638:	84aa                	mv	s1,a0
ffffffffc020363a:	e7b9                	bnez	a5,ffffffffc0203688 <vmm_init+0x94>
        else mm->sm_priv = NULL;
ffffffffc020363c:	02053423          	sd	zero,40(a0)
vmm_init(void) {
ffffffffc0203640:	03200413          	li	s0,50
ffffffffc0203644:	a811                	j	ffffffffc0203658 <vmm_init+0x64>
        vma->vm_start = vm_start;
ffffffffc0203646:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
...
ffffffffc020364a:	00053c23          	sd	zero,24(a0)
    ...
    int i;
    for (i = step1; i >= 1; i --) {
ffffffffc020364e:	146d                	addi	s0,s0,-5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc0203650:	8526                	mv	a0,s1
ffffffffc0203652:	e9dff0ef          	jal	ra,ffffffffc02034ee <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc0203656:	cc05                	beqz	s0,ffffffffc020368e <vmm_init+0x9a>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
...
ffffffffc0203662:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc0203666:	f165                	bnez	a0,ffffffffc0203646 <vmm_init+0x52>
        assert(vma != NULL);
ffffffffc0203668:	00002697          	auipc	a3,0x2
ffffffffc020366c:	17868693          	addi	a3,a3,376 # ffffffffc02057e0 <default_pmm_manager+0x730>
ffffffffc0203670:	00001617          	auipc	a2,0x1
ffffffffc0203674:	69060613          	addi	a2,a2,1680 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203678:	0ce00593          	li	a1,206
ffffffffc020367c:	00002517          	auipc	a0,0x2
ffffffffc0203680:	53450513          	addi	a0,a0,1332 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc0203684:	cf1fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203688:	8fdff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc020368c:	bf55                	j	ffffffffc0203640 <vmm_init+0x4c>
ffffffffc020368e:	03700413          	li	s0,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203692:	1f900913          	li	s2,505
ffffffffc0203696:	a819                	j	ffffffffc02036ac <vmm_init+0xb8>
        vma->vm_start = vm_start;
...
ffffffffc020369c:	00053c23          	sd	zero,24(a0)
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc02036a0:	0415                	addi	s0,s0,5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc02036a2:	8526                	mv	a0,s1
ffffffffc02036a4:	e4bff0ef          	jal	ra,ffffffffc02034ee <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc02036a8:	03240a63          	beq	s0,s2,ffffffffc02036dc <vmm_init+0xe8>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02036ac:	03000513          	li	a0,48
ffffffffc02036b0:	8c8ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02036b4:	85aa                	mv	a1,a0
ffffffffc02036b6:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc02036ba:	fd79                	bnez	a0,ffffffffc0203698 <vmm_init+0xa4>
        assert(vma != NULL);
ffffffffc02036bc:	00002697          	auipc	a3,0x2
ffffffffc02036c0:	12468693          	addi	a3,a3,292 # ffffffffc02057e0 <default_pmm_manager+0x730>
ffffffffc02036c4:	00001617          	auipc	a2,0x1
ffffffffc02036c8:	63c60613          	addi	a2,a2,1596 # ffffffffc0204d00 <commands+0x738>
ffffffffc02036cc:	0d400593          	li	a1,212
ffffffffc02036d0:	00002517          	auipc	a0,0x2
ffffffffc02036d4:	4e050513          	addi	a0,a0,1248 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc02036d8:	c9dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    return listelm->next;
ffffffffc02036dc:	649c                	ld	a5,8(s1)
ffffffffc02036de:	471d                	li	a4,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i ++) {
ffffffffc02036e0:	1fb00593          	li	a1,507
        assert(le != &(mm->mmap_list));
ffffffffc02036e4:	2ef48463          	beq	s1,a5,ffffffffc02039cc <vmm_init+0x3d8>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc02036e8:	fe87b603          	ld	a2,-24(a5)
ffffffffc02036ec:	ffe70693          	addi	a3,a4,-2
ffffffffc02036f0:	26d61e63          	bne	a2,a3,ffffffffc020396c <vmm_init+0x378>
ffffffffc02036f4:	ff07b683          	ld	a3,-16(a5)
ffffffffc02036f8:	26e69a63          	bne	a3,a4,ffffffffc020396c <vmm_init+0x378>
    for (i = 1; i <= step2; i ++) {
ffffffffc02036fc:	0715                	addi	a4,a4,5
ffffffffc02036fe:	679c                	ld	a5,8(a5)
ffffffffc0203700:	feb712e3          	bne	a4,a1,ffffffffc02036e4 <vmm_init+0xf0>
ffffffffc0203704:	4b1d                	li	s6,7
ffffffffc0203706:	4415                	li	s0,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203708:	1f900b93          	li	s7,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc020370c:	85a2                	mv	a1,s0
ffffffffc020370e:	8526                	mv	a0,s1
ffffffffc0203710:	d9fff0ef          	jal	ra,ffffffffc02034ae <find_vma>
ffffffffc0203714:	892a                	mv	s2,a0
        assert(vma1 != NULL);
ffffffffc0203716:	2c050b63          	beqz	a0,ffffffffc02039ec <vmm_init+0x3f8>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc020371a:	00140593          	addi	a1,s0,1
ffffffffc020371e:	8526                	mv	a0,s1
ffffffffc0203720:	d8fff0ef          	jal	ra,ffffffffc02034ae <find_vma>
ffffffffc0203724:	8aaa                	mv	s5,a0
        assert(vma2 != NULL);
ffffffffc0203726:	2e050363          	beqz	a0,ffffffffc0203a0c <vmm_init+0x418>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc020372a:	85da                	mv	a1,s6
ffffffffc020372c:	8526                	mv	a0,s1
ffffffffc020372e:	d81ff0ef          	jal	ra,ffffffffc02034ae <find_vma>
        assert(vma3 == NULL);
ffffffffc0203732:	2e051d63          	bnez	a0,ffffffffc0203a2c <vmm_init+0x438>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc0203736:	00340593          	addi	a1,s0,3
ffffffffc020373a:	8526                	mv	a0,s1
ffffffffc020373c:	d73ff0ef          	jal	ra,ffffffffc02034ae <find_vma>
        assert(vma4 == NULL);
ffffffffc0203740:	30051663          	bnez	a0,ffffffffc0203a4c <vmm_init+0x458>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc0203744:	00440593          	addi	a1,s0,4
ffffffffc0203748:	8526                	mv	a0,s1
ffffffffc020374a:	d65ff0ef          	jal	ra,ffffffffc02034ae <find_vma>
        assert(vma5 == NULL);
ffffffffc020374e:	30051f63          	bnez	a0,ffffffffc0203a6c <vmm_init+0x478>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203752:	00893783          	ld	a5,8(s2)
ffffffffc0203756:	24879b63          	bne	a5,s0,ffffffffc02039ac <vmm_init+0x3b8>
ffffffffc020375a:	01093783          	ld	a5,16(s2)
ffffffffc020375e:	25679763          	bne	a5,s6,ffffffffc02039ac <vmm_init+0x3b8>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203762:	008ab783          	ld	a5,8(s5)
ffffffffc0203766:	22879363          	bne	a5,s0,ffffffffc020398c <vmm_init+0x398>
ffffffffc020376a:	010ab783          	ld	a5,16(s5)
ffffffffc020376e:	21679f63          	bne	a5,s6,ffffffffc020398c <vmm_init+0x398>
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203772:	0415                	addi	s0,s0,5
ffffffffc0203774:	0b15                	addi	s6,s6,5
ffffffffc0203776:	f9741be3          	bne	s0,s7,ffffffffc020370c <vmm_init+0x118>
ffffffffc020377a:	4411                	li	s0,4
    }

    for (i =4; i>=0; i--) {
ffffffffc020377c:	597d                	li	s2,-1
        struct vma_struct *vma_below_5= find_vma(mm,i);
ffffffffc020377e:	85a2                	mv	a1,s0
ffffffffc0203780:	8526                	mv	a0,s1
ffffffffc0203782:	d2dff0ef          	jal	ra,ffffffffc02034ae <find_vma>
ffffffffc0203786:	0004059b          	sext.w	a1,s0
        if (vma_below_5 != NULL ) {
ffffffffc020378a:	c90d                	beqz	a0,ffffffffc02037bc <vmm_init+0x1c8>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc020378c:	6914                	ld	a3,16(a0)
ffffffffc020378e:	6510                	ld	a2,8(a0)
ffffffffc0203790:	00002517          	auipc	a0,0x2
ffffffffc0203794:	59050513          	addi	a0,a0,1424 # ffffffffc0205d20 <default_pmm_manager+0xc70>
ffffffffc0203798:	923fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc020379c:	00002697          	auipc	a3,0x2
ffffffffc02037a0:	5ac68693          	addi	a3,a3,1452 # ffffffffc0205d48 <default_pmm_manager+0xc98>
ffffffffc02037a4:	00001617          	auipc	a2,0x1
ffffffffc02037a8:	55c60613          	addi	a2,a2,1372 # ffffffffc0204d00 <commands+0x738>
ffffffffc02037ac:	0f600593          	li	a1,246
ffffffffc02037b0:	00002517          	auipc	a0,0x2
ffffffffc02037b4:	40050513          	addi	a0,a0,1024 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc02037b8:	bbdfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i =4; i>=0; i--) {
ffffffffc02037bc:	147d                	addi	s0,s0,-1
ffffffffc02037be:	fd2410e3          	bne	s0,s2,ffffffffc020377e <vmm_init+0x18a>
ffffffffc02037c2:	a811                	j	ffffffffc02037d6 <vmm_init+0x1e2>
    __list_del(listelm->prev, listelm->next);
ffffffffc02037c4:	6118                	ld	a4,0(a0)
ffffffffc02037c6:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc02037c8:	03000593          	li	a1,48
ffffffffc02037cc:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc02037ce:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc02037d0:	e398                	sd	a4,0(a5)
ffffffffc02037d2:	860ff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc02037d6:	6488                	ld	a0,8(s1)
    while ((le = list_next(list)) != list) {
ffffffffc02037d8:	fea496e3          	bne	s1,a0,ffffffffc02037c4 <vmm_init+0x1d0>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc02037dc:	03000593          	li	a1,48
ffffffffc02037e0:	8526                	mv	a0,s1
ffffffffc02037e2:	850ff0ef          	jal	ra,ffffffffc0202832 <kfree>
    }

    mm_destroy(mm);

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02037e6:	eadfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc02037ea:	3caa1163          	bne	s4,a0,ffffffffc0203bac <vmm_init+0x5b8>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc02037ee:	00002517          	auipc	a0,0x2
ffffffffc02037f2:	59a50513          	addi	a0,a0,1434 # ffffffffc0205d88 <default_pmm_manager+0xcd8>
ffffffffc02037f6:	8c5fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
...
check_pgfault(void) {
    ...
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc02037fa:	e99fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc02037fe:	84aa                	mv	s1,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203800:	03000513          	li	a0,48
ffffffffc0203804:	f75fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203808:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc020380a:	2a050163          	beqz	a0,ffffffffc0203aac <vmm_init+0x4b8>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020380e:	0000e797          	auipc	a5,0xe
ffffffffc0203812:	d327a783          	lw	a5,-718(a5) # ffffffffc0211540 <swap_init_ok>
    elm->prev = elm->next = elm;
ffffffffc0203816:	e508                	sd	a0,8(a0)
ffffffffc0203818:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc020381a:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc020381e:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc0203822:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203826:	14079063          	bnez	a5,ffffffffc0203966 <vmm_init+0x372>
        else mm->sm_priv = NULL;
ffffffffc020382a:	02053423          	sd	zero,40(a0)
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc020382e:	0000e917          	auipc	s2,0xe
ffffffffc0203832:	cda93903          	ld	s2,-806(s2) # ffffffffc0211508 <boot_pgdir>
    assert(pgdir[0] == 0);
ffffffffc0203836:	00093783          	ld	a5,0(s2)
    check_mm_struct = mm_create();
ffffffffc020383a:	0000e717          	auipc	a4,0xe
ffffffffc020383e:	d0873b23          	sd	s0,-746(a4) # ffffffffc0211550 <check_mm_struct>
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0203842:	01243c23          	sd	s2,24(s0)
    assert(pgdir[0] == 0);
ffffffffc0203846:	24079363          	bnez	a5,ffffffffc0203a8c <vmm_init+0x498>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020384a:	03000513          	li	a0,48
ffffffffc020384e:	f2bfe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203852:	8a2a                	mv	s4,a0
    if (vma != NULL) {
ffffffffc0203854:	28050063          	beqz	a0,ffffffffc0203ad4 <vmm_init+0x4e0>
        vma->vm_end = vm_end;
ffffffffc0203858:	002007b7          	lui	a5,0x200
ffffffffc020385c:	00fa3823          	sd	a5,16(s4)
        vma->vm_flags = vm_flags;
ffffffffc0203860:	4789                	li	a5,2
    ...
    insert_vma_struct(mm, vma);
ffffffffc0203862:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc0203864:	00fa3c23          	sd	a5,24(s4)
    insert_vma_struct(mm, vma);
ffffffffc0203868:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc020386a:	000a3423          	sd	zero,8(s4)
    insert_vma_struct(mm, vma);
ffffffffc020386e:	c81ff0ef          	jal	ra,ffffffffc02034ee <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc0203872:	10000593          	li	a1,256
ffffffffc0203876:	8522                	mv	a0,s0
ffffffffc0203878:	c37ff0ef          	jal	ra,ffffffffc02034ae <find_vma>
ffffffffc020387c:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc0203880:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc0203884:	26aa1863          	bne	s4,a0,ffffffffc0203af4 <vmm_init+0x500>
        *(char *)(addr + i) = i;
ffffffffc0203888:	00f78023          	sb	a5,0(a5) # 200000 <kern_entry-0xffffffffc0000000>
    for (i = 0; i < 100; i ++) {
ffffffffc020388c:	0785                	addi	a5,a5,1
ffffffffc020388e:	fee79de3          	bne	a5,a4,ffffffffc0203888 <vmm_init+0x294>
        sum += i;
ffffffffc0203892:	6705                	lui	a4,0x1
ffffffffc0203894:	10000793          	li	a5,256
ffffffffc0203898:	35670713          	addi	a4,a4,854 # 1356 <kern_entry-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc020389c:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc02038a0:	0007c683          	lbu	a3,0(a5)
    for (i = 0; i < 100; i ++) {
ffffffffc02038a4:	0785                	addi	a5,a5,1
        sum -= *(char *)(addr + i);
ffffffffc02038a6:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc02038a8:	fec79ce3          	bne	a5,a2,ffffffffc02038a0 <vmm_init+0x2ac>
    }
    assert(sum == 0);
ffffffffc02038ac:	26071463          	bnez	a4,ffffffffc0203b14 <vmm_init+0x520>

    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc02038b0:	4581                	li	a1,0
ffffffffc02038b2:	854a                	mv	a0,s2
ffffffffc02038b4:	868fe0ef          	jal	ra,ffffffffc020191c <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc02038b8:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc02038bc:	0000e717          	auipc	a4,0xe
ffffffffc02038c0:	c5473703          	ld	a4,-940(a4) # ffffffffc0211510 <npage>
    return pa2page(PDE_ADDR(pde));
ffffffffc02038c4:	078a                	slli	a5,a5,0x2
ffffffffc02038c6:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc02038c8:	26e7f663          	bgeu	a5,a4,ffffffffc0203b34 <vmm_init+0x540>
    return &pages[PPN(pa) - nbase];
ffffffffc02038cc:	00003717          	auipc	a4,0x3
ffffffffc02038d0:	8a473703          	ld	a4,-1884(a4) # ffffffffc0206170 <nbase>
ffffffffc02038d4:	8f99                	sub	a5,a5,a4
ffffffffc02038d6:	00379713          	slli	a4,a5,0x3
ffffffffc02038da:	97ba                	add	a5,a5,a4
ffffffffc02038dc:	078e                	slli	a5,a5,0x3

    free_page(pde2page(pgdir[0]));
ffffffffc02038de:	0000e517          	auipc	a0,0xe
ffffffffc02038e2:	c3a53503          	ld	a0,-966(a0) # ffffffffc0211518 <pages>
ffffffffc02038e6:	953e                	add	a0,a0,a5
ffffffffc02038e8:	4585                	li	a1,1
ffffffffc02038ea:	d69fd0ef          	jal	ra,ffffffffc0201652 <free_pages>
    return listelm->next;
ffffffffc02038ee:	6408                	ld	a0,8(s0)

    pgdir[0] = 0;
ffffffffc02038f0:	00093023          	sd	zero,0(s2)

    mm->pgdir = NULL;
ffffffffc02038f4:	00043c23          	sd	zero,24(s0)
    while ((le = list_next(list)) != list) {
ffffffffc02038f8:	00a40e63          	beq	s0,a0,ffffffffc0203914 <vmm_init+0x320>
    __list_del(listelm->prev, listelm->next);
ffffffffc02038fc:	6118                	ld	a4,0(a0)
ffffffffc02038fe:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203900:	03000593          	li	a1,48
ffffffffc0203904:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203906:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203908:	e398                	sd	a4,0(a5)
ffffffffc020390a:	f29fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc020390e:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203910:	fea416e3          	bne	s0,a0,ffffffffc02038fc <vmm_init+0x308>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203914:	03000593          	li	a1,48
ffffffffc0203918:	8522                	mv	a0,s0
ffffffffc020391a:	f19fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    mm_destroy(mm);

    check_mm_struct = NULL;
    nr_free_pages_store--;	// szx : Sv39第二级页表多占了一个内存页，所以执行此操作
ffffffffc020391e:	14fd                	addi	s1,s1,-1
    check_mm_struct = NULL;
ffffffffc0203920:	0000e797          	auipc	a5,0xe
ffffffffc0203924:	c207b823          	sd	zero,-976(a5) # ffffffffc0211550 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203928:	d6bfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc020392c:	22a49063          	bne	s1,a0,ffffffffc0203b4c <vmm_init+0x558>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc0203930:	00002517          	auipc	a0,0x2
ffffffffc0203934:	4a850513          	addi	a0,a0,1192 # ffffffffc0205dd8 <default_pmm_manager+0xd28>
ffffffffc0203938:	f82fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc020393c:	d57fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
    nr_free_pages_store--;	// szx : Sv39三级页表多占一个内存页，所以执行此操作
ffffffffc0203940:	19fd                	addi	s3,s3,-1
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203942:	22a99563          	bne	s3,a0,ffffffffc0203b6c <vmm_init+0x578>
}
ffffffffc0203946:	6406                	ld	s0,64(sp)
ffffffffc0203948:	60a6                	ld	ra,72(sp)
ffffffffc020394a:	74e2                	ld	s1,56(sp)
ffffffffc020394c:	7942                	ld	s2,48(sp)
ffffffffc020394e:	79a2                	ld	s3,40(sp)
ffffffffc0203950:	7a02                	ld	s4,32(sp)
ffffffffc0203952:	6ae2                	ld	s5,24(sp)
ffffffffc0203954:	6b42                	ld	s6,16(sp)
ffffffffc0203956:	6ba2                	ld	s7,8(sp)
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203958:	00002517          	auipc	a0,0x2
ffffffffc020395c:	4a050513          	addi	a0,a0,1184 # ffffffffc0205df8 <default_pmm_manager+0xd48>
}
ffffffffc0203960:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203962:	f58fc06f          	j	ffffffffc02000ba <cprintf>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203966:	e1eff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc020396a:	b5d1                	j	ffffffffc020382e <vmm_init+0x23a>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc020396c:	00002697          	auipc	a3,0x2
ffffffffc0203970:	2cc68693          	addi	a3,a3,716 # ffffffffc0205c38 <default_pmm_manager+0xb88>
ffffffffc0203974:	00001617          	auipc	a2,0x1
ffffffffc0203978:	38c60613          	addi	a2,a2,908 # ffffffffc0204d00 <commands+0x738>
ffffffffc020397c:	0dd00593          	li	a1,221
ffffffffc0203980:	00002517          	auipc	a0,0x2
ffffffffc0203984:	23050513          	addi	a0,a0,560 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc0203988:	9edfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc020398c:	00002697          	auipc	a3,0x2
ffffffffc0203990:	36468693          	addi	a3,a3,868 # ffffffffc0205cf0 <default_pmm_manager+0xc40>
ffffffffc0203994:	00001617          	auipc	a2,0x1
ffffffffc0203998:	36c60613          	addi	a2,a2,876 # ffffffffc0204d00 <commands+0x738>
ffffffffc020399c:	0ee00593          	li	a1,238
ffffffffc02039a0:	00002517          	auipc	a0,0x2
ffffffffc02039a4:	21050513          	addi	a0,a0,528 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc02039a8:	9cdfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02039ac:	00002697          	auipc	a3,0x2
ffffffffc02039b0:	31468693          	addi	a3,a3,788 # ffffffffc0205cc0 <default_pmm_manager+0xc10>
ffffffffc02039b4:	00001617          	auipc	a2,0x1
ffffffffc02039b8:	34c60613          	addi	a2,a2,844 # ffffffffc0204d00 <commands+0x738>
ffffffffc02039bc:	0ed00593          	li	a1,237
ffffffffc02039c0:	00002517          	auipc	a0,0x2
ffffffffc02039c4:	1f050513          	addi	a0,a0,496 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc02039c8:	9adfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc02039cc:	00002697          	auipc	a3,0x2
ffffffffc02039d0:	25468693          	addi	a3,a3,596 # ffffffffc0205c20 <default_pmm_manager+0xb70>
ffffffffc02039d4:	00001617          	auipc	a2,0x1
ffffffffc02039d8:	32c60613          	addi	a2,a2,812 # ffffffffc0204d00 <commands+0x738>
ffffffffc02039dc:	0db00593          	li	a1,219
ffffffffc02039e0:	00002517          	auipc	a0,0x2
ffffffffc02039e4:	1d050513          	addi	a0,a0,464 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc02039e8:	98dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc02039ec:	00002697          	auipc	a3,0x2
ffffffffc02039f0:	28468693          	addi	a3,a3,644 # ffffffffc0205c70 <default_pmm_manager+0xbc0>
ffffffffc02039f4:	00001617          	auipc	a2,0x1
ffffffffc02039f8:	30c60613          	addi	a2,a2,780 # ffffffffc0204d00 <commands+0x738>
ffffffffc02039fc:	0e300593          	li	a1,227
ffffffffc0203a00:	00002517          	auipc	a0,0x2
ffffffffc0203a04:	1b050513          	addi	a0,a0,432 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc0203a08:	96dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203a0c:	00002697          	auipc	a3,0x2
ffffffffc0203a10:	27468693          	addi	a3,a3,628 # ffffffffc0205c80 <default_pmm_manager+0xbd0>
ffffffffc0203a14:	00001617          	auipc	a2,0x1
ffffffffc0203a18:	2ec60613          	addi	a2,a2,748 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203a1c:	0e500593          	li	a1,229
ffffffffc0203a20:	00002517          	auipc	a0,0x2
ffffffffc0203a24:	19050513          	addi	a0,a0,400 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc0203a28:	94dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203a2c:	00002697          	auipc	a3,0x2
ffffffffc0203a30:	26468693          	addi	a3,a3,612 # ffffffffc0205c90 <default_pmm_manager+0xbe0>
ffffffffc0203a34:	00001617          	auipc	a2,0x1
ffffffffc0203a38:	2cc60613          	addi	a2,a2,716 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203a3c:	0e700593          	li	a1,231
ffffffffc0203a40:	00002517          	auipc	a0,0x2
ffffffffc0203a44:	17050513          	addi	a0,a0,368 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc0203a48:	92dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203a4c:	00002697          	auipc	a3,0x2
ffffffffc0203a50:	25468693          	addi	a3,a3,596 # ffffffffc0205ca0 <default_pmm_manager+0xbf0>
ffffffffc0203a54:	00001617          	auipc	a2,0x1
ffffffffc0203a58:	2ac60613          	addi	a2,a2,684 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203a5c:	0e900593          	li	a1,233
ffffffffc0203a60:	00002517          	auipc	a0,0x2
ffffffffc0203a64:	15050513          	addi	a0,a0,336 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc0203a68:	90dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc0203a6c:	00002697          	auipc	a3,0x2
ffffffffc0203a70:	24468693          	addi	a3,a3,580 # ffffffffc0205cb0 <default_pmm_manager+0xc00>
ffffffffc0203a74:	00001617          	auipc	a2,0x1
ffffffffc0203a78:	28c60613          	addi	a2,a2,652 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203a7c:	0eb00593          	li	a1,235
ffffffffc0203a80:	00002517          	auipc	a0,0x2
ffffffffc0203a84:	13050513          	addi	a0,a0,304 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc0203a88:	8edfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203a8c:	00002697          	auipc	a3,0x2
ffffffffc0203a90:	d4468693          	addi	a3,a3,-700 # ffffffffc02057d0 <default_pmm_manager+0x720>
ffffffffc0203a94:	00001617          	auipc	a2,0x1
ffffffffc0203a98:	26c60613          	addi	a2,a2,620 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203a9c:	10d00593          	li	a1,269
ffffffffc0203aa0:	00002517          	auipc	a0,0x2
ffffffffc0203aa4:	11050513          	addi	a0,a0,272 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc0203aa8:	8cdfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203aac:	00002697          	auipc	a3,0x2
ffffffffc0203ab0:	36468693          	addi	a3,a3,868 # ffffffffc0205e10 <default_pmm_manager+0xd60>
ffffffffc0203ab4:	00001617          	auipc	a2,0x1
ffffffffc0203ab8:	24c60613          	addi	a2,a2,588 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203abc:	10a00593          	li	a1,266
ffffffffc0203ac0:	00002517          	auipc	a0,0x2
ffffffffc0203ac4:	0f050513          	addi	a0,a0,240 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
    check_mm_struct = mm_create();
ffffffffc0203ac8:	0000e797          	auipc	a5,0xe
ffffffffc0203acc:	a807b423          	sd	zero,-1400(a5) # ffffffffc0211550 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203ad0:	8a5fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc0203ad4:	00002697          	auipc	a3,0x2
ffffffffc0203ad8:	d0c68693          	addi	a3,a3,-756 # ffffffffc02057e0 <default_pmm_manager+0x730>
ffffffffc0203adc:	00001617          	auipc	a2,0x1
ffffffffc0203ae0:	22460613          	addi	a2,a2,548 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203ae4:	11100593          	li	a1,273
ffffffffc0203ae8:	00002517          	auipc	a0,0x2
ffffffffc0203aec:	0c850513          	addi	a0,a0,200 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc0203af0:	885fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203af4:	00002697          	auipc	a3,0x2
ffffffffc0203af8:	2b468693          	addi	a3,a3,692 # ffffffffc0205da8 <default_pmm_manager+0xcf8>
ffffffffc0203afc:	00001617          	auipc	a2,0x1
ffffffffc0203b00:	20460613          	addi	a2,a2,516 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203b04:	11600593          	li	a1,278
ffffffffc0203b08:	00002517          	auipc	a0,0x2
ffffffffc0203b0c:	0a850513          	addi	a0,a0,168 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc0203b10:	865fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203b14:	00002697          	auipc	a3,0x2
ffffffffc0203b18:	2b468693          	addi	a3,a3,692 # ffffffffc0205dc8 <default_pmm_manager+0xd18>
ffffffffc0203b1c:	00001617          	auipc	a2,0x1
ffffffffc0203b20:	1e460613          	addi	a2,a2,484 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203b24:	12000593          	li	a1,288
ffffffffc0203b28:	00002517          	auipc	a0,0x2
ffffffffc0203b2c:	08850513          	addi	a0,a0,136 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc0203b30:	845fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203b34:	00001617          	auipc	a2,0x1
ffffffffc0203b38:	5b460613          	addi	a2,a2,1460 # ffffffffc02050e8 <default_pmm_manager+0x38>
ffffffffc0203b3c:	06500593          	li	a1,101
ffffffffc0203b40:	00001517          	auipc	a0,0x1
ffffffffc0203b44:	5c850513          	addi	a0,a0,1480 # ffffffffc0205108 <default_pmm_manager+0x58>
ffffffffc0203b48:	82dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203b4c:	00002697          	auipc	a3,0x2
ffffffffc0203b50:	21468693          	addi	a3,a3,532 # ffffffffc0205d60 <default_pmm_manager+0xcb0>
ffffffffc0203b54:	00001617          	auipc	a2,0x1
ffffffffc0203b58:	1ac60613          	addi	a2,a2,428 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203b5c:	12e00593          	li	a1,302
ffffffffc0203b60:	00002517          	auipc	a0,0x2
ffffffffc0203b64:	05050513          	addi	a0,a0,80 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc0203b68:	80dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203b6c:	00002697          	auipc	a3,0x2
ffffffffc0203b70:	1f468693          	addi	a3,a3,500 # ffffffffc0205d60 <default_pmm_manager+0xcb0>
ffffffffc0203b74:	00001617          	auipc	a2,0x1
ffffffffc0203b78:	18c60613          	addi	a2,a2,396 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203b7c:	0bd00593          	li	a1,189
ffffffffc0203b80:	00002517          	auipc	a0,0x2
ffffffffc0203b84:	03050513          	addi	a0,a0,48 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc0203b88:	fecfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc0203b8c:	00002697          	auipc	a3,0x2
ffffffffc0203b90:	c1c68693          	addi	a3,a3,-996 # ffffffffc02057a8 <default_pmm_manager+0x6f8>
ffffffffc0203b94:	00001617          	auipc	a2,0x1
ffffffffc0203b98:	16c60613          	addi	a2,a2,364 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203b9c:	0c700593          	li	a1,199
ffffffffc0203ba0:	00002517          	auipc	a0,0x2
ffffffffc0203ba4:	01050513          	addi	a0,a0,16 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc0203ba8:	fccfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203bac:	00002697          	auipc	a3,0x2
ffffffffc0203bb0:	1b468693          	addi	a3,a3,436 # ffffffffc0205d60 <default_pmm_manager+0xcb0>
ffffffffc0203bb4:	00001617          	auipc	a2,0x1
ffffffffc0203bb8:	14c60613          	addi	a2,a2,332 # ffffffffc0204d00 <commands+0x738>
ffffffffc0203bbc:	0fb00593          	li	a1,251
ffffffffc0203bc0:	00002517          	auipc	a0,0x2
ffffffffc0203bc4:	ff050513          	addi	a0,a0,-16 # ffffffffc0205bb0 <default_pmm_manager+0xb00>
ffffffffc0203bc8:	facfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203bcc <do_pgfault>:
...
ffffffffc0203bcc:	7139                	addi	sp,sp,-64
    int ret = -E_INVAL;
    //try to find a vma which include addr
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203bce:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203bd0:	f822                	sd	s0,48(sp)
ffffffffc0203bd2:	f426                	sd	s1,40(sp)
ffffffffc0203bd4:	fc06                	sd	ra,56(sp)
ffffffffc0203bd6:	f04a                	sd	s2,32(sp)
ffffffffc0203bd8:	ec4e                	sd	s3,24(sp)
ffffffffc0203bda:	8432                	mv	s0,a2
ffffffffc0203bdc:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203bde:	8d1ff0ef          	jal	ra,ffffffffc02034ae <find_vma>

    pgfault_num++;
ffffffffc0203be2:	0000e797          	auipc	a5,0xe
ffffffffc0203be6:	9767a783          	lw	a5,-1674(a5) # ffffffffc0211558 <pgfault_num>
ffffffffc0203bea:	2785                	addiw	a5,a5,1
ffffffffc0203bec:	0000e717          	auipc	a4,0xe
ffffffffc0203bf0:	96f72623          	sw	a5,-1684(a4) # ffffffffc0211558 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0203bf4:	c15d                	beqz	a0,ffffffffc0203c9a <do_pgfault+0xce>
ffffffffc0203bf6:	651c                	ld	a5,8(a0)
ffffffffc0203bf8:	0af46163          	bltu	s0,a5,ffffffffc0203c9a <do_pgfault+0xce>
     */
...
ffffffffc0203bfc:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203bfe:	49c1                	li	s3,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203c00:	8b89                	andi	a5,a5,2
ffffffffc0203c02:	efa9                	bnez	a5,ffffffffc0203c5c <do_pgfault+0x90>
        perm |= (PTE_R | PTE_W);
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203c04:	75fd                	lui	a1,0xfffff
...
ffffffffc0203c06:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203c08:	8c6d                	and	s0,s0,a1
    ptep = get_pte(mm->pgdir, addr, 1);  //(1) try to find a pte, if pte's
ffffffffc0203c0a:	85a2                	mv	a1,s0
ffffffffc0203c0c:	4605                	li	a2,1
ffffffffc0203c0e:	abffd0ef          	jal	ra,ffffffffc02016cc <get_pte>
                                         //PT(Page Table) isn't existed, then
                                         //create a PT.
    if (*ptep == 0) {
ffffffffc0203c12:	610c                	ld	a1,0(a0)
ffffffffc0203c14:	c5a5                	beqz	a1,ffffffffc0203c7c <do_pgfault+0xb0>
...
ffffffffc0203c1a:	92a7a783          	lw	a5,-1750(a5) # ffffffffc0211540 <swap_init_ok>
ffffffffc0203c1e:	c7d9                	beqz	a5,ffffffffc0203cac <do_pgfault+0xe0>
...
ffffffffc0203c20:	0030                	addi	a2,sp,8
ffffffffc0203c22:	85a2                	mv	a1,s0
ffffffffc0203c24:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0203c26:	e402                	sd	zero,8(sp)
            if ((ret = swap_in(mm, addr, &page)) != 0) {
ffffffffc0203c28:	c88ff0ef          	jal	ra,ffffffffc02030b0 <swap_in>
ffffffffc0203c2c:	892a                	mv	s2,a0
ffffffffc0203c2e:	e90d                	bnez	a0,ffffffffc0203c60 <do_pgfault+0x94>
...
ffffffffc0203c32:	6c88                	ld	a0,24(s1)
ffffffffc0203c34:	86ce                	mv	a3,s3
ffffffffc0203c36:	8622                	mv	a2,s0
ffffffffc0203c38:	d7ffd0ef          	jal	ra,ffffffffc02019b6 <page_insert>
            swap_map_swappable(mm, addr, page, 1);//将此页面设置为可交换的 ,也添加到算法所维护的次序队列
ffffffffc0203c3c:	6622                	ld	a2,8(sp)
ffffffffc0203c3e:	4685                	li	a3,1
ffffffffc0203c40:	85a2                	mv	a1,s0
ffffffffc0203c42:	8526                	mv	a0,s1
ffffffffc0203c44:	b4cff0ef          	jal	ra,ffffffffc0202f90 <swap_map_swappable>
	        page->pra_vaddr = addr;		//设置页对应的虚拟地址
ffffffffc0203c48:	67a2                	ld	a5,8(sp)
ffffffffc0203c4a:	e3a0                	sd	s0,64(a5)
   }
...
ffffffffc0203c4c:	70e2                	ld	ra,56(sp)
ffffffffc0203c4e:	7442                	ld	s0,48(sp)
ffffffffc0203c50:	74a2                	ld	s1,40(sp)
ffffffffc0203c52:	69e2                	ld	s3,24(sp)
ffffffffc0203c54:	854a                	mv	a0,s2
ffffffffc0203c56:	7902                	ld	s2,32(sp)
ffffffffc0203c58:	6121                	addi	sp,sp,64
ffffffffc0203c5a:	8082                	ret
        perm |= (PTE_R | PTE_W);
ffffffffc0203c5c:	49d9                	li	s3,22
ffffffffc0203c5e:	b75d                	j	ffffffffc0203c04 <do_pgfault+0x38>
                cprintf("swap_in in do_pgfault failed\n");
ffffffffc0203c60:	00002517          	auipc	a0,0x2
ffffffffc0203c64:	22050513          	addi	a0,a0,544 # ffffffffc0205e80 <default_pmm_manager+0xdd0>
ffffffffc0203c68:	c52fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
}
ffffffffc0203c6c:	70e2                	ld	ra,56(sp)
ffffffffc0203c6e:	7442                	ld	s0,48(sp)
ffffffffc0203c70:	74a2                	ld	s1,40(sp)
ffffffffc0203c72:	69e2                	ld	s3,24(sp)
ffffffffc0203c74:	854a                	mv	a0,s2
ffffffffc0203c76:	7902                	ld	s2,32(sp)
ffffffffc0203c78:	6121                	addi	sp,sp,64
ffffffffc0203c7a:	8082                	ret
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203c7c:	6c88                	ld	a0,24(s1)
ffffffffc0203c7e:	864e                	mv	a2,s3
ffffffffc0203c80:	85a2                	mv	a1,s0
ffffffffc0203c82:	a3ffe0ef          	jal	ra,ffffffffc02026c0 <pgdir_alloc_page>
   ret = 0;
ffffffffc0203c86:	4901                	li	s2,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203c88:	f171                	bnez	a0,ffffffffc0203c4c <do_pgfault+0x80>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203c8a:	00002517          	auipc	a0,0x2
ffffffffc0203c8e:	1ce50513          	addi	a0,a0,462 # ffffffffc0205e58 <default_pmm_manager+0xda8>
ffffffffc0203c92:	c28fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203c96:	5971                	li	s2,-4
            goto failed;
ffffffffc0203c98:	bf55                	j	ffffffffc0203c4c <do_pgfault+0x80>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203c9a:	85a2                	mv	a1,s0
ffffffffc0203c9c:	00002517          	auipc	a0,0x2
ffffffffc0203ca0:	18c50513          	addi	a0,a0,396 # ffffffffc0205e28 <default_pmm_manager+0xd78>
ffffffffc0203ca4:	c16fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    int ret = -E_INVAL;
ffffffffc0203ca8:	5975                	li	s2,-3
        goto failed;
ffffffffc0203caa:	b74d                	j	ffffffffc0203c4c <do_pgfault+0x80>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203cac:	00002517          	auipc	a0,0x2
ffffffffc0203cb0:	1f450513          	addi	a0,a0,500 # ffffffffc0205ea0 <default_pmm_manager+0xdf0>
ffffffffc0203cb4:	c06fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203cb8:	5971                	li	s2,-4
            goto failed;
ffffffffc0203cba:	bf49                	j	ffffffffc0203c4c <do_pgfault+0x80>
...
ffffffffc0203d02:	83273703          	ld	a4,-1998(a4) # ffffffffc0211530 <max_swap_offset>
ffffffffc0203d06:	04e7fb63          	bgeu	a5,a4,ffffffffc0203d5c <swapfs_read+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203d0a:	0000e617          	auipc	a2,0xe
ffffffffc0203d0e:	80e63603          	ld	a2,-2034(a2) # ffffffffc0211518 <pages>
...
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203d30:	0000d717          	auipc	a4,0xd
ffffffffc0203d34:	7e073703          	ld	a4,2016(a4) # ffffffffc0211510 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0203d4c:	7e07b783          	ld	a5,2016(a5) # ffffffffc0211528 <va_pa_offset>
...
ffffffffc0203d56:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203d58:	f48fc06f          	j	ffffffffc02004a0 <ide_read_secs>
ffffffffc0203d5c:	86aa                	mv	a3,a0
ffffffffc0203d5e:	00002617          	auipc	a2,0x2
ffffffffc0203d62:	1a260613          	addi	a2,a2,418 # ffffffffc0205f00 <default_pmm_manager+0xe50>
ffffffffc0203d66:	45d1                	li	a1,20
ffffffffc0203d68:	00002517          	auipc	a0,0x2
ffffffffc0203d6c:	18050513          	addi	a0,a0,384 # ffffffffc0205ee8 <default_pmm_manager+0xe38>
...
ffffffffc0203d7e:	3c660613          	addi	a2,a2,966 # ffffffffc0205140 <default_pmm_manager+0x90>
ffffffffc0203d82:	00001517          	auipc	a0,0x1
ffffffffc0203d86:	38650513          	addi	a0,a0,902 # ffffffffc0205108 <default_pmm_manager+0x58>
...
ffffffffc0203d9c:	79873703          	ld	a4,1944(a4) # ffffffffc0211530 <max_swap_offset>
ffffffffc0203da0:	04e7fb63          	bgeu	a5,a4,ffffffffc0203df6 <swapfs_write+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203da4:	0000d617          	auipc	a2,0xd
ffffffffc0203da8:	77463603          	ld	a2,1908(a2) # ffffffffc0211518 <pages>
...
ffffffffc0203dce:	74673703          	ld	a4,1862(a4) # ffffffffc0211510 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0203de6:	7467b783          	ld	a5,1862(a5) # ffffffffc0211528 <va_pa_offset>
...
ffffffffc0203df0:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203df2:	ed2fc06f          	j	ffffffffc02004c4 <ide_write_secs>
ffffffffc0203df6:	86aa                	mv	a3,a0
ffffffffc0203df8:	00002617          	auipc	a2,0x2
ffffffffc0203dfc:	10860613          	addi	a2,a2,264 # ffffffffc0205f00 <default_pmm_manager+0xe50>
ffffffffc0203e00:	45e5                	li	a1,25
ffffffffc0203e02:	00002517          	auipc	a0,0x2
ffffffffc0203e06:	0e650513          	addi	a0,a0,230 # ffffffffc0205ee8 <default_pmm_manager+0xe38>
...
ffffffffc0203e18:	32c60613          	addi	a2,a2,812 # ffffffffc0205140 <default_pmm_manager+0x90>
ffffffffc0203e1c:	00001517          	auipc	a0,0x1
ffffffffc0203e20:	2ec50513          	addi	a0,a0,748 # ffffffffc0205108 <default_pmm_manager+0x58>
ffffffffc0203e24:	d50fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203e28 <printnum>:
 * */
static void
...
ffffffffc0203e28:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203e2c:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203e2e:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203e32:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203e34:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203e38:	f022                	sd	s0,32(sp)
ffffffffc0203e3a:	ec26                	sd	s1,24(sp)
ffffffffc0203e3c:	e84a                	sd	s2,16(sp)
ffffffffc0203e3e:	f406                	sd	ra,40(sp)
ffffffffc0203e40:	e44e                	sd	s3,8(sp)
ffffffffc0203e42:	84aa                	mv	s1,a0
ffffffffc0203e44:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0203e46:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203e4a:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0203e4c:	03067e63          	bgeu	a2,a6,ffffffffc0203e88 <printnum+0x60>
ffffffffc0203e50:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0203e52:	00805763          	blez	s0,ffffffffc0203e60 <printnum+0x38>
ffffffffc0203e56:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203e58:	85ca                	mv	a1,s2
ffffffffc0203e5a:	854e                	mv	a0,s3
ffffffffc0203e5c:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203e5e:	fc65                	bnez	s0,ffffffffc0203e56 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203e60:	1a02                	slli	s4,s4,0x20
ffffffffc0203e62:	00002797          	auipc	a5,0x2
ffffffffc0203e66:	0be78793          	addi	a5,a5,190 # ffffffffc0205f20 <default_pmm_manager+0xe70>
ffffffffc0203e6a:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203e6e:	9a3e                	add	s4,s4,a5
}
ffffffffc0203e70:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203e72:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203e76:	70a2                	ld	ra,40(sp)
ffffffffc0203e78:	69a2                	ld	s3,8(sp)
ffffffffc0203e7a:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203e7c:	85ca                	mv	a1,s2
ffffffffc0203e7e:	87a6                	mv	a5,s1
}
ffffffffc0203e80:	6942                	ld	s2,16(sp)
ffffffffc0203e82:	64e2                	ld	s1,24(sp)
ffffffffc0203e84:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203e86:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203e88:	03065633          	divu	a2,a2,a6
ffffffffc0203e8c:	8722                	mv	a4,s0
ffffffffc0203e8e:	f9bff0ef          	jal	ra,ffffffffc0203e28 <printnum>
ffffffffc0203e92:	b7f9                	j	ffffffffc0203e60 <printnum+0x38>

ffffffffc0203e94 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203e94:	7119                	addi	sp,sp,-128
ffffffffc0203e96:	f4a6                	sd	s1,104(sp)
ffffffffc0203e98:	f0ca                	sd	s2,96(sp)
ffffffffc0203e9a:	ecce                	sd	s3,88(sp)
ffffffffc0203e9c:	e8d2                	sd	s4,80(sp)
ffffffffc0203e9e:	e4d6                	sd	s5,72(sp)
ffffffffc0203ea0:	e0da                	sd	s6,64(sp)
ffffffffc0203ea2:	fc5e                	sd	s7,56(sp)
ffffffffc0203ea4:	f06a                	sd	s10,32(sp)
ffffffffc0203ea6:	fc86                	sd	ra,120(sp)
ffffffffc0203ea8:	f8a2                	sd	s0,112(sp)
ffffffffc0203eaa:	f862                	sd	s8,48(sp)
ffffffffc0203eac:	f466                	sd	s9,40(sp)
ffffffffc0203eae:	ec6e                	sd	s11,24(sp)
ffffffffc0203eb0:	892a                	mv	s2,a0
ffffffffc0203eb2:	84ae                	mv	s1,a1
ffffffffc0203eb4:	8d32                	mv	s10,a2
ffffffffc0203eb6:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0203eb8:	02500993          	li	s3,37
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203ebc:	5b7d                	li	s6,-1
ffffffffc0203ebe:	00002a97          	auipc	s5,0x2
ffffffffc0203ec2:	096a8a93          	addi	s5,s5,150 # ffffffffc0205f54 <default_pmm_manager+0xea4>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203ec6:	00002b97          	auipc	s7,0x2
ffffffffc0203eca:	26ab8b93          	addi	s7,s7,618 # ffffffffc0206130 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203ece:	000d4503          	lbu	a0,0(s10) # 80000 <kern_entry-0xffffffffc0180000>
ffffffffc0203ed2:	001d0413          	addi	s0,s10,1
ffffffffc0203ed6:	01350a63          	beq	a0,s3,ffffffffc0203eea <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0203eda:	c121                	beqz	a0,ffffffffc0203f1a <vprintfmt+0x86>
            putch(ch, putdat);
...
ffffffffc0203ee6:	ff351ae3          	bne	a0,s3,ffffffffc0203eda <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203eea:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203eee:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203ef2:	4c81                	li	s9,0
ffffffffc0203ef4:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0203ef6:	5c7d                	li	s8,-1
ffffffffc0203ef8:	5dfd                	li	s11,-1
ffffffffc0203efa:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0203efe:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f00:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203f04:	0ff5f593          	andi	a1,a1,255
ffffffffc0203f08:	00140d13          	addi	s10,s0,1
ffffffffc0203f0c:	04b56263          	bltu	a0,a1,ffffffffc0203f50 <vprintfmt+0xbc>
ffffffffc0203f10:	058a                	slli	a1,a1,0x2
ffffffffc0203f12:	95d6                	add	a1,a1,s5
ffffffffc0203f14:	4194                	lw	a3,0(a1)
ffffffffc0203f16:	96d6                	add	a3,a3,s5
...
ffffffffc0203f36:	8082                	ret
            padc = '0';
ffffffffc0203f38:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0203f3a:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f3e:	846a                	mv	s0,s10
ffffffffc0203f40:	00140d13          	addi	s10,s0,1
ffffffffc0203f44:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203f48:	0ff5f593          	andi	a1,a1,255
ffffffffc0203f4c:	fcb572e3          	bgeu	a0,a1,ffffffffc0203f10 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0203f50:	85a6                	mv	a1,s1
ffffffffc0203f52:	02500513          	li	a0,37
ffffffffc0203f56:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0203f58:	fff44783          	lbu	a5,-1(s0)
ffffffffc0203f5c:	8d22                	mv	s10,s0
ffffffffc0203f5e:	f73788e3          	beq	a5,s3,ffffffffc0203ece <vprintfmt+0x3a>
ffffffffc0203f62:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0203f66:	1d7d                	addi	s10,s10,-1
ffffffffc0203f68:	ff379de3          	bne	a5,s3,ffffffffc0203f62 <vprintfmt+0xce>
ffffffffc0203f6c:	b78d                	j	ffffffffc0203ece <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0203f6e:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0203f72:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f76:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0203f78:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0203f7c:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203f80:	02d86463          	bltu	a6,a3,ffffffffc0203fa8 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0203f84:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0203f88:	002c169b          	slliw	a3,s8,0x2
ffffffffc0203f8c:	0186873b          	addw	a4,a3,s8
ffffffffc0203f90:	0017171b          	slliw	a4,a4,0x1
ffffffffc0203f94:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0203f96:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0203f9a:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0203f9c:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0203fa0:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203fa4:	fed870e3          	bgeu	a6,a3,ffffffffc0203f84 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0203fa8:	f40ddce3          	bgez	s11,ffffffffc0203f00 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0203fac:	8de2                	mv	s11,s8
ffffffffc0203fae:	5c7d                	li	s8,-1
ffffffffc0203fb0:	bf81                	j	ffffffffc0203f00 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0203fb2:	fffdc693          	not	a3,s11
ffffffffc0203fb6:	96fd                	srai	a3,a3,0x3f
ffffffffc0203fb8:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fbc:	00144603          	lbu	a2,1(s0)
ffffffffc0203fc0:	2d81                	sext.w	s11,s11
ffffffffc0203fc2:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203fc4:	bf35                	j	ffffffffc0203f00 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0203fc6:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fca:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0203fce:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fd0:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0203fd2:	bfd9                	j	ffffffffc0203fa8 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0203fd4:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203fd6:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203fda:	01174463          	blt	a4,a7,ffffffffc0203fe2 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0203fde:	1a088e63          	beqz	a7,ffffffffc020419a <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0203fe2:	000a3603          	ld	a2,0(s4)
ffffffffc0203fe6:	46c1                	li	a3,16
ffffffffc0203fe8:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0203fea:	2781                	sext.w	a5,a5
ffffffffc0203fec:	876e                	mv	a4,s11
ffffffffc0203fee:	85a6                	mv	a1,s1
ffffffffc0203ff0:	854a                	mv	a0,s2
ffffffffc0203ff2:	e37ff0ef          	jal	ra,ffffffffc0203e28 <printnum>
            break;
ffffffffc0203ff6:	bde1                	j	ffffffffc0203ece <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0203ff8:	000a2503          	lw	a0,0(s4)
ffffffffc0203ffc:	85a6                	mv	a1,s1
ffffffffc0203ffe:	0a21                	addi	s4,s4,8
ffffffffc0204000:	9902                	jalr	s2
            break;
ffffffffc0204002:	b5f1                	j	ffffffffc0203ece <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204004:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204006:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020400a:	01174463          	blt	a4,a7,ffffffffc0204012 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc020400e:	18088163          	beqz	a7,ffffffffc0204190 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204012:	000a3603          	ld	a2,0(s4)
ffffffffc0204016:	46a9                	li	a3,10
ffffffffc0204018:	8a2e                	mv	s4,a1
ffffffffc020401a:	bfc1                	j	ffffffffc0203fea <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020401c:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204020:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204022:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204024:	bdf1                	j	ffffffffc0203f00 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204026:	85a6                	mv	a1,s1
ffffffffc0204028:	02500513          	li	a0,37
ffffffffc020402c:	9902                	jalr	s2
            break;
ffffffffc020402e:	b545                	j	ffffffffc0203ece <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204030:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204034:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204036:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204038:	b5e1                	j	ffffffffc0203f00 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc020403a:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020403c:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204040:	01174463          	blt	a4,a7,ffffffffc0204048 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204044:	14088163          	beqz	a7,ffffffffc0204186 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204048:	000a3603          	ld	a2,0(s4)
ffffffffc020404c:	46a1                	li	a3,8
ffffffffc020404e:	8a2e                	mv	s4,a1
ffffffffc0204050:	bf69                	j	ffffffffc0203fea <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204052:	03000513          	li	a0,48
ffffffffc0204056:	85a6                	mv	a1,s1
ffffffffc0204058:	e03e                	sd	a5,0(sp)
ffffffffc020405a:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc020405c:	85a6                	mv	a1,s1
ffffffffc020405e:	07800513          	li	a0,120
ffffffffc0204062:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204064:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204066:	6782                	ld	a5,0(sp)
ffffffffc0204068:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc020406a:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc020406e:	bfb5                	j	ffffffffc0203fea <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204070:	000a3403          	ld	s0,0(s4)
ffffffffc0204074:	008a0713          	addi	a4,s4,8
ffffffffc0204078:	e03a                	sd	a4,0(sp)
ffffffffc020407a:	14040263          	beqz	s0,ffffffffc02041be <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc020407e:	0fb05763          	blez	s11,ffffffffc020416c <vprintfmt+0x2d8>
ffffffffc0204082:	02d00693          	li	a3,45
ffffffffc0204086:	0cd79163          	bne	a5,a3,ffffffffc0204148 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020408a:	00044783          	lbu	a5,0(s0)
ffffffffc020408e:	0007851b          	sext.w	a0,a5
ffffffffc0204092:	cf85                	beqz	a5,ffffffffc02040ca <vprintfmt+0x236>
ffffffffc0204094:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204098:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020409c:	000c4563          	bltz	s8,ffffffffc02040a6 <vprintfmt+0x212>
ffffffffc02040a0:	3c7d                	addiw	s8,s8,-1
ffffffffc02040a2:	036c0263          	beq	s8,s6,ffffffffc02040c6 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc02040a6:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02040a8:	0e0c8e63          	beqz	s9,ffffffffc02041a4 <vprintfmt+0x310>
ffffffffc02040ac:	3781                	addiw	a5,a5,-32
ffffffffc02040ae:	0ef47b63          	bgeu	s0,a5,ffffffffc02041a4 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc02040b2:	03f00513          	li	a0,63
ffffffffc02040b6:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02040b8:	000a4783          	lbu	a5,0(s4)
ffffffffc02040bc:	3dfd                	addiw	s11,s11,-1
ffffffffc02040be:	0a05                	addi	s4,s4,1
ffffffffc02040c0:	0007851b          	sext.w	a0,a5
ffffffffc02040c4:	ffe1                	bnez	a5,ffffffffc020409c <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc02040c6:	01b05963          	blez	s11,ffffffffc02040d8 <vprintfmt+0x244>
...
ffffffffc02040d2:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc02040d4:	fe0d9be3          	bnez	s11,ffffffffc02040ca <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02040d8:	6a02                	ld	s4,0(sp)
ffffffffc02040da:	bbd5                	j	ffffffffc0203ece <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02040dc:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02040de:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc02040e2:	01174463          	blt	a4,a7,ffffffffc02040ea <vprintfmt+0x256>
    else if (lflag) {
ffffffffc02040e6:	08088d63          	beqz	a7,ffffffffc0204180 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc02040ea:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc02040ee:	0a044d63          	bltz	s0,ffffffffc02041a8 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc02040f2:	8622                	mv	a2,s0
ffffffffc02040f4:	8a66                	mv	s4,s9
ffffffffc02040f6:	46a9                	li	a3,10
ffffffffc02040f8:	bdcd                	j	ffffffffc0203fea <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc02040fa:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02040fe:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204100:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204102:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204106:	8fb5                	xor	a5,a5,a3
ffffffffc0204108:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc020410c:	02d74163          	blt	a4,a3,ffffffffc020412e <vprintfmt+0x29a>
ffffffffc0204110:	00369793          	slli	a5,a3,0x3
ffffffffc0204114:	97de                	add	a5,a5,s7
ffffffffc0204116:	639c                	ld	a5,0(a5)
ffffffffc0204118:	cb99                	beqz	a5,ffffffffc020412e <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc020411a:	86be                	mv	a3,a5
ffffffffc020411c:	00002617          	auipc	a2,0x2
ffffffffc0204120:	e3460613          	addi	a2,a2,-460 # ffffffffc0205f50 <default_pmm_manager+0xea0>
ffffffffc0204124:	85a6                	mv	a1,s1
ffffffffc0204126:	854a                	mv	a0,s2
ffffffffc0204128:	0ce000ef          	jal	ra,ffffffffc02041f6 <printfmt>
ffffffffc020412c:	b34d                	j	ffffffffc0203ece <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc020412e:	00002617          	auipc	a2,0x2
ffffffffc0204132:	e1260613          	addi	a2,a2,-494 # ffffffffc0205f40 <default_pmm_manager+0xe90>
ffffffffc0204136:	85a6                	mv	a1,s1
ffffffffc0204138:	854a                	mv	a0,s2
ffffffffc020413a:	0bc000ef          	jal	ra,ffffffffc02041f6 <printfmt>
ffffffffc020413e:	bb41                	j	ffffffffc0203ece <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204140:	00002417          	auipc	s0,0x2
ffffffffc0204144:	df840413          	addi	s0,s0,-520 # ffffffffc0205f38 <default_pmm_manager+0xe88>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204148:	85e2                	mv	a1,s8
ffffffffc020414a:	8522                	mv	a0,s0
ffffffffc020414c:	e43e                	sd	a5,8(sp)
ffffffffc020414e:	196000ef          	jal	ra,ffffffffc02042e4 <strnlen>
ffffffffc0204152:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204156:	01b05b63          	blez	s11,ffffffffc020416c <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc020415a:	67a2                	ld	a5,8(sp)
ffffffffc020415c:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204160:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204162:	85a6                	mv	a1,s1
ffffffffc0204164:	8552                	mv	a0,s4
ffffffffc0204166:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204168:	fe0d9ce3          	bnez	s11,ffffffffc0204160 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020416c:	00044783          	lbu	a5,0(s0)
ffffffffc0204170:	00140a13          	addi	s4,s0,1
ffffffffc0204174:	0007851b          	sext.w	a0,a5
ffffffffc0204178:	d3a5                	beqz	a5,ffffffffc02040d8 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020417a:	05e00413          	li	s0,94
ffffffffc020417e:	bf39                	j	ffffffffc020409c <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204180:	000a2403          	lw	s0,0(s4)
ffffffffc0204184:	b7ad                	j	ffffffffc02040ee <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204186:	000a6603          	lwu	a2,0(s4)
ffffffffc020418a:	46a1                	li	a3,8
ffffffffc020418c:	8a2e                	mv	s4,a1
ffffffffc020418e:	bdb1                	j	ffffffffc0203fea <vprintfmt+0x156>
ffffffffc0204190:	000a6603          	lwu	a2,0(s4)
ffffffffc0204194:	46a9                	li	a3,10
ffffffffc0204196:	8a2e                	mv	s4,a1
ffffffffc0204198:	bd89                	j	ffffffffc0203fea <vprintfmt+0x156>
ffffffffc020419a:	000a6603          	lwu	a2,0(s4)
ffffffffc020419e:	46c1                	li	a3,16
ffffffffc02041a0:	8a2e                	mv	s4,a1
ffffffffc02041a2:	b5a1                	j	ffffffffc0203fea <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc02041a4:	9902                	jalr	s2
ffffffffc02041a6:	bf09                	j	ffffffffc02040b8 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc02041a8:	85a6                	mv	a1,s1
ffffffffc02041aa:	02d00513          	li	a0,45
ffffffffc02041ae:	e03e                	sd	a5,0(sp)
ffffffffc02041b0:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc02041b2:	6782                	ld	a5,0(sp)
ffffffffc02041b4:	8a66                	mv	s4,s9
ffffffffc02041b6:	40800633          	neg	a2,s0
ffffffffc02041ba:	46a9                	li	a3,10
ffffffffc02041bc:	b53d                	j	ffffffffc0203fea <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc02041be:	03b05163          	blez	s11,ffffffffc02041e0 <vprintfmt+0x34c>
ffffffffc02041c2:	02d00693          	li	a3,45
ffffffffc02041c6:	f6d79de3          	bne	a5,a3,ffffffffc0204140 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc02041ca:	00002417          	auipc	s0,0x2
ffffffffc02041ce:	d6e40413          	addi	s0,s0,-658 # ffffffffc0205f38 <default_pmm_manager+0xe88>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041d2:	02800793          	li	a5,40
ffffffffc02041d6:	02800513          	li	a0,40
ffffffffc02041da:	00140a13          	addi	s4,s0,1
ffffffffc02041de:	bd6d                	j	ffffffffc0204098 <vprintfmt+0x204>
ffffffffc02041e0:	00002a17          	auipc	s4,0x2
ffffffffc02041e4:	d59a0a13          	addi	s4,s4,-679 # ffffffffc0205f39 <default_pmm_manager+0xe89>
ffffffffc02041e8:	02800513          	li	a0,40
ffffffffc02041ec:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02041f0:	05e00413          	li	s0,94
ffffffffc02041f4:	b565                	j	ffffffffc020409c <vprintfmt+0x208>

ffffffffc02041f6 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02041f6:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc02041f8:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02041fc:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc02041fe:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204200:	ec06                	sd	ra,24(sp)
ffffffffc0204202:	f83a                	sd	a4,48(sp)
ffffffffc0204204:	fc3e                	sd	a5,56(sp)
ffffffffc0204206:	e0c2                	sd	a6,64(sp)
ffffffffc0204208:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc020420a:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc020420c:	c89ff0ef          	jal	ra,ffffffffc0203e94 <vprintfmt>
}
ffffffffc0204210:	60e2                	ld	ra,24(sp)
ffffffffc0204212:	6161                	addi	sp,sp,80
ffffffffc0204214:	8082                	ret

ffffffffc0204216 <readline>:
...
ffffffffc0204216:	715d                	addi	sp,sp,-80
ffffffffc0204218:	e486                	sd	ra,72(sp)
ffffffffc020421a:	e0a6                	sd	s1,64(sp)
ffffffffc020421c:	fc4a                	sd	s2,56(sp)
ffffffffc020421e:	f84e                	sd	s3,48(sp)
ffffffffc0204220:	f452                	sd	s4,40(sp)
ffffffffc0204222:	f056                	sd	s5,32(sp)
ffffffffc0204224:	ec5a                	sd	s6,24(sp)
ffffffffc0204226:	e85e                	sd	s7,16(sp)
    if (prompt != NULL) {
ffffffffc0204228:	c901                	beqz	a0,ffffffffc0204238 <readline+0x22>
ffffffffc020422a:	85aa                	mv	a1,a0
        cprintf("%s", prompt);
ffffffffc020422c:	00002517          	auipc	a0,0x2
ffffffffc0204230:	d2450513          	addi	a0,a0,-732 # ffffffffc0205f50 <default_pmm_manager+0xea0>
ffffffffc0204234:	e87fb0ef          	jal	ra,ffffffffc02000ba <cprintf>
readline(const char *prompt) {
...
ffffffffc0204246:	ea6b8b93          	addi	s7,s7,-346 # ffffffffc02110e8 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc020424a:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc020424e:	ea5fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc0204252:	00054a63          	bltz	a0,ffffffffc0204266 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204256:	00a95a63          	bge	s2,a0,ffffffffc020426a <readline+0x54>
ffffffffc020425a:	029a5263          	bge	s4,s1,ffffffffc020427e <readline+0x68>
        c = getchar();
ffffffffc020425e:	e95fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc0204262:	fe055ae3          	bgez	a0,ffffffffc0204256 <readline+0x40>
            return NULL;
ffffffffc0204266:	4501                	li	a0,0
ffffffffc0204268:	a091                	j	ffffffffc02042ac <readline+0x96>
        else if (c == '\b' && i > 0) {
ffffffffc020426a:	03351463          	bne	a0,s3,ffffffffc0204292 <readline+0x7c>
ffffffffc020426e:	e8a9                	bnez	s1,ffffffffc02042c0 <readline+0xaa>
        c = getchar();
ffffffffc0204270:	e83fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc0204274:	fe0549e3          	bltz	a0,ffffffffc0204266 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204278:	fea959e3          	bge	s2,a0,ffffffffc020426a <readline+0x54>
ffffffffc020427c:	4481                	li	s1,0
            cputchar(c);
ffffffffc020427e:	e42a                	sd	a0,8(sp)
ffffffffc0204280:	e71fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i ++] = c;
ffffffffc0204284:	6522                	ld	a0,8(sp)
ffffffffc0204286:	009b87b3          	add	a5,s7,s1
ffffffffc020428a:	2485                	addiw	s1,s1,1
ffffffffc020428c:	00a78023          	sb	a0,0(a5)
ffffffffc0204290:	bf7d                	j	ffffffffc020424e <readline+0x38>
        else if (c == '\n' || c == '\r') {
ffffffffc0204292:	01550463          	beq	a0,s5,ffffffffc020429a <readline+0x84>
ffffffffc0204296:	fb651ce3          	bne	a0,s6,ffffffffc020424e <readline+0x38>
            cputchar(c);
ffffffffc020429a:	e57fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i] = '\0';
ffffffffc020429e:	0000d517          	auipc	a0,0xd
ffffffffc02042a2:	e4a50513          	addi	a0,a0,-438 # ffffffffc02110e8 <buf>
ffffffffc02042a6:	94aa                	add	s1,s1,a0
ffffffffc02042a8:	00048023          	sb	zero,0(s1)
            return buf;
        }
    }
}
ffffffffc02042ac:	60a6                	ld	ra,72(sp)
ffffffffc02042ae:	6486                	ld	s1,64(sp)
ffffffffc02042b0:	7962                	ld	s2,56(sp)
ffffffffc02042b2:	79c2                	ld	s3,48(sp)
ffffffffc02042b4:	7a22                	ld	s4,40(sp)
ffffffffc02042b6:	7a82                	ld	s5,32(sp)
ffffffffc02042b8:	6b62                	ld	s6,24(sp)
ffffffffc02042ba:	6bc2                	ld	s7,16(sp)
ffffffffc02042bc:	6161                	addi	sp,sp,80
ffffffffc02042be:	8082                	ret
            cputchar(c);
ffffffffc02042c0:	4521                	li	a0,8
ffffffffc02042c2:	e2ffb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            i --;
ffffffffc02042c6:	34fd                	addiw	s1,s1,-1
ffffffffc02042c8:	b759                	j	ffffffffc020424e <readline+0x38>

ffffffffc02042ca <strlen>:
...
strlen(const char *s) {
ffffffffc02042ce:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc02042d0:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc02042d2:	cb81                	beqz	a5,ffffffffc02042e2 <strlen+0x18>
        cnt ++;
ffffffffc02042d4:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc02042d6:	00a707b3          	add	a5,a4,a0
ffffffffc02042da:	0007c783          	lbu	a5,0(a5)
ffffffffc02042de:	fbfd                	bnez	a5,ffffffffc02042d4 <strlen+0xa>
...
ffffffffc02042e4:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc02042e6:	e589                	bnez	a1,ffffffffc02042f0 <strnlen+0xc>
ffffffffc02042e8:	a811                	j	ffffffffc02042fc <strnlen+0x18>
        cnt ++;
ffffffffc02042ea:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc02042ec:	00f58863          	beq	a1,a5,ffffffffc02042fc <strnlen+0x18>
ffffffffc02042f0:	00f50733          	add	a4,a0,a5
ffffffffc02042f4:	00074703          	lbu	a4,0(a4)
ffffffffc02042f8:	fb6d                	bnez	a4,ffffffffc02042ea <strnlen+0x6>
ffffffffc02042fa:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc02042fc:	852e                	mv	a0,a1
ffffffffc02042fe:	8082                	ret

ffffffffc0204300 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0204300:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204302:	0005c703          	lbu	a4,0(a1)
ffffffffc0204306:	0785                	addi	a5,a5,1
ffffffffc0204308:	0585                	addi	a1,a1,1
ffffffffc020430a:	fee78fa3          	sb	a4,-1(a5)
ffffffffc020430e:	fb75                	bnez	a4,ffffffffc0204302 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0204316:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020431a:	cb89                	beqz	a5,ffffffffc020432c <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc020431c:	0505                	addi	a0,a0,1
ffffffffc020431e:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204320:	fee789e3          	beq	a5,a4,ffffffffc0204312 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204324:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204328:	9d19                	subw	a0,a0,a4
ffffffffc020432a:	8082                	ret
ffffffffc020432c:	4501                	li	a0,0
ffffffffc020432e:	bfed                	j	ffffffffc0204328 <strcmp+0x16>

ffffffffc0204330 <strchr>:
...
ffffffffc0204334:	c799                	beqz	a5,ffffffffc0204342 <strchr+0x12>
        if (*s == c) {
ffffffffc0204336:	00f58763          	beq	a1,a5,ffffffffc0204344 <strchr+0x14>
    while (*s != '\0') {
ffffffffc020433a:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc020433e:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204340:	fbfd                	bnez	a5,ffffffffc0204336 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204346:	ca01                	beqz	a2,ffffffffc0204356 <memset+0x10>
ffffffffc0204348:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc020434a:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc020434c:	0785                	addi	a5,a5,1
ffffffffc020434e:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204352:	fec79de3          	bne	a5,a2,ffffffffc020434c <memset+0x6>
    }
    return s;
...
ffffffffc0204358 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204358:	ca19                	beqz	a2,ffffffffc020436e <memcpy+0x16>
ffffffffc020435a:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc020435c:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc020435e:	0005c703          	lbu	a4,0(a1)
ffffffffc0204362:	0585                	addi	a1,a1,1
ffffffffc0204364:	0785                	addi	a5,a5,1
ffffffffc0204366:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc020436a:	fec59ae3          	bne	a1,a2,ffffffffc020435e <memcpy+0x6>
    }
    return dst;
